...
// ResultComponentType
INSERT INTO KSLU_LRC_RESCOMP_TYPE (TYPE_KEY, TYPE_DESC, EFF_DT, EXPIR_DT, NAME) values ('lrcType.resultComponent.1', 'A Basic ResultComponent 1', {ts '2000-01-01 00:00:00.0'}, {ts '2000-12-31 00:00:00.0'}, 'ResultComponent 1')
/
INSERT INTO KSLU_LRC_RESCOMP_TYPE (TYPE_KEY, TYPE_DESC, EFF_DT, EXPIR_DT, NAME) values ('lrcType.resultComponent.2', 'A Basic ResultComponent 2', {ts '2000-01-01 00:00:00.0'}, {ts '2000-12-31 00:00:00.0'}, 'ResultComponent 2')
/
INSERT INTO KSLU_LRC_RESCOMP_TYPE (TYPE_KEY, TYPE_DESC, EFF_DT, EXPIR_DT, NAME) values ('lrcType.resultComponent.3', 'A Basic ResultComponent 3', {ts '2000-01-01 00:00:00.0'}, {ts '2000-12-31 00:00:00.0'}, 'ResultComponent 3')
/

// ResultComponent
INSERT INTO KSLU_LRC_RESCOMP (ID, NAME, RT_DESCR_ID, EFF_DT, EXPIR_DT, TYPE, STATE) VALUES ('LRC-RESCOMP-1', 'ResultComponent 1', 'RT-DESC-LCR-7',  {ts '2000-01-01 00:00:00.0'},  {ts '2000-12-31 00:00:00.0'}, 'lrcType.resultComponent.1', 'Active')
/
INSERT INTO KSLU_LRC_RESCOMP (ID, NAME, RT_DESCR_ID, EFF_DT, EXPIR_DT, TYPE, STATE) VALUES ('LRC-RESCOMP-2', 'ResultComponent 2', 'RT-DESC-LCR-8',  {ts '2000-01-01 00:00:00.0'},  {ts '2000-12-31 00:00:00.0'}, 'lrcType.resultComponent.2', 'Active')
/
INSERT INTO KSLU_LRC_RESCOMP (ID, NAME, RT_DESCR_ID, EFF_DT, EXPIR_DT, TYPE, STATE) VALUES ('LRC-RESCOMP-3', 'ResultComponent 3', 'RT-DESC-LCR-9',  {ts '2000-01-01 00:00:00.0'},  {ts '2000-12-31 00:00:00.0'}, 'lrcType.resultComponent.3', 'Active')
/
INSERT INTO KSLU_LRC_RESCOMP (ID, NAME, RT_DESCR_ID, EFF_DT, EXPIR_DT, TYPE, STATE) VALUES ('LRC-RESCOMP-4', 'ResultComponent 4', 'RT-DESC-LCR-9',  {ts '2000-01-01 00:00:00.0'},  {ts '2000-12-31 00:00:00.0'}, 'lrcType.resultComponent.3', 'Active')
/
