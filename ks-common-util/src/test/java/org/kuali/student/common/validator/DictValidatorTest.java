...
import org.kuali.student.core.validation.dto.DictValidationResultInfo;

public class DictValidatorTest {
	...
	public void testElementXPath() {
    	...
    	List<DictValidationResultContainer> results = val.validateTypeStateObject( p, buildObjectStructure1());    
    ...
    public void testRequired() {
    	...
    	List<DictValidationResultContainer> results = val.validateTypeStateObject( buildTestPerson1(), buildObjectStructure1());    
    	assertEquals(results.size(), 3);

    	assertEquals(results.get(1).getErrorLevel(), DictValidationResultInfo.ErrorLevel.ERROR);
    ...
    public void testLengthRange() {
    	...
    	assertEquals(results.get(0).getErrorLevel(), DictValidationResultInfo.ErrorLevel.ERROR);
    ...
    public void testMinLength() {
    	...
    	List<DictValidationResultContainer> results = val.validateTypeStateObject( p, o1);    
    	assertEquals(results.size(), 3);
    ...
    public void testDoubleValueRange() {
    	...
    	assertEquals(results.get(2).getErrorLevel(), DictValidationResultInfo.ErrorLevel.ERROR);
