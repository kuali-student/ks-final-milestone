...
/
INSERT INTO KRCR_PARM_T (APPL_ID, CMPNT_CD, EVAL_OPRTR_CD, NMSPC_CD, OBJ_ID, PARM_DESC_TXT, PARM_NM, PARM_TYP_CD, VAL, VER_NBR)
  VALUES ('KUALI', 'ActionList', 'A', 'KR-WKFLW', '340789CDF30F4252A1A2A42AD39B90B2', 'Default email address used for testing.', 'EMAIL_NOTIFICATION_TEST_ADDRESS', 'CONFG', null, 1)
/
INSERT INTO KRCR_PARM_T (APPL_ID, CMPNT_CD, EVAL_OPRTR_CD, NMSPC_CD, OBJ_ID, PARM_DESC_TXT, PARM_NM, PARM_TYP_CD, VAL, VER_NBR)
  VALUES ('KUALI', 'ActionList', 'A', 'KR-WKFLW', '2CE075BC0C59435CA6DEFF724492DE3F', 'Throttles the number of results returned on all users Action Lists, regardless of their user preferences.  This is intended to be used in a situation where excessively large Action Lists are causing performance issues.', 'PAGE_SIZE_THROTTLE', 'CONFG', null, 1)
/
INSERT INTO KRCR_PARM_T (APPL_ID, CMPNT_CD, EVAL_OPRTR_CD, NMSPC_CD, OBJ_ID, PARM_DESC_TXT, PARM_NM, PARM_TYP_CD, VAL, VER_NBR)
...
/
INSERT INTO KRCR_PARM_T (APPL_ID, CMPNT_CD, EVAL_OPRTR_CD, NMSPC_CD, OBJ_ID, PARM_DESC_TXT, PARM_NM, PARM_TYP_CD, VAL, VER_NBR)
  VALUES ('KUALI', 'All', 'A', 'KR-WKFLW', '4656B6E7E9844E2C9E2255014AFC86B5', 'The maximum number of nodes the workflow engine will process before it determines the process is a runaway process.  This is prevent infinite "loops" in the workflow engine.', 'MAXIMUM_NODES_BEFORE_RUNAWAY', 'CONFG', null, 1)
/
INSERT INTO KRCR_PARM_T (APPL_ID, CMPNT_CD, EVAL_OPRTR_CD, NMSPC_CD, OBJ_ID, PARM_DESC_TXT, PARM_NM, PARM_TYP_CD, VAL, VER_NBR)
...
/
INSERT INTO KRCR_PARM_T (APPL_ID, CMPNT_CD, EVAL_OPRTR_CD, NMSPC_CD, OBJ_ID, PARM_DESC_TXT, PARM_NM, PARM_TYP_CD, VAL, VER_NBR)
  VALUES ('KUALI', 'DocumentSearch', 'A', 'KR-WKFLW', 'D43459D143FC46C6BF83C71AC2383B76', 'Limit of fetch more iterations for document searches.', 'FETCH_MORE_ITERATION_LIMIT', 'CONFG', null, 1)
/
INSERT INTO KRCR_PARM_T (APPL_ID, CMPNT_CD, EVAL_OPRTR_CD, NMSPC_CD, OBJ_ID, PARM_DESC_TXT, PARM_NM, PARM_TYP_CD, VAL, VER_NBR)
  VALUES ('KUALI', 'DocumentSearch', 'A', 'KR-WKFLW', 'E324D85082184EB6967537B3EE1F655B', 'Maximum number of documents to return from a search.', 'RESULT_CAP', 'CONFG', null, 1)
/
INSERT INTO KRCR_PARM_T (APPL_ID, CMPNT_CD, EVAL_OPRTR_CD, NMSPC_CD, OBJ_ID, PARM_DESC_TXT, PARM_NM, PARM_TYP_CD, VAL, VER_NBR)
...
/
INSERT INTO KRCR_PARM_T (APPL_ID, CMPNT_CD, EVAL_OPRTR_CD, NMSPC_CD, OBJ_ID, PARM_DESC_TXT, PARM_NM, PARM_TYP_CD, VAL, VER_NBR)
  VALUES ('KUALI', 'Feature', 'A', 'KR-WKFLW', 'BEBDBCFA74A5458EADE2CF075FFF206E', 'A flag to specify whether the WorkflowInfo.isLastApproverAtNode(...) API method attempts to active requests first, prior to execution.', 'IS_LAST_APPROVER_ACTIVATE_FIRST_IND', 'CONFG', null, 1)
/
INSERT INTO KRCR_PARM_T (APPL_ID, CMPNT_CD, EVAL_OPRTR_CD, NMSPC_CD, OBJ_ID, PARM_DESC_TXT, PARM_NM, PARM_TYP_CD, VAL, VER_NBR)
...
/
INSERT INTO KRCR_PARM_T (APPL_ID, CMPNT_CD, EVAL_OPRTR_CD, NMSPC_CD, OBJ_ID, PARM_DESC_TXT, PARM_NM, PARM_TYP_CD, VAL, VER_NBR)
  VALUES ('KUALI', 'Notification', 'D', 'KR-WKFLW', '08280F2575904F3586CF48BB97907506', 'Defines a group name (in the format "namespace:name") which contains members who should never receive "notifications" action requests from KEW.', 'NOTIFY_GROUPS', 'CONFG', null, 1)
/
INSERT INTO KRCR_PARM_T (APPL_ID, CMPNT_CD, EVAL_OPRTR_CD, NMSPC_CD, OBJ_ID, PARM_DESC_TXT, PARM_NM, PARM_TYP_CD, VAL, VER_NBR)
  VALUES ('KUALI', 'PersonDocumentName', 'A', 'KR-IDM', '61645D045B0105D7E0404F8189D849B1', null, 'PREFIXES', 'CONFG', 'Ms;Mrs;Mr;Dr', 1)
/
INSERT INTO KRCR_PARM_T (APPL_ID, CMPNT_CD, EVAL_OPRTR_CD, NMSPC_CD, OBJ_ID, PARM_DESC_TXT, PARM_NM, PARM_TYP_CD, VAL, VER_NBR)
  VALUES ('KUALI', 'PersonDocumentName', 'A', 'KR-IDM', '61645D045B0205D7E0404F8189D849B1', null, 'SUFFIXES', 'CONFG', 'Jr;Sr;Mr;Md', 1)
/
INSERT INTO KRCR_PARM_T (APPL_ID, CMPNT_CD, EVAL_OPRTR_CD, NMSPC_CD, OBJ_ID, PARM_DESC_TXT, PARM_NM, PARM_TYP_CD, VAL, VER_NBR)
...
/
INSERT INTO KRCR_PARM_T (APPL_ID, CMPNT_CD, EVAL_OPRTR_CD, NMSPC_CD, OBJ_ID, PARM_DESC_TXT, PARM_NM, PARM_TYP_CD, VAL, VER_NBR)
  VALUES ('KUALI', 'QuickLinks', 'A', 'KR-WKFLW', '5292CFD9A0EA48BEB22A2EB3B3BD3CDA', 'Comma seperated list of Document Types to exclude from the Rule Quicklinks.', 'RESTRICT_DOCUMENT_TYPES', 'CONFG', null, 1)
/
INSERT INTO KRCR_PARM_T (APPL_ID, CMPNT_CD, EVAL_OPRTR_CD, NMSPC_CD, OBJ_ID, PARM_DESC_TXT, PARM_NM, PARM_TYP_CD, VAL, VER_NBR)
  VALUES ('KUALI', 'Rule', 'A', 'KR-WKFLW', 'BDE964269F2743338C00A4326B676195', 'Defines custom Document Type processes to use for certain types of routing rules.', 'CUSTOM_DOCUMENT_TYPES', 'CONFG', null, 1)
/
INSERT INTO KRCR_PARM_T (APPL_ID, CMPNT_CD, EVAL_OPRTR_CD, NMSPC_CD, OBJ_ID, PARM_DESC_TXT, PARM_NM, PARM_TYP_CD, VAL, VER_NBR)
