INSERT INTO KREW_DOC_TYP_T (ACTV_IND, BLNKT_APPR_GRP_ID, CUR_IND, DOC_HDLR_URL, DOC_TYP_DESC, DOC_TYP_ID, DOC_TYP_NM, DOC_TYP_VER_NBR, GRP_ID, HELP_DEF_URL, LBL, OBJ_ID, PARNT_ID, POST_PRCSR, PREV_DOC_TYP_VER_NBR, RTE_VER_NBR, VER_NBR)
  ...
  'Create a KRMS Final Exam Matrix Rule', CONCAT('KS-KREW-DOC-TYP-', KS_RICE_ID_S.NEXTVAL), 'FERuleMaintenanceDocument', 0, '1', null, 'KRMS Final Exam Rule Maintenance Document', '874ef5b0-e448-4e52-90df-7478e3f6e1d9',
...
INSERT INTO KREW_DOC_TYP_PROC_T (DOC_TYP_ID, DOC_TYP_PROC_ID, INIT_IND, NM, VER_NBR)
  VALUES (CONCAT('KS-KREW-DOC-TYP-', KS_RICE_ID_S.CURRVAL), CONCAT('KS-KREW-DOC-TYP-PROC-', KS_RICE_ID_S.NEXTVAL), 1, 'PRIMARY', 2)
/