...
INSERT INTO KRIM_ROLE_MBR_ATTR_DATA_T (ATTR_DATA_ID, ATTR_VAL, KIM_ATTR_DEFN_ID, KIM_TYP_ID, OBJ_ID, ROLE_MBR_ID, VER_NBR)
  VALUES ('10097', '1000ENGL', (SELECT KIM_ATTR_DEFN_ID FROM KRIM_ATTR_DEFN_T WHERE NM = 'org' AND NMSPC_CD = 'KS-SYS'), '114', 'D2F07FCB2ECCFFC9E040760A4A45207E', '10036', 1)
/
INSERT INTO KRIM_ROLE_MBR_ATTR_DATA_T (ATTR_DATA_ID, ATTR_VAL, KIM_ATTR_DEFN_ID, KIM_TYP_ID, OBJ_ID, ROLE_MBR_ID, VER_NBR)
  VALUES ('10098', 'N', (SELECT KIM_ATTR_DEFN_ID FROM KRIM_ATTR_DEFN_T WHERE NM = 'descendHierarchy' AND NMSPC_CD = 'KS-SYS'), '114', 'D2F07FCB2ECDFFC9E040760A4A45207E', '10036', 1)
/
