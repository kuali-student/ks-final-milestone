...
have access to register students  so that  not any person that have access
to the system can register students for courses*/
--////////////////////////////////////////////////////////////////////////
...
values
  (KRIM_ROLE_ID_S.NEXTVAL,
   ...
   'KS-ENR',
   'KS Administrator with global abilities Registration Personnel Role',
...
values
  (KRIM_ROLE_MBR_ID_S.NEXTVAL,
   ...
   (SELECT ROLE_ID
      FROM KRIM_ROLE_T
     where ROLE_NM = 'Central Registration Personnel Role'
       and nmspc_cd = 'KS-ENR'),
   'admin',
   'P',
   '',
...
values
  (KRIM_ROLE_PERM_ID_S.NEXTVAL,
   ...
   (SELECT perm_id
      from krim_perm_t
     where nm = 'Central Registration Personnel Permission'
       and nmspc_cd = 'KS-ENR'),
   'Y')
/
--////////////////////////////////////////////////////////////////////////
