...
/
Insert into KRMS_TYP_T (ACTV,TYP_ID,NM,NMSPC_CD,SRVC_NM,VER_NBR) values ('Y',CONCAT('KS-KRMS-TYP-', KS_RICE_ID_S.NEXTVAL),'kuali.krms.proposition.type.final.exam.course.offering','KS-SYS','simplePropositionTypeService',0)
/
...
/
Insert into KRMS_TYP_RELN_T (TYP_RELN_ID,FROM_TYP_ID,TO_TYP_ID,RELN_TYP,SEQ_NO,VER_NBR,ACTV) values (CONCAT('KS-KRMS-TYP-RELN-', KS_RICE_ID_S.NEXTVAL),(SELECT TYP_ID FROM KRMS_TYP_T WHERE NM = 'kuali.krms.rule.type.final.exam.common'),(SELECT TYP_ID FROM KRMS_TYP_T WHERE NM = 'kuali.krms.proposition.type.final.exam.course.offering'),'A',1,0,'Y')
/
Insert into KRMS_TYP_RELN_T (TYP_RELN_ID,FROM_TYP_ID,TO_TYP_ID,RELN_TYP,SEQ_NO,VER_NBR,ACTV) values (CONCAT('KS-KRMS-TYP-RELN-', KS_RICE_ID_S.NEXTVAL),(SELECT TYP_ID FROM KRMS_TYP_T WHERE NM = 'kuali.krms.rule.type.final.exam.common'),(SELECT TYP_ID FROM KRMS_TYP_T WHERE NM = 'kuali.krms.proposition.type.final.exam.courseset'),'A',1,0,'Y')
/