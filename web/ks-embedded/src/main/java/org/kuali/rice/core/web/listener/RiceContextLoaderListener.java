...
import org.kuali.rice.core.web.context.RiceWebApplicationContextProxy;
...
public class RiceContextLoaderListener implements ServletContextListener {
    ...
    /**
     * Checks for spring context file location parameters. Checks for kew settings, then standard spring context init param,
     * then defaults to StandaloneSpringBeans.xml.
     * 
    ...
    protected void initWebContext(ServletContext servletContext) {
        ...
        if (servletContext.getAttribute(WebApplicationContext.ROOT_WEB_APPLICATION_CONTEXT_ATTRIBUTE) != null) {
            throw new IllegalStateException(
                    "Cannot set Rice Root WebApplication context because one is already present - " +
                    "check whether you have other Spring ContextLoaderListeners in your web.xml!");
        }
