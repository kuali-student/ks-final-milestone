...
public class CommentServiceValidationDecorator extends CommentServiceDecorator {
    ...
    public CommentInfo createComment(String referenceId, String referenceTypeKey, String commentTypeKey, CommentInfo commentInfo, ContextInfo contextInfo)
        ...
        try {
            List<ValidationResultInfo> errors =
                    this.validateComment(DataDictionaryValidator.ValidationType.FULL_VALIDATION.toString(), commentInfo, contextInfo);
            if (!errors.isEmpty()) {
    ...
    public List<ValidationResultInfo> validateComment(String validationTypeKey, CommentInfo commentInfo, ContextInfo contextInfo)
        ...
        try {
            ...
            errors.addAll(getNextDecorator().validateComment(validationTypeKey, commentInfo, contextInfo));
        } catch (DoesNotExistException ex) {
            throw new OperationFailedException("Error validating", ex);
