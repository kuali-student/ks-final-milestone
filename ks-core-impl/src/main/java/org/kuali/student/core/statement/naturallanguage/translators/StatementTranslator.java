...
import org.kuali.student.core.statement.naturallanguage.util.TemplateTranslator;
...
//			return null;
	...
	private String getHeaderTemplate(Statement luStatement, String nlUsageTypeKey) throws DoesNotExistException {
		for(StatementTypeHeaderTemplate header : luStatement.getLuStatementType().getHeaders()) {
