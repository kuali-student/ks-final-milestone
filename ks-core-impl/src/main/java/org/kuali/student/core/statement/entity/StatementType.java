...
//	private List<LuType> luTypes;
    ...
    private List<StatementType> allowedLuStatementTypes;
...
//	}
    ...
    public List<StatementType> getAllowedLuStatementTypes() {
        if(null == allowedLuStatementTypes) {
            allowedLuStatementTypes = new ArrayList<StatementType>();
        }
        
        return allowedLuStatementTypes;
    }

    public void setAllowedLuStatementTypes(List<StatementType> allowedLuStatementTypes) {
