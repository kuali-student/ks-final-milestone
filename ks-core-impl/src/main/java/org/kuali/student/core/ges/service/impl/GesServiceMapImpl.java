...
public class GesServiceMapImpl implements MockService, GesService {
    ...
    @Override
    public List<ValueInfo> evaluateValuesForParameters(List<String> parameterKeys, GesCriteriaInfo criteria, ContextInfo contextInfo)
            throws InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
            PermissionDeniedException
    ...
    @Override
    public List<ValueInfo> evaluateValuesForParametersOnDate (List<String> parameterKeys, GesCriteriaInfo criteria, Date onDate,ContextInfo contextInfo)
            throws InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
            PermissionDeniedException
    ...
    @Override
    public ParameterGroupInfo getParameterGroup(String parameterGroupKey, ContextInfo contextInfo)
            throws DoesNotExistException,
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
    ...
    @Override
    public List<ParameterGroupInfo> getParameterGroupsByKeys(List<String> parameterGroupKeys, ContextInfo contextInfo)
            throws DoesNotExistException,
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
    ...
    @Override
    public List<String> getParameterGroupKeysByType(String parameterGroupTypeKey, ContextInfo contextInfo)
            throws InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
            PermissionDeniedException
    ...
    @Override
    public List<String> searchForParameterGroupKeys(QueryByCriteria criteria, ContextInfo contextInfo)
            throws InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
            PermissionDeniedException
    ...
    @Override
    public List<ParameterGroupInfo> searchForParameterGroups(QueryByCriteria criteria, ContextInfo contextInfo)
            throws InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
            PermissionDeniedException
    ...
    @Override
    public List<ValidationResultInfo> validateParameterGroup (String validationTypeKey, String valueTypeKey, ParameterGroupInfo parameterGroupInfo, ContextInfo contextInfo)
            throws DoesNotExistException,
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
    ...
    @Override
    public ParameterGroupInfo createParameterGroup(String parameterGroupTypeKey, ParameterGroupInfo parameterGroupInfo, ContextInfo contextInfo)
            throws DoesNotExistException,
            DataValidationErrorException,
            InvalidParameterException,
            MissingParameterException,
    ...
    @Override
    public ParameterGroupInfo updateParameterGroup(String parameterGroupKey, ParameterGroupInfo parameterGroupInfo, ContextInfo contextInfo)
            throws DataValidationErrorException,
            DoesNotExistException,
            InvalidParameterException,
            MissingParameterException,
    ...
    @Override
    public StatusInfo deleteParameterGroup (String parameterGroupKey, ContextInfo contextInfo)
            throws DoesNotExistException,
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
    ...
    @Override
    public List<ParameterGroupInfo> getParameterGroupsForParameter(String parameterKey, ContextInfo contextInfo)
            throws InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
            PermissionDeniedException
    ...
    @Override
    public List<ParameterInfo> getParametersForParameterGroup(String parameterGroupKey, ContextInfo contextInfo)
            throws InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
            PermissionDeniedException
    ...
    @Override
    public StatusInfo addParameterToParameterGroup(String parameterKey, String parameterGroupKey, ContextInfo contextInfo)
    ...
    @Override
    public StatusInfo removeParameterFromParameterGroup(String parameterKey, String parameterGroupKey, ContextInfo contextInfo)
            throws DoesNotExistException,
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
