...
/**
 * This is poor man's implementation of a mock messages service to be used for UI testing, 
 * it will load gwt-messages.xml configured via the set method. 
 * 
...
public class MessageServiceMock implements MessageService {
    ...
    public Message addMessage(Message messageInfo) {
        ...
        localeMessages.putMessage(messageInfo.getGroupName(), messageInfo.getId(), messageInfo.getValue());
    ...
    /**
     * @see org.kuali.student.core.messages.service.MessageService#getMessage(java.lang.String, java.lang.String, java.lang.String)
     */
    @Override
    public Message getMessage(String localeKey, String messageGroupKey, String messageKey) {
        ...
        try{
            ...
            m.setId(messageKey);
            m.setValue(this.messages.get(localeKey).getMessages(messageGroupKey).get(messageKey));
        } catch (Exception e) {
    ...
    /**
     * @see org.kuali.student.core.messages.service.MessageService#getMessages(java.lang.String, java.lang.String)
     */
    @Override
    public MessageList getMessages(String localeKey, String messageGroupKey) {
        ...
        try{
            Map<String, String> groupMessages = ((LocaleMessages)messages.get(localeKey)).getMessages(messageGroupKey);
    ...
    /**
     * @see org.kuali.student.core.messages.service.MessageService#getMessagesByGroups(java.lang.String, org.kuali.student.core.messages.dto.MessageGroupKeyList)
     */
    @Override
    ...
    /**
     * @see org.kuali.student.core.messages.service.MessageService#updateMessage(java.lang.String, java.lang.String, java.lang.String, org.kuali.student.core.messages.dto.Message)
     */
    @Override
    public Message updateMessage(String localeKey, String messageGroupKey, String messageKey, Message messageInfo) {
        if (getMessage(localeKey, messageGroupKey, messageKey) != null){
            putMessage(localeKey, messageGroupKey, messageKey, messageInfo.getValue());
        }
        return messageInfo;
    }
