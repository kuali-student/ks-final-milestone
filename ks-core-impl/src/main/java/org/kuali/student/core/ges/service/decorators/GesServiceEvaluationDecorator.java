...
public class GesServiceEvaluationDecorator extends GesServiceDecorator {
    ...
    private boolean isValueApplicable(ValueInfo value, GesCriteriaInfo criteria, String atpTypeKey, Date onDate, ContextInfo contextInfo)
        ...
        return isAtpActive(value.getAtpTypeKey(), atpTypeKey, onDate, contextInfo) &&
    ...
    private boolean isAtpActive(String gesValueAtpTypeKey, String atpTypeKey, Date date, ContextInfo contextInfo) throws MissingParameterException, PermissionDeniedException, InvalidParameterException, OperationFailedException {
        if (StringUtils.isEmpty(gesValueAtpTypeKey) || StringUtils.isEmpty(atpTypeKey)) {
            return true;
        }
        if (StringUtils.equals(gesValueAtpTypeKey, atpTypeKey)) {
                return true;
            }
