...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.ResultComponentTypeInfoHelper.Properties;


public class ResultComponentTypeInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "ResultComponentTypeInfoMetadata");
