...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.AttributeInfoHelper.Properties;


public class AttributeInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "AttributeInfoMetadata");
		...
		if (this.matches (type, state, "(default)", "(default)"))
		{
			...
			childMeta.getConstraints ().add (ConstraintMetadataBank.BANK.get ("dynamic.field.types"));
		}
