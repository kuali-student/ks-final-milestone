...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.orch.NewCreditCourseProposalHelper.Properties;
...
public class NewCreditCourseProposalMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "NewCreditCourseProposalMetadata");
