...
import org.kuali.student.lum.nlt.naturallanguage.util.CustomCluSetInfo;
...
public abstract class AbstractContext<T> implements Context<T> {
     ...
     * @throws OperationFailedException If building a custom CLU set fails
     */
    public CustomCluSetInfo getCluSet(CustomReqComponentInfo reqComponent) throws OperationFailedException {
...
//            String key = field.getKey();
     ...
     */
    public String getReqCompFieldValue(CustomReqComponentInfo reqComponent, String key) {
