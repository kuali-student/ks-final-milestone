...
@XmlRootElement(name = "removeOutcomeLoFromClu", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "removeOutcomeLoFromClu", namespace = "http://student.kuali.org/wsdl/lu", propOrder = {"loId","cluId"})

public class RemoveOutcomeLoFromClu {
