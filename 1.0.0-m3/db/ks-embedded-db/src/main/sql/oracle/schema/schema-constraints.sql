...
ALTER TABLE ENUM_VAL_FLD_ENT
    ADD CONSTRAINT FK5D0DCFCE32448E4B FOREIGN KEY (ENUM_META_ENT_ID)
...
ALTER TABLE KSLU_CLU
    ADD CONSTRAINT FK1C27ACBEEA0EF546 FOREIGN KEY (RT_MKTG_DESCR_ID)
    REFERENCES KS_RICH_TEXT_T (ID)
/
...
ALTER TABLE KSLU_LO_CATEGORY
    ADD CONSTRAINT KSLU_LO_CATEGORY_FK_1 FOREIGN KEY (LO_REPO_ID)
    REFERENCES KSLU_LO_REPOSITORY (ID)
/
...
ALTER TABLE KSLU_LO_CATEGORY_TYPE_ATTR
    ADD CONSTRAINT KSLU_LO_CATEGORY_TYPE_ATT_FK_1 FOREIGN KEY (OWNER)
    REFERENCES KSLU_LO_CATEGORY_TYPE (ID)
/
