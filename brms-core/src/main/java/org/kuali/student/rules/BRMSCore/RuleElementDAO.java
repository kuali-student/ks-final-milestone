...
public interface RuleElementDAO {
     ...
     * @param ruleElement A rule element to persist in database.
     ...
     * @param ruleElement A rule element to update in database.
     ...
     * @param id ID of Rule Element to find in database.
     ...
     * @param ruleElement A rule element to delete from database.
