...
public interface RulePropositionDAO {
     ...
     * @param ruleProposition A rule proposition to persist in database.
     ...
     * @param ruleProposition Rule Proposition to update in database.
     ...
     * @param id ID of Rule Proposition to find in database.
     ...
     * @param ruleProposition Rule Proposition to delete from database.
