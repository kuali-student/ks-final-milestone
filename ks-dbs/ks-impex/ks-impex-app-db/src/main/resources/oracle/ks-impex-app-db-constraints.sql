...
ALTER TABLE KSEN_LRR
    ADD CONSTRAINT KSEN_LRR_FK1 FOREIGN KEY (RT_DESCR_ID)
    REFERENCES KSEN_RICH_TEXT_T (ID)
/

ALTER TABLE KSEN_LRR
    ADD CONSTRAINT KSEN_LRR_FK2 FOREIGN KEY (TYPE_ID)
    REFERENCES KSEN_LRR_TYPE (TYPE_KEY)
/


ALTER TABLE KSEN_LRR_ATTR
    ADD CONSTRAINT KSEN_LRR_ATTR_FK1 FOREIGN KEY (OWNER_ID)
...
ALTER TABLE KSEN_SCHED_REF_OBJECT
    ADD CONSTRAINT KSEN_SCHED_REF_OBJECT_FK1 FOREIGN KEY (SCHED_RQST_SET_ID)
    REFERENCES KSEN_SCHED_RQST_SET (ID)
/


ALTER TABLE KSEN_SCHED_RQST
    ADD CONSTRAINT KSEN_SCHED_RQST_FK2 FOREIGN KEY (SCHED_RQST_SET_ID)
    REFERENCES KSEN_SCHED_RQST_SET (ID)
/
...
ALTER TABLE KSEN_SCHED_RQST_SET_ATTR
    ADD CONSTRAINT KSEN_SCHED_RQST_SET_ATTR_FK1 FOREIGN KEY (OWNER_ID)
    REFERENCES KSEN_SCHED_RQST_SET (ID)
/
