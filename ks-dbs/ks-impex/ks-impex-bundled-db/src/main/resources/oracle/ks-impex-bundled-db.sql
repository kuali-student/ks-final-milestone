...
ALTER TABLE KSEN_SCHED_REF_OBJECT
    ADD CONSTRAINT KSEN_SCHED_REF_OBJECTP1
PRIMARY KEY (SCHED_RQST_SET_ID,REF_OBJECT_ID)
/


CREATE INDEX KSEN_SCHED_REF_OBJECT_IF1 
  ON KSEN_SCHED_REF_OBJECT 
  (SCHED_RQST_SET_ID)
/
...
CREATE INDEX KSEN_SCHED_RQST_SET_I1 
  ON KSEN_SCHED_RQST_SET 
  (SCHED_RQST_SET_TYPE)
/
CREATE INDEX KSEN_SCHED_RQST_SET_I2 
  ON KSEN_SCHED_RQST_SET 
  (REF_OBJECT_TYPE)
/
...
CREATE INDEX KSEN_SCHED_RQST_SET_ATTR_IF1 
  ON KSEN_SCHED_RQST_SET_ATTR 
  (OWNER_ID)
/
...
CREATE SEQUENCE KRMS_TERM_SPEC_S INCREMENT BY 1 START WITH 10015 NOMAXVALUE NOCYCLE NOCACHE ORDER
/
...
CREATE SEQUENCE KRMS_TYP_S INCREMENT BY 1 START WITH 10077 NOMAXVALUE NOCYCLE NOCACHE ORDER
/
