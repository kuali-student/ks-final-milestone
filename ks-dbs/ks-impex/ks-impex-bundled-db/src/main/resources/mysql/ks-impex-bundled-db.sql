...
(
    ...
    , CONSTRAINT KSCO_REFERENCE_U1 UNIQUE (REFERENCE_ID, REFERENCE_TYPE)
...
(
    ...
    , CONSTRAINT KSEM_CTX_T_U1 UNIQUE (CTX_KEY, CTX_VAL)
...
(
      ID VARCHAR(255)
        ...
        , UPDATETIME DATETIME
        , UPDATEID VARCHAR(255)
        , IS_INITIAL_STATE DECIMAL(1) default 0 NOT NULL
...
(
    ...
    , CONSTRAINT KSLO_LO_JN_LOCATEGORY_U1 UNIQUE (LO_ID, LOCATEGORY_ID)
...
(
    ...
    , CONSTRAINT KSLU_CLU_U1 UNIQUE (VER_IND_ID, SEQ_NUM)
...
(
    ...
    , CONSTRAINT KSLU_CLURES_JN_RESOPT_U1 UNIQUE (RES_OPT_ID)
...
(
    ...
    , CONSTRAINT KSLU_CLU_JN_ACCRED_U1 UNIQUE (CLU_ACCRED_ID)
...
(
    ...
    , CONSTRAINT KSLU_CLU_JN_CLU_IDENT_U1 UNIQUE (ALT_CLU_ID)
...
(
    ...
    , CONSTRAINT KSLU_CLU_JN_CLU_INSTR_U1 UNIQUE (CLU_INSTR_ID)
...
(
    ...
    , CONSTRAINT KSLU_CLU_PUBL_JN_CLU_INSTR_U1 UNIQUE (CLU_INSTR_ID)
...
(
    ...
    , CONSTRAINT KSLU_CLU_PUBL_VARI_U1 UNIQUE (VARI_KEY, OWNER)
...
(
    ...
    , CONSTRAINT KSLU_MEMSHIP_KSLU_SPARAM_U1 UNIQUE (SEARCHPARAMETERS_ID)
...
(
    ...
    , CONSTRAINT KSLU_RSRC_U1 UNIQUE (RSRC_TYPE_ID, CLU_ID)
...
(
    ...
    , CONSTRAINT KSLU_SPARAM_KSLU_SPVALUE_U1 UNIQUE (VALUES_ID)
...
(
    ...
    , CONSTRAINT KSOR_ORG_PERS_RELTN_U1 UNIQUE (ORG_PERS_RELTN_TYPE, ORG, PERS_ID)
...
(
    ...
    , CONSTRAINT KSOR_ORG_POS_RESTR_U1 UNIQUE (ORG, PERS_RELTN_TYPE)
...
(
    ...
    , CONSTRAINT KSST_OBJ_TYP_JN_OBJ_SUB_TYP_U1 UNIQUE (OBJ_SUB_TYPE_ID)
...
(
    ...
    , CONSTRAINT KSST_RC_JN_RC_FIELD_U1 UNIQUE (REQ_COM_FIELD_ID)
...
(
    ...
    , CONSTRAINT KSST_STMT_JN_STMT_U1 UNIQUE (CHLD_STMT_ID)
...
/
ALTER TABLE KRMS_TERM_SPEC_S auto_increment = 10015
/
...
/
ALTER TABLE KRMS_TYP_RELN_S auto_increment = 10117
/
...
/
ALTER TABLE KRMS_TYP_S auto_increment = 10077
/
