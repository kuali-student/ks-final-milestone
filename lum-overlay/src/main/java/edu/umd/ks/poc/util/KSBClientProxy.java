...
/**
 * This class creates a proxy for services deployed on KSB. A reference to the service is obtained
 * only upon the first method invocation.
 *
 */
public class KSBClientProxy implements InvocationHandler {
    ...
    /**
     * This overridden method invokes the proxied service method. 
     */
    @Override
