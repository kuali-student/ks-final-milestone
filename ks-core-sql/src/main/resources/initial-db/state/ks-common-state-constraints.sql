...
ALTER TABLE KSEN_STATEPROCESS_RELTN
    ADD CONSTRAINT FKCDFDC0E09F94F29D FOREIGN KEY (NEXT_STATEKEY)
    REFERENCES KSEN_COMM_STATE (ID)
/

ALTER TABLE KSEN_STATEPROCESS_RELTN
    ADD CONSTRAINT FKCDFDC0E0D6162101 FOREIGN KEY (PROCESS_KEY)
    REFERENCES KSEN_STATE_PROCESS (ID)
/

ALTER TABLE KSEN_STATEPROCESS_RELTN
    ADD CONSTRAINT FKCDFDC0E024D2ACA6 FOREIGN KEY (PRIOR_STATEKEY)
    REFERENCES KSEN_COMM_STATE (ID)
/
