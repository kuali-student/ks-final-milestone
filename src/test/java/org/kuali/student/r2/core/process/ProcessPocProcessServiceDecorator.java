...
public class ProcessPocProcessServiceDecorator extends ProcessServiceDecorator {
    ...
    public void init() {
        ...
        _createCheck(ProcessPocConstants.CHECK_ID_HAS_OVERDUE_LIBRARY_BOOK, ProcessServiceConstants.HOLD_CHECK_TYPE_KEY,
                "kuali.hold.issue.library.book.overdue", "", "", "", "has overdue library book",
                "Checks if student has an overdue library book", context);
        _createCheck(ProcessPocConstants.CHECK_ID_HAS_NOT_PAID_BILL_FROM_PRIOR_TERM, ProcessServiceConstants.HOLD_CHECK_TYPE_KEY,
        ...
        _createCheck(ProcessPocConstants.CHECK_ID_STUDENT_HAS_BASIC_ELIGIBILITY, ProcessServiceConstants.PROCESS_CHECK_TYPE_KEY,
        ...
        _createCheck(ProcessPocConstants.CHECK_ID_REGISTRATION_PERIOD_IS_OPEN, ProcessServiceConstants.START_DATE_CHECK_TYPE_KEY,
                "", "kuali.atp.milestone.RegistrationPeriod", "", "", "registration period is open",
                "Checks that the registration period is open", context);
        _createCheck(ProcessPocConstants.CHECK_ID_REGISTRATION_PERIOD_IS_NOT_CLOSED,
        ...
        _createCheck(ProcessPocConstants.CHECK_ID_REGISTRATION_HOLDS_CLEARED, ProcessServiceConstants.PROCESS_CHECK_TYPE_KEY, "",
