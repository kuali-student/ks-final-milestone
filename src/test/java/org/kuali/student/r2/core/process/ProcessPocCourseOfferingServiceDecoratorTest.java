 ...
 * @author nwright
 */
public class ProcessPocCourseOfferingServiceDecoratorTest {

    public ProcessPocCourseOfferingServiceDecoratorTest() {
    }
    ...
    public void testSomeMethod() throws Exception {
        ...
        coService = new ProcessPocCourseOfferingServiceDecorator(coService);
