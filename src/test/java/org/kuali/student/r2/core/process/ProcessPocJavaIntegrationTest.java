...
import org.kuali.student.enrollment.class2.courseregistration.service.impl.CourseRegistrationServiceMapImpl;
...
import org.kuali.student.r2.core.exemption.service.impl.ExemptionServiceMapImpl;
...
public class ProcessPocJavaIntegrationTest {
    ...
    @Before
    public void setUp() {
        CourseRegistrationService decorator = new CourseRegistrationServiceProcessCheckDecorator(new CourseRegistrationServiceMapImpl());
        ...
        ExemptionService exemptionService = new ProcessPocExemptionServiceDecorator(new ExemptionServiceMapImpl());
