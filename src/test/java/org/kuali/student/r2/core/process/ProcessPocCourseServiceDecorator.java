 ...
 * @author nwright
 */
public class ProcessPocCourseServiceDecorator extends CourseServiceDecorator {

    public ProcessPocCourseServiceDecorator() {
    }

    public ProcessPocCourseServiceDecorator(CourseService nextDecorator) {
        super();
