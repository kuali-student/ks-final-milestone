...
import org.kuali.student.enrollment.class2.courseoffering.service.impl.CourseOfferingServiceDecorator;
 ...
 * @author nwright
 */
public class ProcessPocCourseOfferingServiceDecorator extends CourseOfferingServiceDecorator {

    public ProcessPocCourseOfferingServiceDecorator() {
    }

    public ProcessPocCourseOfferingServiceDecorator(CourseOfferingService nextDecorator) {
        super();
