 ...
 * @author nwright
 */
public class ProcessIntegrationTestAtpServiceDataLoadingDecorator extends AtpServiceDecorator {

    public ProcessIntegrationTestAtpServiceDataLoadingDecorator() {
    }
    public ProcessIntegrationTestAtpServiceDataLoadingDecorator(AtpService nextDecorator) {
        super();
    ...
    public void init() {
        ...
        AtpInfo spring2011 = this._createAtp(ProcessIntegrationTestConstants.SPRING_2011_TERM_KEY, AtpServiceConstants.ATP_SPRING_TYPE_KEY, "Spring 2011", "2011-02-01", "2011-05-31", context);
        AtpInfo summer2011 = this._createAtp(ProcessIntegrationTestConstants.SUMMER_2011_TERM_KEY, AtpServiceConstants.ATP_SUMMER_TYPE_KEY, "Summer 2011", "2011-06-01", "2011-08-31", context);
        AtpInfo fall2011 = this._createAtp(ProcessIntegrationTestConstants.FALL_2011_TERM_KEY, AtpServiceConstants.ATP_FALL_TYPE_KEY, "Fall 2011", "2011-09-01", "2011-12-31", context);
        AtpInfo spring2012 = this._createAtp(ProcessIntegrationTestConstants.SPRING_2012_TERM_KEY, AtpServiceConstants.ATP_SPRING_TYPE_KEY, "Spring 2012", "2012-02-01", "2012-05-31", context);
