...
INSERT INTO KRIM_ROLE_PERM_T (ACTV_IND,OBJ_ID,PERM_ID,ROLE_ID,ROLE_PERM_ID,VER_NBR)
  VALUES ('Y','5C27A267EF5C7417E0404F8189D830AA','24','63','754',1);
...
INSERT INTO KRIM_ATTR_DEFN_T (ACTV_IND,APPL_URL,KIM_ATTR_DEFN_ID,NM,LBL,NMSPC_CD,OBJ_ID,VER_NBR) 
  VALUES ('Y','${application.url}','100','department','Department','KS-ORG','5ADAA8B6D4AA7954E0404F8189D85002',1);
...
-- insert kim role for 'Department' users
