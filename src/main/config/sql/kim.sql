...
-- insert kim type for 'Department Committee'
...
INSERT INTO KRIM_TYP_T (ACTV_IND,KIM_TYP_ID,NM,NMSPC_CD,OBJ_ID,SRVC_NM,VER_NBR) 
  VALUES ('Y','100','Department Committee Type','KS-LUM','5ADF18B6ACACA954E040AA8189D85002','kimRoleTypeService',1);
...
-- insert kim role for 'Department Committee' responsibility to use
...
-- insert kim responsibility for 'Department Committee' route node
INSERT INTO KRIM_RSP_T (RSP_ID,NMSPC_CD,NM,ACTV_IND,RSP_TMPL_ID,VER_NBR,DESC_TXT,OBJ_ID) 
...
INSERT INTO KRIM_TYP_T (ACTV_IND,KIM_TYP_ID,NM,NMSPC_CD,OBJ_ID,SRVC_NM,VER_NBR) 
  VALUES ('Y','101','College Committee Type','KS-LUM','5ADF18B6ACACA95CE040AA8189D85002','kimRoleTypeService',1);
INSERT INTO KRIM_TYP_ATTR_T (ACTV_IND,KIM_ATTR_DEFN_ID,KIM_TYP_ATTR_ID,KIM_TYP_ID,OBJ_ID,SORT_CD,VER_NBR) 
...
INSERT INTO KRIM_ATTR_DEFN_T (ACTV_IND,APPL_URL,CMPNT_NM,KIM_ATTR_DEFN_ID,NM,LBL,NMSPC_CD,OBJ_ID,VER_NBR) 
  VALUES ('Y','${application.url}','org.kuali.rice.student.bo.KualiStudentKimAttributes','102','orgAdmin','Organization Admin','KS-LUM','ABCDA8B6D4AA7954E0404F8189D85002',1);
INSERT INTO KRIM_TYP_T (ACTV_IND,KIM_TYP_ID,NM,NMSPC_CD,OBJ_ID,SRVC_NM,VER_NBR) 
  VALUES ('Y','102','Org Admin Type','KS-LUM','ABCD18B6ACACA95CE040AA8189D85002','ksOrgAdminRoleTypeService',1);
INSERT INTO KRIM_TYP_ATTR_T (ACTV_IND,KIM_ATTR_DEFN_ID,KIM_TYP_ATTR_ID,KIM_TYP_ID,OBJ_ID,SORT_CD,VER_NBR) 
  VALUES ('Y','102','202','102','ABCD9976C06BAA02E0404F8189D86F11','a',1);

-- insert kim role for 'OrgAdmin' derived role
INSERT INTO KRIM_ROLE_T (ACTV_IND,KIM_TYP_ID,NMSPC_CD,OBJ_ID,ROLE_ID,ROLE_NM,VER_NBR) 
  VALUES ('Y','102','KS-LUM','ABCDF3RA08CF45CFAA404F8189D831AA','902','College Committee Reviewer',1);  
...
INSERT INTO KRIM_RSP_ATTR_DATA_T (ATTR_DATA_ID,ATTR_VAL,KIM_ATTR_DEFN_ID,KIM_TYP_ID,OBJ_ID,RSP_ID,VER_NBR) 
  VALUES ('10','CluDocument','13','7','AAAA0974GG28EF33E0404F8189AAAF24','4',1);
INSERT INTO KRIM_RSP_ATTR_DATA_T (ATTR_DATA_ID,ATTR_VAL,KIM_ATTR_DEFN_ID,KIM_TYP_ID,OBJ_ID,RSP_ID,VER_NBR) 
  VALUES ('11','Department Admin Review','16','7','AAAA09744GG8EF33E0404F8189AAAF24','4',1);
INSERT INTO KRIM_RSP_ATTR_DATA_T (ATTR_DATA_ID,ATTR_VAL,KIM_ATTR_DEFN_ID,KIM_TYP_ID,OBJ_ID,RSP_ID,VER_NBR) 
  VALUES ('12','false','41','7','AAAA097AAA28EF33E0404F81GGAAAF24','4',1);
INSERT INTO KRIM_RSP_ATTR_DATA_T (ATTR_DATA_ID,ATTR_VAL,KIM_ATTR_DEFN_ID,KIM_TYP_ID,OBJ_ID,RSP_ID,VER_NBR) 
  VALUES ('13','false','40','7','AAAA09744A28GA33E0404F818GGGAF24','4',1);
INSERT INTO KRIM_ROLE_RSP_T (ACTV_IND,OBJ_ID,RSP_ID,ROLE_ID,ROLE_RSP_ID,VER_NBR) 
  VALUES ('Y','AAAAA267EF607417E0404FG189DAA0A9','4','902','6',1);
INSERT INTO KRIM_ROLE_RSP_ACTN_T (ROLE_RSP_ACTN_ID,OBJ_ID,VER_NBR,ACTN_TYP_CD,ACTN_PLCY_CD,ROLE_MBR_ID,ROLE_RSP_ID,FRC_ACTN) 
  VALUES ('5','AAAAF3FA08CF45GFAA404FBB89D831AA',1,'A','F','*','6','Y');
  
-- insert kim responsibility for 'Senate Admin' route node
INSERT INTO KRIM_RSP_T (RSP_ID,NMSPC_CD,NM,ACTV_IND,RSP_TMPL_ID,VER_NBR,DESC_TXT,OBJ_ID) 
  VALUES ('5','KS-LUM','Review','Y','1',0,'Responsibility for Senate Admin Review','BBBBE1C2441D6320E04AAAA189D85169');
INSERT INTO KRIM_RSP_ATTR_DATA_T (ATTR_DATA_ID,ATTR_VAL,KIM_ATTR_DEFN_ID,KIM_TYP_ID,OBJ_ID,RSP_ID,VER_NBR) 
  VALUES ('14','CluDocument','13','7','BBBB0974GG28EF33E0404F8189AAAF24','5',1);
INSERT INTO KRIM_RSP_ATTR_DATA_T (ATTR_DATA_ID,ATTR_VAL,KIM_ATTR_DEFN_ID,KIM_TYP_ID,OBJ_ID,RSP_ID,VER_NBR) 
  VALUES ('15','Senate Admin Review','16','7','BBBB09744GG8EF33E0404F8189AAAF24','5',1);
INSERT INTO KRIM_RSP_ATTR_DATA_T (ATTR_DATA_ID,ATTR_VAL,KIM_ATTR_DEFN_ID,KIM_TYP_ID,OBJ_ID,RSP_ID,VER_NBR) 
  VALUES ('16','false','41','7','BBBB097AAA28EF33E0404F81GGAAAF24','5',1);
INSERT INTO KRIM_RSP_ATTR_DATA_T (ATTR_DATA_ID,ATTR_VAL,KIM_ATTR_DEFN_ID,KIM_TYP_ID,OBJ_ID,RSP_ID,VER_NBR) 
  VALUES ('17','false','40','7','BBBB09744A28GA33E0404F818GGGAF24','5',1);
INSERT INTO KRIM_ROLE_RSP_T (ACTV_IND,OBJ_ID,RSP_ID,ROLE_ID,ROLE_RSP_ID,VER_NBR) 
  VALUES ('Y','BBBBA267EF607417E0404FG189DAA0A9','5','902','7',1);
INSERT INTO KRIM_ROLE_RSP_ACTN_T (ROLE_RSP_ACTN_ID,OBJ_ID,VER_NBR,ACTN_TYP_CD,ACTN_PLCY_CD,ROLE_MBR_ID,ROLE_RSP_ID,FRC_ACTN) 
  VALUES ('6','BBBBF3FA08CF45GFAA404FBB89D831AA',1,'A','F','*','7','Y');
  
  
-- insert kim type for 'Senate Committee'
INSERT INTO KRIM_ATTR_DEFN_T (ACTV_IND,APPL_URL,CMPNT_NM,KIM_ATTR_DEFN_ID,NM,LBL,NMSPC_CD,OBJ_ID,VER_NBR) 
  VALUES ('Y','${application.url}','org.kuali.rice.student.bo.KualiStudentKimAttributes','103','senate','Senate','KS-LUM','ABCCA8B6D4AA7954E0404F8189D85002',1);
INSERT INTO KRIM_TYP_T (ACTV_IND,KIM_TYP_ID,NM,NMSPC_CD,OBJ_ID,SRVC_NM,VER_NBR) 
  VALUES ('Y','103','Senate Committee Type','KS-LUM','ABCC18B6ACACA95CE040AA8189D85002','kimRoleTypeService',1);
INSERT INTO KRIM_TYP_ATTR_T (ACTV_IND,KIM_ATTR_DEFN_ID,KIM_TYP_ATTR_ID,KIM_TYP_ID,OBJ_ID,SORT_CD,VER_NBR) 
  VALUES ('Y','103','203','103','ABCC9976C06BAA02E0404F8189D86F11','a',1);

-- insert kim role for 'Senate' responsibility to use
INSERT INTO KRIM_ROLE_T (ACTV_IND,KIM_TYP_ID,NMSPC_CD,OBJ_ID,ROLE_ID,ROLE_NM,VER_NBR) 
  VALUES ('Y','103','KS-LUM','ABCCF3RA08CF45CFAA404F8189D831AA','903','Senate Committee Reviewer',1);

-- insert kim responsibility for 'Senate' route node
INSERT INTO KRIM_RSP_T (RSP_ID,NMSPC_CD,NM,ACTV_IND,RSP_TMPL_ID,VER_NBR,DESC_TXT,OBJ_ID) 
...
INSERT INTO KRIM_ROLE_RSP_ACTN_T (ROLE_RSP_ACTN_ID,OBJ_ID,VER_NBR,ACTN_TYP_CD,ACTN_PLCY_CD,ROLE_MBR_ID,ROLE_RSP_ID,FRC_ACTN) 
  VALUES ('6','ABCCF3FA08CF45GFAA404FBB89D831AA',1,'A','F','*','8','Y');  
