 ...
 * @author nwright
 */
public class OrganizationLoaderModelFactory
{
 ...
 public OrganizationLoaderModel getModel ()
 {
...
//    System.out.println ("adding excelFile(" + i + ")=" + excelFileName);
  ...
  OrganizationLoaderModelExcelImpl model =
                                   new OrganizationLoaderModelExcelImpl (reader);
//  ContextFactory contextFactory = new ContextFactory ();
//  contextFactory.setConfig (config);
//  model.setContext (contextFactory.getInstance ());
  OrganizationLoaderModelCache cache = new OrganizationLoaderModelCache (model);
  return cache;
 }
}
