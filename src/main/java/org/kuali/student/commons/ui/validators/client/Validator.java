...
public interface Validator {
	 ...
	 * @param messages the internationalization messages to be used by the validator
	 */
	 ...
	 * Validates the object using the default attributes
	 * @param value the value to validate
	 * @param valueName the name of the value, used when interpolating error messages
	 * @return ValidationResult containing the validation state and messages
	 */
	 ...
	 * @param value the value to validate
	 * @param attributes the addition attributes to used for validation
	 * @return ValidationResult containing the validation state and messages
	 */
