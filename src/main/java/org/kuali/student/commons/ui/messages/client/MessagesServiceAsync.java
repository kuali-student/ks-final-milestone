...
public interface MessagesServiceAsync {
	 ...
	 * @param groupName the logical group name of the messages to retrieve 
	 * @param callback callback to be executed on response
	 */
	 ...
	 * @param locale locale code
	 * @param groupName the logical group names of the messages to retrieve 
	 * @param callback callback to be executed on response
	 */
	 ...
	 * @param locale locale for which to return the available message groups
	 * @param callback callback to be executed on response
	 */
