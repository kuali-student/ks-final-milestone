 ...
 * 
 * @param <T> the ModelObject type of the Model being bound to
 */
public class ModelBinding<T extends ModelObject>{
	 ...
	 * @param model the model to which to bind the widget
	 * @param widget the widget to which to bind the model
	 */
