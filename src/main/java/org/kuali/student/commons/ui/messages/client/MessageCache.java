...
public class MessageCache {
	/**
	 * Key used for retrieving preloaded messages from document body.
	 * Messages can be preloaded by the servlet/JSP that generates the page and embedded in the page content.
	 * TODO: rewrite this to use the "encode for response" mechanism provided by GWT 1.5, or remove as it really isn't used.
	 */
	 ...
	 * @param groupName the name of the group of messages to retrieve.
	 ...
	 * @param locale the locale to use when loading the messages
	 * @param groupName the name of the group of messages to retrieve.
	 * @param callback AsyncCallback<Messages> to be called on response.
	 */
	 ...
	 * Loads messages from messages service
	 * @param locale the locale to use when loading the messages
	 * @param groupNames the names of the groups of messages to retrieve.
	 * @param callback AsyncCallback<Map<String, Messages>> to be called on response. Map is keyed by group name.
	 */
