...
/**
 * Interface used with MetadataGenerator rebind generator. Used to implement some basic reflection capabilities for event types.
 */
public interface HasMetadata {
	 ...
	 * @param o HasMetadata instance to compare against
