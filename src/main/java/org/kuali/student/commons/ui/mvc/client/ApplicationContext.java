...
public class ApplicationContext {
	...
	/**
	 * Sets the current locale code. Warning: Do not call this method after any localized data has been retrieved from the server,
	 * or the locales will be out of sync.
	...
	/**
	 * Returns the security context for the page view.
	 * TODO: integrate with actual security framework once it has been determined
	 ...
	 * @param viewName the name of the view for which to load metadata
	 * @param callback callback to be used to signal load complete
	 */
	...
	/** 
	 * Returns reference to global event dispatcher.  Global event dispatcher should only be used for events that are not view specific,
	 * such as global "busy indicators" or login/logout events, etc.
	 * @return
	 */
