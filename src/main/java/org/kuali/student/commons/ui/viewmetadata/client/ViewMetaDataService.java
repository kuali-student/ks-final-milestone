...
public interface ViewMetaDataService extends RemoteService {
	/**
	 * Returns the ViewMetaData for the specified viewName, and internationalization for that view associated with the specified locale
	 * @param locale the locale to use when retrieving internationalization messages
	 * @param viewName the view for which to retrieve metadata
	 * @return the ViewMetaData for the specified viewName, and internationalization for that view associated with the specified locale
	 */
	public ViewMetaData getViewMetaData(String locale, String viewName);
	
	/**
	 * Returns the ViewMetaData for the specified viewNames, and internationalization for those views associated with the specified locale
	 * @param locale the locale to use when retrieving internationalization messages
	 * @param viewNames the views for which to retrieve metadata
	 * @return the ViewMetaData for the specified viewNames, and internationalization for those views associated with the specified locale
	 */
