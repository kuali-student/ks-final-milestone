...
@XmlRootElement(name = "createPerson", namespace = "http://student.kuali.org/poc/wsdl/personidentity/person/service")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "createPerson", namespace = "http://student.kuali.org/poc/wsdl/personidentity/person/service")

public class CreatePerson {

    @XmlElement(name = "personCreateInfo")
    private org.kuali.student.poc.personidentity.person.dto.PersonCreateInfo personCreateInfo;
    @XmlElement(name = "personTypeKeys")
    private java.util.List<String> personTypeKeys;

    public org.kuali.student.poc.personidentity.person.dto.PersonCreateInfo getPersonCreateInfo() {
        return this.personCreateInfo;
    }
    
    public void setPersonCreateInfo( org.kuali.student.poc.personidentity.person.dto.PersonCreateInfo newPersonCreateInfo ) {
