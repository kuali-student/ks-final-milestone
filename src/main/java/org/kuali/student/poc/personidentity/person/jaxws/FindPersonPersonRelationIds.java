...
@XmlRootElement(name = "findPersonPersonRelationIds", namespace = "http://student.kuali.org/poc/wsdl/personidentity/person/service")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findPersonPersonRelationIds", namespace = "http://student.kuali.org/poc/wsdl/personidentity/person/service")

public class FindPersonPersonRelationIds {
