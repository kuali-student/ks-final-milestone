 ...
 * @author nwright
 */
public class AlwaysFalseCheckProposition extends AbstractCheckProposition {

    public AlwaysFalseCheckProposition(InstructionInfo instruction, CheckInfo check) {
