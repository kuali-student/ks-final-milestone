 ...
 * @author nwright
 */
public class MaxValueCheckProposition extends AbstractValueCheckProposition {

    public MaxValueCheckProposition(InstructionInfo instruction, CheckInfo check) {
        super(instruction, check);
    }

    @Override
    protected String getExemptionTypeToLookFor() {
        return ExemptionServiceConstants.CHECK_VALUE_MAX_EXEMPTION_TYPE_KEY;
    }
