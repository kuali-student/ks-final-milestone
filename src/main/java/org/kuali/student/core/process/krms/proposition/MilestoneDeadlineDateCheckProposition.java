 ...
 * @author nwright
 */
public class MilestoneDeadlineDateCheckProposition extends AbstractMilestoneDateCheckProposition {

    public MilestoneDeadlineDateCheckProposition(InstructionInfo instruction, CheckInfo check) {
