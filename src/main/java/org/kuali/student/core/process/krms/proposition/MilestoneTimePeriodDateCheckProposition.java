...
/**
 * Proposition that evaluates a milestone range (time period) check
 *
 * @author nwright
 */
public class MilestoneTimePeriodDateCheckProposition extends AbstractMilestoneDateCheckProposition {

    public MilestoneTimePeriodDateCheckProposition(InstructionInfo instruction, CheckInfo check) {
