...
public class CheckBoxListExample extends Composite {
    ...
    public CheckBoxListExample(){
        KSCheckBoxList checkBoxList = new KSCheckBoxList("Colors");
        ...
        checkBoxList.setListItems(tableItems);
        checkBoxList.addSelectionChangeHandler(new SelectionChangeHandler(){

            @Override
            public void onSelectionChange(KSSelectItemWidgetAbstract w) {
               List<String> selectedItems = w.getSelectedItems();
               String selectedString = "Selected Color(s): \n";
