...
public class InfoDialogExampleDescriptor extends KitchenSinkExample {
    ...
    public String getDescription() {       
        return "InfoDialogPanel is a panel that can pop up over other widgets. It overlays the browser's client area (and any previously-created popups). It is not modal, i.e. user can still interact with other panels "; 
    }
