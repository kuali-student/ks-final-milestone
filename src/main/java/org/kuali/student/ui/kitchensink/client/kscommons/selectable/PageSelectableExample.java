 ...
 *
 */
public class PageSelectableExample extends Composite {
    ...
    final KSLabel label = new KSLabel("Paging and scrollable table with sortable columns" +
     ...
     */
    private CachedTableModel<Person> cachedTableModel = null;
    ...
    public PageSelectableExample(int pageSize) {

        createCachedTableModel(pageSize);
        TableDefinition<Person> tableDef = createTableDefinition();
        pagingScrollTable = new PagingScrollTable<Person>(cachedTableModel,tableDef);
        ...
        FlexCellFormatter flexCellFormatter = tableAndSelection.getFlexCellFormatter();
        flexCellFormatter.setRowSpan(row, 1, 2);
        row++;
        tableAndSelection.insertRow(row);
        tableAndSelection.insertCell(row, 0);
    ...
    private void createCachedTableModel(int pageSize) {
        ...
        cachedTableModel = new CachedTableModel<Person>(tableModel);
     ...
     */
    public CachedTableModel<Person> getCachedTableModel() {
