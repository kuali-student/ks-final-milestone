...
public class KSSuggestBoxPicker<T extends Idable> extends Composite{
    ...
    private PagingScrollTable<T> listWidget;
    ...
    public KSSuggestBoxPicker(KSSuggestBoxWAdvSearch suggestWidget, PagingScrollTable<T> widget){
