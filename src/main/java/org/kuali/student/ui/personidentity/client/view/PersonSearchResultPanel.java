...
public class PersonSearchResultPanel extends Composite {
    ...
    public static class SelectPersonEvent extends MVCEvent {
        static {
            EventTypeRegistry.register(SelectPersonEvent.class, new SelectPersonEvent().getHierarchy());
        }
        public EventTypeHierarchy getHierarchy() {
            return super.getHierarchy().add(SelectPersonEvent.class);
        }
    }
    static {
        new SelectPersonEvent();
    }
