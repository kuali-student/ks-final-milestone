 ...
 * @author nwright
 */
public class LookupImplMetadataWriter
{

 private JavaClassWriter out;
 private String name;
 private LookupImplMetadata implMeta;

 public LookupImplMetadataWriter (JavaClassWriter out,
                                   String name,
                                   LookupImplMetadata implMeta)
 {
  this.out = out;
  this.name = name;
  this.implMeta = implMeta;
 }

 public void write ()
 {
  out.imports.add (LookupImplMetadata.class.getName ());
  writeSetValue ("Service", implMeta.getService ());
  writeSetValue ("Type", implMeta.getType ());
  writeSetValue ("Info", implMeta.getInfo ());
 }
