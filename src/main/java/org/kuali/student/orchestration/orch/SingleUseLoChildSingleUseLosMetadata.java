...
import org.kuali.student.orchestration.orch.SingleUseLoChildSingleUseLosHelper.Properties;


public class SingleUseLoChildSingleUseLosMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "SingleUseLoChildSingleUseLosMetadata");
		...
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.CHILD_LO.getKey (), childMeta);
		...
		childMeta.setDataType (Data.DataType.STRING);
		childMeta.setWriteAccess (Metadata.WriteAccess.NEVER);
		childMeta.setDefaultValue (new Data.StringValue ("kuali.lo.relation.type.includes"));
		if (this.matches (type, state, "(default)", "(default)"))
		{
			childMeta.getConstraints ().add (ConstraintMetadataBank.BANK.get ("single"));
			childMeta.getConstraints ().add (ConstraintMetadataBank.BANK.get ("hard.coded.lolorealtion.includes"));
			childMeta.getConstraints ().add (ConstraintMetadataBank.BANK.get ("hard.coded.lolorealtion.includes"));
