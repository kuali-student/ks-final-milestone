...
public class NewCreditCourseProposalDataHelper
{
	...
	public NewCreditCourseProposalDataHelper (ModifiableData data)
	{
		this.data = data;
	}
	...
	public void setBasedOn (CreditCourseDataHelper value)
	{
		data.set (Properties.BASED_ON.getKey (), value.getData ());
	}
	
	
	public CreditCourseDataHelper getBasedOn ()
	{
		return new CreditCourseDataHelper ((ModifiableData) data.get (Properties.BASED_ON.getKey ()));
	}
