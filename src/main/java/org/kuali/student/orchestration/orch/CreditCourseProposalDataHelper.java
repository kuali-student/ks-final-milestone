...
public class CreditCourseProposalDataHelper
{
	...
	public CreditCourseProposalDataHelper (ModifiableData data)
	{
		this.data = data;
	}
	...
	public void setRationale (RichTextInfoDataHelper value)
	{
		data.set (Properties.RATIONALE.getKey (), value.getData ());
	}
	
	
	public RichTextInfoDataHelper getRationale ()
	{
		return new RichTextInfoDataHelper ((Data) data.get (Properties.RATIONALE.getKey ()));
	}
	...
	public void setCreditCourse (CreditCourseDataHelper value)
	{
		data.set (Properties.CREDIT_COURSE.getKey (), value.getData ());
	}
	
	
	public CreditCourseDataHelper getCreditCourse ()
	{
		return new CreditCourseDataHelper ((ModifiableData) data.get (Properties.CREDIT_COURSE.getKey ()));
	}
