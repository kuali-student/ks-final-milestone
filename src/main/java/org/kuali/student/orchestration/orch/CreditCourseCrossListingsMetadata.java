...
import org.kuali.student.orchestration.orch.CreditCourseCrossListingsHelper.Properties;
...
public class CreditCourseCrossListingsMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "CreditCourseCrossListingsMetadata");
