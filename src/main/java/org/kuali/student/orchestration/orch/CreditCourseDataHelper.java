...
public class CreditCourseDataHelper
{
	...
	public CreditCourseDataHelper (ModifiableData data)
	{
		this.data = data;
	}
	...
	public void setTranscriptTitle (RichTextInfoDataHelper value)
	{
		data.set (Properties.TRANSCRIPT_TITLE.getKey (), value.getData ());
	}
	
	
	public RichTextInfoDataHelper getTranscriptTitle ()
	{
		return new RichTextInfoDataHelper ((Data) data.get (Properties.TRANSCRIPT_TITLE.getKey ()));
	}
	
	
	public void setCourseTitle (RichTextInfoDataHelper value)
	{
		data.set (Properties.COURSE_TITLE.getKey (), value.getData ());
	}
	
	
	public RichTextInfoDataHelper getCourseTitle ()
	{
		return new RichTextInfoDataHelper ((Data) data.get (Properties.COURSE_TITLE.getKey ()));
	}
	
	
	public void setDescription (RichTextInfoDataHelper value)
	{
		data.set (Properties.DESCRIPTION.getKey (), value.getData ());
	}
	
	
	public RichTextInfoDataHelper getDescription ()
	{
		return new RichTextInfoDataHelper ((Data) data.get (Properties.DESCRIPTION.getKey ()));
	}
