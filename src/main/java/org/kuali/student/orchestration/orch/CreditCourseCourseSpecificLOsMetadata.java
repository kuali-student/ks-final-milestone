...
import org.kuali.student.orchestration.orch.CreditCourseCourseSpecificLOsHelper.Properties;
...
public class CreditCourseCourseSpecificLOsMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "CreditCourseCourseSpecificLOsMetadata");
