...
public class CluInfoDataHelper
{
	...
	public CluInfoDataHelper (ModifiableData data)
	{
		this.data = data;
	}
	...
	public void setOfficialIdentifier (CluIdentifierInfoDataHelper value)
	{
		data.set (Properties.OFFICIAL_IDENTIFIER.getKey (), value.getData ());
	}
	
	
	public CluIdentifierInfoDataHelper getOfficialIdentifier ()
	{
		return new CluIdentifierInfoDataHelper ((Data) data.get (Properties.OFFICIAL_IDENTIFIER.getKey ()));
	}
	...
	public void setMarketingDesc (RichTextInfoDataHelper value)
	{
		data.set (Properties.MARKETING_DESC.getKey (), value.getData ());
	}
	
	
	public RichTextInfoDataHelper getMarketingDesc ()
	{
		return new RichTextInfoDataHelper ((Data) data.get (Properties.MARKETING_DESC.getKey ()));
	}
	...
	public void setPrimaryAdminOrg (AdminOrgInfoDataHelper value)
	{
		data.set (Properties.PRIMARY_ADMIN_ORG.getKey (), value.getData ());
	}
	
	
	public AdminOrgInfoDataHelper getPrimaryAdminOrg ()
	{
		return new AdminOrgInfoDataHelper ((Data) data.get (Properties.PRIMARY_ADMIN_ORG.getKey ()));
	}
	...
	public void setPrimaryInstructor (CluInstructorInfoDataHelper value)
	{
		data.set (Properties.PRIMARY_INSTRUCTOR.getKey (), value.getData ());
	}
	
	
	public CluInstructorInfoDataHelper getPrimaryInstructor ()
	{
		return new CluInstructorInfoDataHelper ((Data) data.get (Properties.PRIMARY_INSTRUCTOR.getKey ()));
	}
	...
	public void setIntensity (TimeAmountInfoDataHelper value)
	{
		data.set (Properties.INTENSITY.getKey (), value.getData ());
	}
	
	
	public TimeAmountInfoDataHelper getIntensity ()
	{
		return new TimeAmountInfoDataHelper ((Data) data.get (Properties.INTENSITY.getKey ()));
	}
	
	
	public void setStdDuration (TimeAmountInfoDataHelper value)
	{
		data.set (Properties.STD_DURATION.getKey (), value.getData ());
	}
	
	
	public TimeAmountInfoDataHelper getStdDuration ()
	{
		return new TimeAmountInfoDataHelper ((Data) data.get (Properties.STD_DURATION.getKey ()));
	}
	...
	public void setPublishingInfo (CluPublishingInfoDataHelper value)
	{
		data.set (Properties.PUBLISHING_INFO.getKey (), value.getData ());
	}
	
	
	public CluPublishingInfoDataHelper getPublishingInfo ()
	{
		return new CluPublishingInfoDataHelper ((Data) data.get (Properties.PUBLISHING_INFO.getKey ()));
	}
	...
	public void setFeeInfo (CluFeeInfoDataHelper value)
	{
		data.set (Properties.FEE_INFO.getKey (), value.getData ());
	}
	
	
	public CluFeeInfoDataHelper getFeeInfo ()
	{
		return new CluFeeInfoDataHelper ((Data) data.get (Properties.FEE_INFO.getKey ()));
	}
	
	
	public void setAccountingInfo (CluAccountingInfoDataHelper value)
	{
		data.set (Properties.ACCOUNTING_INFO.getKey (), value.getData ());
	}
	
	
	public CluAccountingInfoDataHelper getAccountingInfo ()
	{
		return new CluAccountingInfoDataHelper ((Data) data.get (Properties.ACCOUNTING_INFO.getKey ()));
	}
