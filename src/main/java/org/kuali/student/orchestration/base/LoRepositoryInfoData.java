...
public class LoRepositoryInfoData
	extends Data
{
	...
	public LoRepositoryInfoData ()
	{
		// TODO: ask Wil if we want to really use the class name as the key
		super (LoRepositoryInfo.class.getName ());
	}
	...
	{
		super.set (Properties.ROOT_LO_ID.getKey (), value);
	}
	
	
	public String getRootLoId ()
	{
		return super.get (Properties.ROOT_LO_ID.getKey ());
	}
