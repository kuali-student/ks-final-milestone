...
public class ProposalDocRelationInfoData
	extends ModifiableData
{
	...
	public ProposalDocRelationInfoData ()
	{
		// TODO: ask Wil if we want to really use the class name as the key
		super (ProposalDocRelationInfo.class.getName ());
	}
	
	public void setProposalId (String value)
	{
		super.set (Properties.PROPOSAL_ID.getKey (), value);
	}
	
	
	public String getProposalId ()
	{
		return super.get (Properties.PROPOSAL_ID.getKey ());
	}
	
	
	public void setDocumentId (String value)
	{
		super.set (Properties.DOCUMENT_ID.getKey (), value);
	}
	
	
	public String getDocumentId ()
	{
		return super.get (Properties.DOCUMENT_ID.getKey ());
	}
	
	
	public void setTitle (String value)
	{
		super.set (Properties.TITLE.getKey (), value);
	}
