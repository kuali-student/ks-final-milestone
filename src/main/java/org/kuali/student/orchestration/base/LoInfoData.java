	...
	extends ModifiableData
{
	...
	{
		super.set (Properties.LO_REPOSITORY_KEY.getKey (), value);
	}
	
	
	public String getLoRepositoryKey ()
	{
		return super.get (Properties.LO_REPOSITORY_KEY.getKey ());
	}
