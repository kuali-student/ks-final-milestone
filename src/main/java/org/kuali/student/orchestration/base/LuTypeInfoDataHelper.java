...
public class LuTypeInfoDataHelper
{
	...
	public LuTypeInfoDataHelper (Data data)
	{
		this.data = data;
	}
	...
	public void setInstructionalFormat (String value)
	{
		data.set (Properties.INSTRUCTIONAL_FORMAT.getKey (), value);
	}
	
	
	public String getInstructionalFormat ()
	{
		return (String) data.get (Properties.INSTRUCTIONAL_FORMAT.getKey ());
	}
	
	
	public void setDeliveryMethod (String value)
	{
		data.set (Properties.DELIVERY_METHOD.getKey (), value);
	}
	
	
	public String getDeliveryMethod ()
	{
		return (String) data.get (Properties.DELIVERY_METHOD.getKey ());
	}
