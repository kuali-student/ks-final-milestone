...
public class FieldDescriptorInfoDataHelper
{
	...
	public FieldDescriptorInfoDataHelper (Data data)
	{
		this.data = data;
	}
	...
	public void setEnumFieldView (EnumFieldViewInfoDataHelper value)
	{
		data.set (Properties.ENUM_FIELD_VIEW.getKey (), value.getData ());
	}
	
	
	public EnumFieldViewInfoDataHelper getEnumFieldView ()
	{
		return new EnumFieldViewInfoDataHelper ((Data) data.get (Properties.ENUM_FIELD_VIEW.getKey ()));
	}
