...
public class DocumentBinaryInfoData
	extends Data
{
	...
	public DocumentBinaryInfoData ()
	{
		// TODO: ask Wil if we want to really use the class name as the key
		super (DocumentBinaryInfo.class.getName ());
	}
	
	public void setBinary (String value)
	{
		super.set (Properties.BINARY.getKey (), value);
	}
	
	
	public String getBinary ()
	{
		return super.get (Properties.BINARY.getKey ());
	}
