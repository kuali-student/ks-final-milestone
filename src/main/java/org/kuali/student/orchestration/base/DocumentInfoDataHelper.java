...
public class DocumentInfoDataHelper
{
	...
	public DocumentInfoDataHelper (ModifiableData data)
	{
		this.data = data;
	}
	...
	{
		data.set (Properties.FILE_NAME.getKey (), value);
	}
	
	
	public String getFileName ()
	{
		return (String) data.get (Properties.FILE_NAME.getKey ());
	}
	...
	public void setDocumentBinaryInfo (DocumentBinaryInfoDataHelper value)
	{
		data.set (Properties.DOCUMENT_BINARY_INFO.getKey (), value.getData ());
	}
	
	
	public DocumentBinaryInfoDataHelper getDocumentBinaryInfo ()
	{
		return new DocumentBinaryInfoDataHelper ((Data) data.get (Properties.DOCUMENT_BINARY_INFO.getKey ()));
	}
