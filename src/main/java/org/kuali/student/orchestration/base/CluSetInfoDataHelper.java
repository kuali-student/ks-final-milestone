...
public class CluSetInfoDataHelper
{
	...
	public CluSetInfoDataHelper (ModifiableData data)
	{
		this.data = data;
	}
	...
	public void setMembershipQuery (MembershipQueryInfoDataHelper value)
	{
		data.set (Properties.MEMBERSHIP_QUERY.getKey (), value.getData ());
	}
	
	
	public MembershipQueryInfoDataHelper getMembershipQuery ()
	{
		return new MembershipQueryInfoDataHelper ((Data) data.get (Properties.MEMBERSHIP_QUERY.getKey ()));
	}
