...
public class LoLoRelationInfoDataHelper
{
	...
	public LoLoRelationInfoDataHelper (ModifiableData data)
	{
		this.data = data;
	}
	...
	{
		data.set (Properties.LO_ID.getKey (), value);
	}
	
	
	public String getLoId ()
	{
		return (String) data.get (Properties.LO_ID.getKey ());
	}
	
	
	public void setRelatedLoId (String value)
	{
		data.set (Properties.RELATED_LO_ID.getKey (), value);
	}
	
	
	public String getRelatedLoId ()
	{
		return (String) data.get (Properties.RELATED_LO_ID.getKey ());
	}
