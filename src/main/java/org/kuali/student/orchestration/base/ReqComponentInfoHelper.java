...
import org.kuali.student.orchestration.base.ReqCompFieldInfoHelper;
import org.kuali.student.orchestration.base.RichTextInfoHelper;


public class ReqComponentInfoHelper
{
	...
	public ReqComponentInfoHelper (ModifiableData data)
	{
		this.data = data;
	}
