...
import org.kuali.student.orchestration.base.ReqCompFieldTypeInfoHelper.Properties;
...
public class ReqCompFieldTypeInfoMetadata
{
	...
	public void loadChildMetadata (Metadata mainMeta, String type, String state)
	{
		...
		new FieldDescriptorInfoMetadata ().loadChildMetadata (childMeta, type, state);
