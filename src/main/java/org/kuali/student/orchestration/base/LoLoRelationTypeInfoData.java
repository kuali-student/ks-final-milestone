...
public class LoLoRelationTypeInfoData
	extends Data
{
	...
	public LoLoRelationTypeInfoData ()
	{
		// TODO: ask Wil if we want to really use the class name as the key
		super (LoLoRelationTypeInfo.class.getName ());
	}
	...
	{
		super.set (Properties.REV_NAME.getKey (), value);
	}
	
	
	public String getRevName ()
	{
		return super.get (Properties.REV_NAME.getKey ());
	}
	
	
	public void setRevDesc (String value)
	{
		super.set (Properties.REV_DESC.getKey (), value);
	}
	
	
	public String getRevDesc ()
	{
		return super.get (Properties.REV_DESC.getKey ());
	}
