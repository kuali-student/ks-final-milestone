	...
	extends Data
{
	...
	{
		super.set (Properties.INSTRUCTIONAL_FORMAT.getKey (), value);
	}
	
	
	public String getInstructionalFormat ()
	{
		return super.get (Properties.INSTRUCTIONAL_FORMAT.getKey ());
	}
	
	
	public void setDeliveryMethod (String value)
	{
		super.set (Properties.DELIVERY_METHOD.getKey (), value);
	}
	
	
	public String getDeliveryMethod ()
	{
		return super.get (Properties.DELIVERY_METHOD.getKey ());
	}
