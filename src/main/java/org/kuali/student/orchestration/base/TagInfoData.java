	...
	extends Data
{
	...
	public TagInfoData ()
	{
		...
		super (TagInfo.class.getName ());
	}
	
	public void setNamespace (String value)
	{
		super.set (Properties.NAMESPACE.getKey (), value);
	}
	
	
	public String getNamespace ()
	{
		return super.get (Properties.NAMESPACE.getKey ());
	}
	
	
	public void setPredicate (String value)
	{
		super.set (Properties.PREDICATE.getKey (), value);
	}
	
	
	public String getPredicate ()
	{
		return super.get (Properties.PREDICATE.getKey ());
	}
