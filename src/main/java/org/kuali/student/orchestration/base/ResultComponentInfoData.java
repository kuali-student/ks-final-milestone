...
public class ResultComponentInfoData
	extends ModifiableData
{
	...
	public ResultComponentInfoData ()
	{
		// TODO: ask Wil if we want to really use the class name as the key
		super (ResultComponentInfo.class.getName ());
	}
	...
	{
		super.set (Properties.RESULT_VALUE_IDS.getKey (), value);
	}
	
	
	public Data getResultValueIds ()
	{
		return super.get (Properties.RESULT_VALUE_IDS.getKey ());
	}
