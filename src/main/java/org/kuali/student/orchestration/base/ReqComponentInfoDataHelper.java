...
public class ReqComponentInfoDataHelper
{
	...
	public ReqComponentInfoDataHelper (ModifiableData data)
	{
		this.data = data;
	}
	...
	public void setReqCompField (ReqCompFieldInfoDataHelper value)
	{
		data.set (Properties.REQ_COMP_FIELD.getKey (), value.getData ());
	}
	
	
	public ReqCompFieldInfoDataHelper getReqCompField ()
	{
		return new ReqCompFieldInfoDataHelper ((Data) data.get (Properties.REQ_COMP_FIELD.getKey ()));
	}
