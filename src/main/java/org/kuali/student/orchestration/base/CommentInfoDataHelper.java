...
public class CommentInfoDataHelper
{
	...
	public CommentInfoDataHelper (ModifiableData data)
	{
		this.data = data;
	}
	...
	public void setCommentText (RichTextInfoDataHelper value)
	{
		data.set (Properties.COMMENT_TEXT.getKey (), value.getData ());
	}
	
	
	public RichTextInfoDataHelper getCommentText ()
	{
		return new RichTextInfoDataHelper ((Data) data.get (Properties.COMMENT_TEXT.getKey ()));
	}
