...
import org.kuali.student.orchestration.base.QueryParamValueHelper.Properties;


public class QueryParamValueMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "QueryParamValueMetadata");
		...
		if (this.matches (type, state, "(default)", "(default)"))
		{
			...
			childMeta.getConstraints ().add (ConstraintMetadataBank.BANK.get ("query.param.value.types"));
		}
