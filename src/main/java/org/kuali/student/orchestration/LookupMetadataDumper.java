 ...
 * @author nwright
 */
public class LookupMetadataDumper
{
 ...
 public LookupMetadataDumper (PrintStream out, Metadata meta, String key,
                              int indent)
 {
  this.out = out;
  this.meta = meta;
 ...
 public void dump ()
 {
  ...
  for (String key : meta.getProperties ().keySet ())
  {
   ...
   new LookupMetadataDumper (out, child, key, indent + 1).dump ();
  }
 }

 private void dump (LookupMetadata lookup)
 {
  if (lookup == null)
  {
   return;
