...
@XmlType(name = "typeInfo", namespace = "http://student.kuali.org/wsdl/atp", propOrder = {
    "name",
    "desc",
    "effectiveDate",
    "expirationDate",
...
@XmlSeeAlso({
    DateRangeTypeInfo.class,
    AtpDurationTypeInfo.class,
    AtpSeasonalTypeInfo.class,
    AtpTypeInfo.class,
    MilestoneTypeInfo.class
})
