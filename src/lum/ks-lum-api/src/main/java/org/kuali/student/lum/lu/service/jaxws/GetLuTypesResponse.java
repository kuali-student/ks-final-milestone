...
@XmlRootElement(name = "getLuTypesResponse", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getLuTypesResponse", namespace = "http://student.kuali.org/wsdl/lu")
...
public class GetLuTypesResponse {
    ...
    public java.util.List<LuTypeInfo> getReturn() {
		if(_return==null){
			_return = new java.util.ArrayList<LuTypeInfo>(0);
		}
        return this._return;
    }
