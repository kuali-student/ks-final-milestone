...
public class RuleTypesComposite extends Composite {
    ...
    private BusinessRuleTypeInfo activeRuleType; // keep copy of business rule type so we can update all fields user can
            ...
            ruleTypesTree.addSelectionListener(new ModelTableSelectionListener<RuleTypesHierarchyInfo>() {
                public void onSelect(RuleTypesHierarchyInfo modelObject) {
                    ...
                    if (modelObject == null) {
                        ...
                        DevelopersGuiService.Util.getInstance().fetchBusinessRuleType(businessRuleTypeKey, anchorTypeKey, new AsyncCallback<BusinessRuleTypeInfo>() {
