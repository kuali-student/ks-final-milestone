...
have access to create Hold Issue so that  not any person that have access
to the system */
--////////////////////////////////////////////////////////////////////////
  ...
  ('KS-KRIM-PERM-'||KRIM_PERM_ID_S.NEXTVAL,
   ...
   (SELECT perm_tmpl_id
     ...
     where nm = 'Open View'
       and nmspc_cd = 'KS-ENR'),
   'KS-ENR',
   'Holds Personnel Permission',
   'Allows the user to create Holds Issues',
   'Y')
/
--////////////////////////////////////////////////////////////////////////
...
values
  ('KS-'||KRIM_ROLE_ID_S.NEXTVAL,
   SYS_GUID(),
   1,
   'Holds Personnel Role',
   'KS-ENR',
   'KS Administrator with global abilities Holds Issue Permission',
...
values
  ('KS-KRIM-ROLE-PERM-'||KRIM_ROLE_PERM_ID_S.NEXTVAL,
   ...
   (SELECT perm_id
      from krim_perm_t
     where nm = 'Holds Personnel Permission'
       and nmspc_cd = 'KS-ENR'),
   'Y')
/
--////////////////////////////////////////////////////////////////////////
