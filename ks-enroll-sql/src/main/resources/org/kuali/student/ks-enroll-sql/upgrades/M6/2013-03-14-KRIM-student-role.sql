...
insert into KRIM_ROLE_T (ROLE_ID, OBJ_ID, VER_NBR, ROLE_NM, NMSPC_CD, DESC_TXT, KIM_TYP_ID, ACTV_IND, LAST_UPDT_DT)
  values ('KS-KRIM-ROLE-1000',  SYS_GUID(), 1, 'KS Student', 'KS-SYS', 'A student ', (SELECT KIM_TYP_ID FROM KRIM_TYP_T WHERE NM = 'Default' AND NMSPC_CD = 'KUALI'), 'Y', TO_DATE ('11/26/2012', 'MM/DD/YYYY') )
/
