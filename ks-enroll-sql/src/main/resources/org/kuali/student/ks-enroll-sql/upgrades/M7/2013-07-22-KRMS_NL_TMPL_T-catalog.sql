Insert into KRMS_NL_TMPL_T (LANG_CD,NL_TMPL_ID,NL_USAGE_ID,TMPL,TYP_ID,VER_NBR) values ('en','KS-KRMS-NL-TMPL-1501','KS-KRMS-NL-USAGE-1005','minimum cumulative GPA of $gpa','10040',0)
/
...
/
Insert into KRMS_NL_TMPL_T (LANG_CD,NL_TMPL_ID,NL_USAGE_ID,TMPL,TYP_ID,VER_NBR) values ('en','KS-KRMS-NL-TMPL-1505','KS-KRMS-NL-USAGE-1005','must have been admitted to a program offered by  #if($org.getAttributes().get("umType") == "Academic Department")within $org.getLongName() department#{else}in $org.getLongName()#end','10065',0)
/
...
/
Insert into KRMS_NL_TMPL_T (LANG_CD,NL_TMPL_ID,NL_USAGE_ID,TMPL,TYP_ID,VER_NBR) values ('en','KS-KRMS-NL-TMPL-1508','KS-KRMS-NL-USAGE-1005','#if(($intValue == 1 &&$courseCluSet.getCluList().size() == 1) || ($courseCluSet.getCluList().size() <= 1))$courseCluSet.getCluSetAsCode()#{else}#if($courseCluSet.getQueryValueFromParam("lu.queryParam.luOptionalDivision") == "")#set($a=$courseCluSet.getCluSetAsCode().lastIndexOf(","))#set($b=1)#set($c=$a+$b)#if($courseCluSet.getCluList().size() > 2)#set($courses=$courseCluSet.getCluSetAsCode().substring(0,$a)+", or"+$courseCluSet.getCluSetAsCode().substring($c))#{else}must have successfully completed no more than $intValue courses from #set($courses=$courseCluSet.getCluSetAsCode().substring(0,$a)+" or"+$courseCluSet.getCluSetAsCode().substring($c))#end#if($intValue > 1)$intValue $NLHelper.getProperGrammar($intValue, "course") from #end$courses#{else}$intValue $NLHelper.getProperGrammar($intValue, "course") from #set($prefix=${courseCluSet.getQueryValueFromParam("lu.queryParam.luOptionalDivision").toUpperCase()})$prefix$courseCluSet.getQueryValueFromParam("lu.queryParam.luOptionalCrsNoRange") course range#end#end','10053',0)
/
Insert into KRMS_NL_TMPL_T (LANG_CD,NL_TMPL_ID,NL_USAGE_ID,TMPL,TYP_ID,VER_NBR) values ('en','KS-KRMS-NL-TMPL-1509','KS-KRMS-NL-USAGE-1005','minimum of $intValue $NLHelper.getProperGrammar($intValue, "credit") from #if($courseCluSet.getQueryValueFromParam("lu.queryParam.luOptionalDivision") == "")$courseCluSet.getCluSetAsCode()#{else}#set($prefix=${courseCluSet.getQueryValueFromParam("lu.queryParam.luOptionalDivision").toUpperCase()})$prefix$courseCluSet.getQueryValueFromParam("lu.queryParam.luOptionalCrsNoRange") course range#end','10054',0)
/
Insert into KRMS_NL_TMPL_T (LANG_CD,NL_TMPL_ID,NL_USAGE_ID,TMPL,TYP_ID,VER_NBR) values ('en','KS-KRMS-NL-TMPL-1510','KS-KRMS-NL-USAGE-1005','must be in #if($programCluSet.getCluList().size() > 1)one of the following programs #end$NLHelper.getCluOrCluSetAsLongNames($programClu,$programCluSet,";") #if($programCluSet.getCluList().size() == 1)program#end','10052',0)
/
Insert into KRMS_NL_TMPL_T (LANG_CD,NL_TMPL_ID,NL_USAGE_ID,TMPL,TYP_ID,VER_NBR) values ('en','KS-KRMS-NL-TMPL-1511','KS-KRMS-NL-USAGE-1005','must not have completed $courseClu.getOfficialIdentifier().getCode()','10032',0)
/
...
/
Insert into KRMS_NL_TMPL_T (LANG_CD,NL_TMPL_ID,NL_USAGE_ID,TMPL,TYP_ID,VER_NBR) values ('en','KS-KRMS-NL-TMPL-1513','KS-KRMS-NL-USAGE-1005','must successfully complete a minimum of $intValue $NLHelper.getProperGrammar($intValue, "course") with a minimum grade of $grade from #if($courseCluSet.getQueryValueFromParam("lu.queryParam.luOptionalDivision") == "")$courseCluSet.getCluSetAsCode()#{else}#set($prefix=${courseCluSet.getQueryValueFromParam("lu.queryParam.luOptionalDivision").toUpperCase()})$prefix$courseCluSet.getQueryValueFromParam("lu.queryParam.luOptionalCrsNoRange") course range#end','10028',0)
/
...
/
Insert into KRMS_NL_TMPL_T (LANG_CD,NL_TMPL_ID,NL_USAGE_ID,TMPL,TYP_ID,VER_NBR) values ('en','KS-KRMS-NL-TMPL-1519','KS-KRMS-NL-USAGE-1005','concurrently enrolled in $courseClu.getOfficialIdentifier().getCode()','10030',0)
/
Insert into KRMS_NL_TMPL_T (LANG_CD,NL_TMPL_ID,NL_USAGE_ID,TMPL,TYP_ID,VER_NBR) values ('en','KS-KRMS-NL-TMPL-1520','KS-KRMS-NL-USAGE-1005','concurrently enrolled in #if(($intValue == 1 &&$courseCluSet.getCluList().size() == 1) || ($courseCluSet.getCluList().size() <= 1))$courseCluSet.getCluSetAsCode()#{else}#if($courseCluSet.getQueryValueFromParam("lu.queryParam.luOptionalDivision") == "")#if($intValue > 1)$intValue $NLHelper.getProperGrammar($intValue, "course") from $courseCluSet.getCluSetAsCode()#{else}#set($a=$courseCluSet.getCluSetAsCode().lastIndexOf(","))#set($b=1)#set($c=$a+$b)#set($d=$courseCluSet.getCluSetAsCode().lastIndexOf(")"))#if($courseCluSet.getCluList().size() > 2)#set($courses=$courseCluSet.getCluSetAsCode().substring(1,$a)+", or"+$courseCluSet.getCluSetAsCode().substring($c, $d))#{else}#set($courses=$courseCluSet.getCluSetAsCode().substring(1,$a)+" or"+$courseCluSet.getCluSetAsCode().substring($c, $d))#end$courses#end#{else}$intValue $NLHelper.getProperGrammar($intValue, "course") from #set($prefix=${courseCluSet.getQueryValueFromParam("lu.queryParam.luOptionalDivision").toUpperCase()})$prefix$courseCluSet.getQueryValueFromParam("lu.queryParam.luOptionalCrsNoRange") course range#end#end','10024',0)
/
...
/
Insert into KRMS_NL_TMPL_T (LANG_CD,NL_TMPL_ID,NL_USAGE_ID,TMPL,TYP_ID,VER_NBR) values ('en','KS-KRMS-NL-TMPL-1524','KS-KRMS-NL-USAGE-1005','must not have been admitted to the $NLHelper.getCluOrCluSetAsLongNames($programClu,$programCluSet) program','10036',0)
/
Insert into KRMS_NL_TMPL_T (LANG_CD,NL_TMPL_ID,NL_USAGE_ID,TMPL,TYP_ID,VER_NBR) values ('en','KS-KRMS-NL-TMPL-1525','KS-KRMS-NL-USAGE-1005','must have successfully completed a minimum of $intValue $NLHelper.getProperGrammar($intValue, "credit") from courses in the $org.getLongName()','10055',0)
/
Insert into KRMS_NL_TMPL_T (LANG_CD,NL_TMPL_ID,NL_USAGE_ID,TMPL,TYP_ID,VER_NBR) values ('en','KS-KRMS-NL-TMPL-1526','KS-KRMS-NL-USAGE-1005','must successfully complete no more than $intValue $NLHelper.getProperGrammar($intValue, "credit") from $courseCluSet.getCluSetAsCode()','10021',0)
/
Insert into KRMS_NL_TMPL_T (LANG_CD,NL_TMPL_ID,NL_USAGE_ID,TMPL,TYP_ID,VER_NBR) values ('en','KS-KRMS-NL-TMPL-1527','KS-KRMS-NL-USAGE-1005','must not have successfully completed any credits from $courseCluSet.getCluSetAsCode()','10022',0)
/
Insert into KRMS_NL_TMPL_T (LANG_CD,NL_TMPL_ID,NL_USAGE_ID,TMPL,TYP_ID,VER_NBR) values ('en','KS-KRMS-NL-TMPL-1528','KS-KRMS-NL-USAGE-1005','must have earned a minimum GPA of $intValue in $courseCluSet.getCluSetAsCode()','10025',0)
/
...
/
Insert into KRMS_NL_TMPL_T (LANG_CD,NL_TMPL_ID,NL_USAGE_ID,TMPL,TYP_ID,VER_NBR) values ('en','KS-KRMS-NL-TMPL-1532','KS-KRMS-NL-USAGE-1005','must have successfully completed $courseClu.getOfficialIdentifier().getCode() between $term.name and $term2.name','10062',0)
/
...
/
Insert into KRMS_NL_TMPL_T (LANG_CD,NL_TMPL_ID,NL_USAGE_ID,TMPL,TYP_ID,VER_NBR) values ('en','KS-KRMS-NL-TMPL-1537','KS-KRMS-NL-USAGE-1005','must have successfully completed $courseClu.getOfficialIdentifier().getCode() as of $term.name','10060',0)
/
