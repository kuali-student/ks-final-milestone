...
public class LuPublicationTypeInfoHelper
{
	...
	private LuPublicationTypeInfoHelper (Data data)
	{
		this.data = data;
	}
	
	public static LuPublicationTypeInfoHelper wrap (Data data)
	{
		if (data == null)
		{
			 return null;
		}
		return new LuPublicationTypeInfoHelper (data);
	}
