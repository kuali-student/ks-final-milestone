...
// ResultValue
INSERT INTO KSLU_LRC_RESULT_VALUE (ID, VALUE, RSLT_COMP_ID) VALUES ('LRC-RESULT_VALUE-CREDIT-1', 'Credit 1', 'LRC-RESCOMP-1')
INSERT INTO KSLU_LRC_RESULT_VALUE (ID, VALUE, RSLT_COMP_ID) VALUES ('LRC-RESULT_VALUE-CREDIT-2', 'Credit 2', 'LRC-RESCOMP-1')
INSERT INTO KSLU_LRC_RESULT_VALUE (ID, VALUE, RSLT_COMP_ID) VALUES ('LRC-RESULT_VALUE-CREDIT-3', 'Credit 3', 'LRC-RESCOMP-1')
INSERT INTO KSLU_LRC_RESULT_VALUE (ID, VALUE, RSLT_COMP_ID) VALUES ('LRC-RESULT_VALUE-CREDIT-4', 'Credit 4', 'LRC-RESCOMP-1')

INSERT INTO KSLU_LRC_RESULT_VALUE (ID, VALUE, RSLT_COMP_ID) VALUES ('LRC-RESULT_VALUE-CREDENTIAL-1', 'Credential 1', 'LRC-RESCOMP-2')
INSERT INTO KSLU_LRC_RESULT_VALUE (ID, VALUE, RSLT_COMP_ID) VALUES ('LRC-RESULT_VALUE-CREDENTIAL-2', 'Credential 2', 'LRC-RESCOMP-2')
INSERT INTO KSLU_LRC_RESULT_VALUE (ID, VALUE, RSLT_COMP_ID) VALUES ('LRC-RESULT_VALUE-CREDENTIAL-3', 'Credential 3', 'LRC-RESCOMP-2')
INSERT INTO KSLU_LRC_RESULT_VALUE (ID, VALUE, RSLT_COMP_ID) VALUES ('LRC-RESULT_VALUE-CREDENTIAL-4', 'Credential 4', 'LRC-RESCOMP-2')

INSERT INTO KSLU_LRC_RESULT_VALUE (ID, VALUE, RSLT_COMP_ID) VALUES ('LRC-RESULT_VALUE-GRADE-1', 'GRADE 1', 'LRC-RESCOMP-3')
INSERT INTO KSLU_LRC_RESULT_VALUE (ID, VALUE, RSLT_COMP_ID) VALUES ('LRC-RESULT_VALUE-GRADE-2', 'GRADE 2', 'LRC-RESCOMP-3')
INSERT INTO KSLU_LRC_RESULT_VALUE (ID, VALUE, RSLT_COMP_ID) VALUES ('LRC-RESULT_VALUE-GRADE-3', 'GRADE 3', 'LRC-RESCOMP-3')
INSERT INTO KSLU_LRC_RESULT_VALUE (ID, VALUE, RSLT_COMP_ID) VALUES ('LRC-RESULT_VALUE-GRADE-4', 'GRADE 4', 'LRC-RESCOMP-3')
...
INSERT INTO KSLU_LRC_RESCOMP_TYPE (TYPE_KEY, TYPE_DESC, EFF_DT, EXPIR_DT, NAME) VALUES ('kuali.resultComponentType.grade.finalGrade', 'This records that a final grade is a result for this course', {ts '2000-01-01 00:00:00.0'}, {ts '2020-01-01 00:00:00.0'}, 'Final Grade');
INSERT INTO KSLU_LRC_RESCOMP_TYPE (TYPE_KEY, TYPE_DESC, EFF_DT, EXPIR_DT, NAME) VALUES ('kuali.resultComponentType.credit.degree.fixed', 'This records a single fixed number of credits that are awarded if the student passes the course.', {ts '2000-01-01 00:00:00.0'}, {ts '2020-01-01 00:00:00.0'}, 'Fixed Number');
INSERT INTO KSLU_LRC_RESCOMP_TYPE (TYPE_KEY, TYPE_DESC, EFF_DT, EXPIR_DT, NAME) VALUES ('kuali.resultComponentType.credit.degree.range', 'This records a range of number of credits that can be awarded for this course.', {ts '2000-01-01 00:00:00.0'}, {ts '2020-01-01 00:00:00.0'}, 'Range of Numbers');
