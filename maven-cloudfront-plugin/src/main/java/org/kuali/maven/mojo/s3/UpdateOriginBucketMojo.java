...
public class UpdateOriginBucketMojo extends S3Mojo {
    ...
    protected void updateDirectory(AmazonS3Client client, String bucket, String html, String prefix, String delimiter, String defaultObjectKey, ObjectListing objectListing) throws IOException {
        ...
        // However, the html generated by the maven-site-plugin does not render correctly if the url does not end with a slash
        ...
        if (isPutInternallyGeneratedDirectoryObjects(client, bucket, objectListing, defaultObjectKey)) {
            // The defaultObject either does not exist or was generated by this plugin, we are free to overwrite it
            // Place the html we generated into the bucket under the keys "foo/bar/" and "foo/bar"
            ...
            if (isCopyDefaultObjectWithDelimiter()) {
                ...
                client.copyObject(getCopyObjectRequest(bucket, defaultObjectKey, prefix));
            }
            if (isCopyDefaultObjectWithoutDelimiter()) {
                // Copy the contents of the clients default object to "foo/bar"
                // This allows the url "http://www.mybucket.com/foo/bar" to return the default object
                client.copyObject(getCopyObjectRequest(bucket, defaultObjectKey, trimmedPrefix));
            }
        }
    }
     ...
     */
    protected boolean isPutInternallyGeneratedDirectoryObjects(AmazonS3Client client, String bucket, ObjectListing objectListing, String defaultObjectKey) {
        return isCreateOrUpdateDefaultObject(client, bucket, objectListing, defaultObjectKey);
    }
