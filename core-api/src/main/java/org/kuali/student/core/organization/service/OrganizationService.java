...
import org.kuali.student.core.enumeration.service.EnumerationService;
...
public interface OrganizationService extends EnumerationService, DictionaryService, SearchService{
     ...
     * @throws OperationFailedException unable to complete request
	 */
    public List<ValidationResult> validateOrg(@WebParam(name="validationType")String validationType, @WebParam(name="orgInfo")OrgInfo orgInfo) throws DoesNotExistException, InvalidParameterException, MissingParameterException, OperationFailedException;
     ...
     * @throws OperationFailedException unable to complete request
	 */
    public List<ValidationResult> validateOrgOrgRelation(@WebParam(name="validationType")String validationType, @WebParam(name="orgOrgRelationInfo")OrgOrgRelationInfo orgOrgRelationInfo) throws DoesNotExistException, InvalidParameterException, MissingParameterException, OperationFailedException;
     ...
     * @throws OperationFailedException unable to complete request
	 */
    public List<ValidationResult> validateOrgPersonRelation(@WebParam(name="validationType")String validationType, @WebParam(name="orgPersonRelationInfo")OrgPersonRelationInfo orgPersonRelationInfo) throws DoesNotExistException, InvalidParameterException, MissingParameterException, OperationFailedException;
     ...
     * @throws PermissionDeniedException authorization failure
	 */
    public List<String> getAncestors(@WebParam(name="orgId")String orgId, @WebParam(name="orgHierarchy")String orgHierarchy) throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException;
