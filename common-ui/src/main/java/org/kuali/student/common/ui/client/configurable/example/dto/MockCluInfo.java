 ...
 */
package org.kuali.student.common.ui.client.configurable.example.dto;
...
public class MockCluInfo implements Serializable, Idable, HasTypeState, HasAttributes {

    private static final long serialVersionUID = 1L;

    @XmlElement
    private MockCluIdentifierInfo officialIdentifier;

    @XmlElement
    private List<MockCluIdentifierInfo> alternateIdentifiers;
    ...
    @XmlElement
    private MockCluInstructorInfo primaryInstructor;

    @XmlElement
    private List<MockCluInstructorInfo> instructors;
     ...
     */
    public MockCluIdentifierInfo getOfficialIdentifier() {
        return officialIdentifier;
    }

    public void setOfficialIdentifier(MockCluIdentifierInfo officialIdentifier) {
     ...
     */
    public List<MockCluIdentifierInfo> getAlternateIdentifiers() {
        if (alternateIdentifiers == null) {
            alternateIdentifiers = new ArrayList<MockCluIdentifierInfo>();
        }
        return alternateIdentifiers;
    }

    public void setAlternateIdentifiers(List<MockCluIdentifierInfo> alternateIdentifiers) {
     ...
     */
    public MockCluInstructorInfo getPrimaryInstructor() {
        return primaryInstructor;
    }

    public void setPrimaryInstructor(MockCluInstructorInfo primaryInstructor) {
     ...
     */
    public List<MockCluInstructorInfo> getInstructors() {
        if (instructors == null) {
            instructors = new ArrayList<MockCluInstructorInfo>();
        }
        return instructors;
    }

    public void setInstructors(List<MockCluInstructorInfo> instructors) {
