...
public class KSDatePicker extends Composite{
	...
	public KSDatePicker(){
		...
		dateField.addFocusHandler(new FocusHandler(){
			public void onFocus(FocusEvent event) {
				...
				popup.setPopupPosition(KSDatePicker.this.getAbsoluteLeft(), KSDatePicker.this.getAbsoluteTop() + dateField.getOffsetHeight());
				if(justPicked){
					dateField.selectAll();
					justPicked = false;
				}
