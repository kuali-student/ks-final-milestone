...
mkdir build
copy one-jar-boot-0.96.jar kuali-dictionary-generator.jar
...
copy DictionaryMANIFEST.MF build\MANIFEST.MF
cd build
call %JAVA_HOME%\bin\jar -uvmf MANIFEST.MF ..\kuali-dictionary-generator.jar *
pause
