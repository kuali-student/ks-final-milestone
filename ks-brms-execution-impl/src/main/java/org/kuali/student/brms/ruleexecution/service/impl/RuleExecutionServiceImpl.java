...
public class RuleExecutionServiceImpl implements RuleExecutionService {
    ...
    public AgendaExecutionResultInfo executeAgenda(
    	...
    	return this.ruleExecution.executeAgenda(businessRuleAnchorInfoList, executionParamMap);
	}
    ...
    public ExecutionResultInfo executeBusinessRule(final String businessRuleId, final Map<String,String> exectionParamMap)
		throws DoesNotExistException, InvalidParameterException, MissingParameterException, OperationFailedException {
    	return this.ruleExecution.executeBusinessRule(businessRuleId, exectionParamMap);
	}
    ...
    public ExecutionResultInfo executeBusinessRuleTest(final BusinessRuleInfo businessRule, final Map<String,String> exectionParamMap)
		throws DoesNotExistException, InvalidParameterException, MissingParameterException, OperationFailedException {
    	return this.ruleExecution.executeBusinessRuleTest(businessRule, exectionParamMap);
    }
}
