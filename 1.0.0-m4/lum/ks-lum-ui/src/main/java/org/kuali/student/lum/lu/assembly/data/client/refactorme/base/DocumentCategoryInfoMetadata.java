...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.DocumentCategoryInfoHelper.Properties;


public class DocumentCategoryInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "DocumentCategoryInfoMetadata");
