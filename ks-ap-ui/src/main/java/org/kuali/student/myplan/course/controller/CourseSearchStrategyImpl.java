...
public class CourseSearchStrategyImpl implements CourseSearchStrategy {
	...
	private static enum ProjectedOrder {
		AU, FA, WI, SP, SU;
	}

	private static enum ScheduledOrder {
		WI, SP, SU, AU, FA;
	}

	protected static final Comparator<String> NUMERIC = new Comparator<String>() {
		@Override
	...
	protected static final Comparator<String> ALPHA = new Comparator<String>() {
		@Override
		public int compare(String o1, String o2) {
			if (o1 == null && o2 == null)
				return 0;
	...
	protected static final Comparator<String> TERMS = new Comparator<String>() {
		@Override
		public int compare(String o1, String o2) {
			if (o1 == null && o2 == null)
				return 0;
