...
/**
 * Created by IntelliJ IDEA. User: hemanthg Date: 7/27/12 Time: 10:28 AM To
 * change this template use File | Settings | File Templates.
 */
public class EnumerationHelper {

	private static final Logger logger = Logger
			.getLogger(EnumerationHelper.class);
	...
	public static void setEnumServiceCache(
	...
	public static List<EnumeratedValueInfo> getEnumerationValueInfoList(
			String param) {
		List<EnumeratedValueInfo> enumeratedValueInfoList = null;
		try {
