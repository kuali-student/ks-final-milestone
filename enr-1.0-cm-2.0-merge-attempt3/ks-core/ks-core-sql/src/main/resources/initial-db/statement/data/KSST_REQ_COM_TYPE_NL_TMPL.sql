...
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('1001','en','KUALI.RULE','kuali.reqComponent.type.program.programset.completed.nof','Must have successfully completed a minimum of $intValue $NLHelper.getProperGrammar($intValue, "program") from $programCluSet.getCluSetAsShortName() $NLHelper.getProperGrammar($programCluSet.getCluList().size(), "program")',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('1002','en','KUALI.RULE','kuali.reqComponent.type.program.programset.notcompleted.nof','Must not have successfully completed #if($programCluSet.getCluList().size() > 1)any of #end$programCluSet.getCluSetAsShortName() $NLHelper.getProperGrammar($programCluSet.getCluList().size(), "program")',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('1003','en','KUALI.RULE','kuali.reqComponent.type.program.programset.completed.all','Must have successfully completed #if($programCluSet.getCluList().size() != 1)all of #end$programCluSet.getCluSetAsShortName() $NLHelper.getProperGrammar($programCluSet.getCluList().size(), "program")',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('1004','en','KUALI.RULE','kuali.reqComponent.type.program.programset.coursecompleted.nof','Must have successfully completed a minimum of $intValue $NLHelper.getProperGrammar($intValue, "course") from $programCluSet.getCluSetAsShortName() $NLHelper.getProperGrammar($programCluSet.getCluList().size(), "program")',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
...
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('1011','en','KUALI.RULE','kuali.reqComponent.type.program.residence.credits.final','$programClu.getOfficialIdentifier().getShortName() students must take their final $intValue $NLHelper.getProperGrammar($intValue, "credit") in residence',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('1012','en','KUALI.RULE','kuali.reqComponent.type.program.enrolled.credits.final','$programClu.getOfficialIdentifier().getShortName() students must be enrolled in their graduation major for the final $intValue $NLHelper.getProperGrammar($intValue, "credit") taken',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
...
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('1101','en','KUALI.RULE.PREVIEW','kuali.reqComponent.type.program.programset.completed.nof','Must have successfully completed a minimum of $intValue $NLHelper.getProperGrammar($intValue, "program") from $programCluSet.getCluSetAsShortName() $NLHelper.getProperGrammar($programCluSet.getCluList().size(), "program")',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('1102','en','KUALI.RULE.PREVIEW','kuali.reqComponent.type.program.programset.notcompleted.nof','Must not have successfully completed #if($programCluSet.getCluList().size() > 1)any of #end$programCluSet.getCluSetAsShortName() $NLHelper.getProperGrammar($programCluSet.getCluList().size(), "program")',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('1103','en','KUALI.RULE.PREVIEW','kuali.reqComponent.type.program.programset.completed.all','Must have successfully completed #if($programCluSet.getCluList().size() != 1)all of #end$programCluSet.getCluSetAsShortName() $NLHelper.getProperGrammar($programCluSet.getCluList().size(), "program")',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('1104','en','KUALI.RULE.PREVIEW','kuali.reqComponent.type.program.programset.coursecompleted.nof','Must have successfully completed a minimum of $intValue $NLHelper.getProperGrammar($intValue, "course") from $programCluSet.getCluSetAsShortName() $NLHelper.getProperGrammar($programCluSet.getCluList().size(), "program")',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
...
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('1111','en','KUALI.RULE.PREVIEW','kuali.reqComponent.type.program.residence.credits.final','$programClu.getOfficialIdentifier().getShortName() students must take their final $intValue $NLHelper.getProperGrammar($intValue, "credit") in residence',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('1112','en','KUALI.RULE.PREVIEW','kuali.reqComponent.type.program.enrolled.credits.final','$programClu.getOfficialIdentifier().getShortName() students must be enrolled in their graduation major for the final $intValue $NLHelper.getProperGrammar($intValue, "credit") taken',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
...
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('113','en','KUALI.RULE.PREVIEW','kuali.reqComponent.type.course.courseset.grade.min','Must have earned a minimum grade of $gradeType.getName().toLowerCase() $grade in',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('114','en','KUALI.RULE.PREVIEW','kuali.reqComponent.type.course.courseset.grade.max','Must not have earned a maximum grade of $gradeType.getName().toLowerCase() $grade or higher in',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
...
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('117','en','KUALI.RULE.PREVIEW','kuali.reqComponent.type.course.test.score.min','Must have achieved a minimum score of $fields.get(''kuali.reqComponent.field.type.test.score'') on $testCluSet.getCluSetAsShortName()',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('118','en','KUALI.RULE.PREVIEW','kuali.reqComponent.type.course.test.score.max','Must have achieved a score no higher than $fields.get(''kuali.reqComponent.field.type.test.score'') on $testCluSet.getCluSetAsShortName()',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('119','en','KUALI.RULE.PREVIEW','kuali.reqComponent.type.course.courseset.nof.grade.min','Must successfully complete a minimum of $intValue $NLHelper.getProperGrammar($intValue, "course") with a minimum grade of $gradeType.getName().toLowerCase() $grade from',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('120','en','KUALI.RULE.PREVIEW','kuali.reqComponent.type.course.program.admitted.org.duration','Students admitted to $NLHelper.getCluOrCluSetAsShortNames($programClu,$programCluSet) may take no more than $intValue $NLHelper.getProperGrammar($intValue, "course") in the $org.getLongName() in $duration $NLHelper.getProperGrammar($duration, $durationType.getName()).toLowerCase()',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('121','en','KUALI.RULE.PREVIEW','kuali.reqComponent.type.course.program.notadmitted.org.duration','Students not admitted to $NLHelper.getCluOrCluSetAsShortNames($programClu,$programCluSet) may take no more than $intValue $NLHelper.getProperGrammar($intValue, "course") in the $org.getLongName() in $duration $NLHelper.getProperGrammar($duration, $durationType.getName()).toLowerCase()',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
...
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('123','en','KUALI.RULE.PREVIEW','kuali.reqComponent.type.course.program.notadmitted','Must not have been admitted to the $NLHelper.getCluOrCluSetAsShortNames($programClu,$programCluSet) program',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
...
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('126','en','KUALI.RULE.PREVIEW','kuali.reqComponent.type.course.program.admitted','Must have been admitted to the $NLHelper.getCluOrCluSetAsShortNames($programClu,$programCluSet) program',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
...
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('13','en','KUALI.RULE','kuali.reqComponent.type.course.courseset.grade.min','Must have earned a minimum grade of $gradeType.getName().toLowerCase() $grade in $courseCluSet.getCluSetAsCode()',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('14','en','KUALI.RULE','kuali.reqComponent.type.course.courseset.grade.max','Must not have earned a maximum grade of $gradeType.getName().toLowerCase() $grade or higher in $courseCluSet.getCluSetAsCode()',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
...
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('17','en','KUALI.RULE','kuali.reqComponent.type.course.test.score.min','Must have achieved a minimum score of $fields.get(''kuali.reqComponent.field.type.test.score'') on $testCluSet.getCluSetAsShortName()',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('18','en','KUALI.RULE','kuali.reqComponent.type.course.test.score.max','Must have achieved a score no higher than $fields.get(''kuali.reqComponent.field.type.test.score'') on $testCluSet.getCluSetAsShortName()',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('19','en','KUALI.RULE','kuali.reqComponent.type.course.courseset.nof.grade.min','Must successfully complete a minimum of $intValue $NLHelper.getProperGrammar($intValue, "course") with a minimum grade of $gradeType.getName().toLowerCase() $grade from $courseCluSet.getCluSetAsCode()',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
...
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('20','en','KUALI.RULE','kuali.reqComponent.type.course.program.admitted.org.duration','Students admitted to $NLHelper.getCluOrCluSetAsShortNames($programClu,$programCluSet) may take no more than $intValue $NLHelper.getProperGrammar($intValue, "course") in the $org.getLongName() in $duration $NLHelper.getProperGrammar($duration, $durationType.getName()).toLowerCase()',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
...
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('21','en','KUALI.RULE','kuali.reqComponent.type.course.program.notadmitted.org.duration','Students not admitted to $NLHelper.getCluOrCluSetAsShortNames($programClu,$programCluSet) may take no more than $intValue $NLHelper.getProperGrammar($intValue, "course") in the $org.getLongName() in $duration $NLHelper.getProperGrammar($duration, $durationType.getName()).toLowerCase()',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
...
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('23','en','KUALI.RULE','kuali.reqComponent.type.course.program.notadmitted','Must not have been admitted to the $NLHelper.getCluOrCluSetAsShortNames($programClu,$programCluSet) program',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
...
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
  VALUES ('26','en','KUALI.RULE','kuali.reqComponent.type.course.program.admitted','Must have been admitted to the $NLHelper.getCluOrCluSetAsShortNames($programClu,$programCluSet) program',0)
/
INSERT INTO KSST_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE,VER_NBR)
