...
import org.apache.maven.plugins.site.kuali.BreadCrumbGenerator;
 ...
 * @version $Id: AbstractSiteRenderingMojo.java 891014 2009-12-15 21:47:19Z ltheussl $
 */
    ...
    extends AbstractSiteMojo
{
        ...
        throws MojoExecutionException, IOException, MojoFailureException
    {
        ...
        try
        {
    		...
    		decorationModel.getBody().setBreadcrumbs(new BreadCrumbGenerator().getBreadCrumbs(project));
        }
