...
@XmlRootElement(name = "isCluInCluSet", namespace = "http://student.kuali.org/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "isCluInCluSet", namespace = "http://student.kuali.org/lum/lu", propOrder = {"cluId","cluSetId"})
