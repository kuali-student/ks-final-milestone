...
@XmlRootElement(name = "getLrScaleTypesForLui", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getLrScaleTypesForLui", namespace = "http://student.kuali.org/wsdl/lu", propOrder = {"luiId","lrTypeKey"})

public class GetLrScaleTypesForLui {
