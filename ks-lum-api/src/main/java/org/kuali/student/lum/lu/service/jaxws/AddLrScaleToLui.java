...
@XmlRootElement(name = "addLrScaleToLui", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "addLrScaleToLui", namespace = "http://student.kuali.org/wsdl/lu", propOrder = {"lrScaleTypeKey","lrTypeKey","luiId"})
