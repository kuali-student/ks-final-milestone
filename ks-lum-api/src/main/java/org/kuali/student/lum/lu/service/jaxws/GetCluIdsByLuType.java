...
@XmlRootElement(name = "getCluIdsByLuType", namespace = "http://student.kuali.org/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getCluIdsByLuType", namespace = "http://student.kuali.org/lum/lu", propOrder = {"luTypeKey","luState"})
