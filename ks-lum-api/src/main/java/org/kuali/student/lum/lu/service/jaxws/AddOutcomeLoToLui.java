...
@XmlRootElement(name = "addOutcomeLoToLui", namespace = "http://student.kuali.org/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "addOutcomeLoToLui", namespace = "http://student.kuali.org/lum/lu", propOrder = {"loId","luiId"})
