...
@XmlRootElement(name = "getNaturalLanguageForStatementInfoAsTree", namespace = "http://student.kuali.org/lum/nlt")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getNaturalLanguageForStatementInfoAsTree", namespace = "http://student.kuali.org/lum/nlt", propOrder = {"cluId","statementInfo","nlUsageTypeKey","language"})
