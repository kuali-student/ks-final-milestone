...
@XmlRootElement(name = "getGradesByKeyList", namespace = "http://student.kuali.org/lum/lrc")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getGradesByKeyList", namespace = "http://student.kuali.org/lum/lrc")
