...
@XmlRootElement(name = "removeOutcomeLoFromClu", namespace = "http://student.kuali.org/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "removeOutcomeLoFromClu", namespace = "http://student.kuali.org/lum/lu", propOrder = {"loId","cluId"})
