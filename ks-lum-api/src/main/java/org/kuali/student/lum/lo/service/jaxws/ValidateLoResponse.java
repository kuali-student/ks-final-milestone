...
@XmlRootElement(name = "validateLoResponse", namespace = "http://student.kuali.org/wsdl/lo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "validateLoResponse", namespace = "http://student.kuali.org/wsdl/lo")

public class ValidateLoResponse {
