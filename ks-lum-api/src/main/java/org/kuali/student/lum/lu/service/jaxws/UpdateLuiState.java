...
@XmlRootElement(name = "updateLuiState", namespace = "http://student.kuali.org/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "updateLuiState", namespace = "http://student.kuali.org/lum/lu", propOrder = {"luiId","luState"})
