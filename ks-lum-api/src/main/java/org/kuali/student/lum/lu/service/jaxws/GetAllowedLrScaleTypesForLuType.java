...
@XmlRootElement(name = "getAllowedLrScaleTypesForLuType", namespace = "http://student.kuali.org/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getAllowedLrScaleTypesForLuType", namespace = "http://student.kuali.org/lum/lu", propOrder = {"luTypeKey","lrTypeKey"})
