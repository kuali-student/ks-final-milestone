...
@XmlRootElement(name = "getLuiIdsInAtpByCluId", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getLuiIdsInAtpByCluId", namespace = "http://student.kuali.org/wsdl/lu", propOrder = {"cluId","atpKey"})

public class GetLuiIdsInAtpByCluId {
