...
@XmlRootElement(name = "getLuiIdsInAtpByCluId", namespace = "http://student.kuali.org/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getLuiIdsInAtpByCluId", namespace = "http://student.kuali.org/lum/lu", propOrder = {"cluId","atpKey"})
