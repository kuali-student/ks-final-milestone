...
@XmlRootElement(name = "getAllowedLuLuRelationTypeInfosForLuType", namespace = "http://student.kuali.org/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getAllowedLuLuRelationTypeInfosForLuType", namespace = "http://student.kuali.org/lum/lu", propOrder = {"luTypeKey","relatedLuTypeKey"})
