...
@XmlRootElement(name = "getAllowedLuLuRelationTypeInfosForLuType", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getAllowedLuLuRelationTypeInfosForLuType", namespace = "http://student.kuali.org/wsdl/lu", propOrder = {"luTypeKey","relatedLuTypeKey"})

public class GetAllowedLuLuRelationTypeInfosForLuType {
