...
@XmlRootElement(name = "removeOutcomeLoFromLui", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "removeOutcomeLoFromLui", namespace = "http://student.kuali.org/wsdl/lu", propOrder = {"loId","luiId"})
