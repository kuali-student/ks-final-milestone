...
@XmlRootElement(name = "removeCluFromCluSet", namespace = "http://student.kuali.org/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "removeCluFromCluSet", namespace = "http://student.kuali.org/lum/lu", propOrder = {"cluId","cluSetId"})
