...
public interface DataService {
	//Data operations
	public Data getData(String dataId, ContextInfo) throws OperationFailedException, DoesNotExistException, InvalidParameterException, MissingParameterException, OperationFailedException;
