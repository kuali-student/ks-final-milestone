...
<div class="body">
    ...
    <ul class="chan">
        ...
        <li><portal:portalLink displayTitle="true" title="Test SOC State Change" url="${ConfigProperties.application.url}/kr-krad/testStatePropagation?viewId=testStatePropagationView&pageId=SocStateChangePage&methodToCall=start"/></li>
    </ul>
