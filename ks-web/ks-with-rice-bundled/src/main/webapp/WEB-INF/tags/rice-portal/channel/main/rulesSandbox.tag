...
<div class="body">
    ...
    <ul class="chan">
        ...
        <li><portal:portalLink displayTitle="true" title="Final Exam Scheduling Matrix" url="${ConfigProperties.application.url}/kr-krad/finalExamRules?viewTypeName=MAINTENANCE&methodToCall=maintenanceEdit&dataObjectClassName=org.kuali.student.enrollment.class1.krms.dto.FERuleManagementWrapper&viewName=FEAgendaManagementView&overrideKeys=refObjectId&refObjectId=0f074dc5-91ec-4a9d-9f27-decbdbb79e8e"/></li>
    </ul>
</div>
