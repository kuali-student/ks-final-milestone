...
<div class="body">
    ...
    <ul class="chan">
        ...
        <li><portal:portalLink displayTitle="true" title="Rule Edit" url="${ConfigProperties.application.url}/kr-krad/krmsRuleStudentEditor?viewTypeName=MAINTENANCE&methodToCall=maintenanceEdit&dataObjectClassName=org.kuali.student.enrollment.class1.krms.dto.RuleEditor&viewName=StudentView&id=10101"/></li>
