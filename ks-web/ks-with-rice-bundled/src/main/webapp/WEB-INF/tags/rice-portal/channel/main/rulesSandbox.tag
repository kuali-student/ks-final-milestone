...
<div class="body">
    ...
    <ul class="chan">
        ...
        <li><portal:portalLink displayTitle="true" title="Manage Enrollment Eligibility" url="${ConfigProperties.application.url}/kr-krad/krmsRuleStudentEditor?viewTypeName=MAINTENANCE&methodToCall=maintenanceEdit&dataObjectClassName=org.kuali.student.enrollment.class1.krms.dto.RuleEditor&viewName=AgendaWithRuleView&overrideKeys=cluId&cluId=39b47c39-451a-4aff-9c87-47092e8627f0"/></li>
