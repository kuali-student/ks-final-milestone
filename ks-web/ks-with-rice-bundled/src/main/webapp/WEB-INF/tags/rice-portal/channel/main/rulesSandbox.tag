...
<div class="body">
    ...
    <ul class="chan">
        ...
        <li><portal:portalLink displayTitle="true" title="Proposition Edit" url="${ConfigProperties.application.url}/kr-krad/krmsProposition?viewTypeName=MAINTENANCE&methodToCall=maintenanceEdit&dataObjectClassName=org.kuali.rice.krms.impl.repository.PropositionBo&id=20000"/></li>
