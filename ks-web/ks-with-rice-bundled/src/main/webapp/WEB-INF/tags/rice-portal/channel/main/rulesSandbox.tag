...
<div class="body">
    ...
    <ul class="chan">
        ...
        <li><portal:portalLink displayTitle="true" title="Create New Rule" url="${ConfigProperties.application.url}/kr-krad/krmsProposition?methodToCall=start&dataObjectClassName=org.kuali.student.enrollment.class1.krms.PropositionEditor&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true"/></li>
        ...
        <li><portal:portalLink displayTitle="true" title="Rule Edit" url="${ConfigProperties.application.url}/kr-krad/krmsProposition?viewTypeName=MAINTENANCE&methodToCall=maintenanceEdit&dataObjectClassName=org.kuali.student.enrollment.class1.krms.PropositionEditor&id=10186"/></li>
