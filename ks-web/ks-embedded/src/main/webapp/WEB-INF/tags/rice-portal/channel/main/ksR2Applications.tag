...
<div class="body">
  ...
  <ul class="chan">
      <li><portal:portalLink displayTitle="true" title="Enrollment Landing" url="${ConfigProperties.application.url}/spring/launch?viewId=enrollmentLaunchView&methodToCall=start" /></li>
  </ul>
  ...
  <ul class="chan">
      ...
      <li><portal:portalLink displayTitle="true" title="TermInfo --> TermWrapper Lookup (by Key)" url="${ConfigProperties.application.url}/spring/lookup?methodToCall=start&dataObjectClassName=org.kuali.student.enrollment.acal.dto.TermInfo&viewId=TermWrapper-LookupView2&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" /></li>
      ...
      <li><strong><portal:portalLink displayTitle="true" title="Academic Calendar Lookup" url="${ConfigProperties.application.url}/spring/lookup?methodToCall=start&id=2&dataObjectClassName=org.kuali.student.enrollment.class2.acal.dto.AcademicCalendarWrapper&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" /></strong></li>
<!--      <li><portal:portalLink displayTitle="true" title="Academic Calendar Inquiry" url="${ConfigProperties.application.url}spring/inquiry?methodToCall=start&key=kuali.academic.calendar.Baccalaureate.2011-2012&dataObjectClassName=org.kuali.student.enrollment.class2.acal.dto.AcademicCalendarWrapper&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true"/></li>
  ...
  <ul class="chan">
      <li><portal:portalLink displayTitle="true" title="Schedule Classes" url="${ConfigProperties.application.url}/spring/lookup?methodToCall=start&id=2&dataObjectClassName=org.kuali.student.enrollment.courseoffering.dto.CourseOfferingInfo&viewId=ScheduleClasses-LookupView&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" /></li>
  </ul>
