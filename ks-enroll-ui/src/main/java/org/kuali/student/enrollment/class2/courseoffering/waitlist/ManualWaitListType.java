 ...
 *  successor -> Semi Automatic
 */
public class ManualWaitListType implements WaitListTypeWrapper, Serializable {

    public String waitListTypeForUI = "manual";
    public String waitListType = LuiServiceConstants.MANUAL_WAITLIST_TYPE_KEY;
    private WaitListTypeWrapper successor = new SemiAutomaticWaitListType();
