 ...
 */
public class TypeTypeRelationInfoAdminInquirableImpl
        extends InquirableImpl {

    private final static String TYPE_TYPE_RELATION_ID = "id";
    private transient TypeService typeService;
    final Logger logger = Logger.getLogger(TypeTypeRelationInfoAdminInquirableImpl.class);

    @Override
    public TypeTypeRelationInfo retrieveDataObject(Map<String, String> parameters) {
        try {
            return getTypeService().getTypeTypeRelation(parameters.get(TYPE_TYPE_RELATION_ID), getContextInfo());
