...
@Controller
@RequestMapping(value = KRMSConstants.WebPaths.AGENDA_STUDENT_INQUIRY_PATH)
public class AgendaStudentInquiryController extends InquiryController {
    ...
    public ModelAndView viewRule(@ModelAttribute("KualiForm") UifFormBase form, BindingResult result,
        ...
        form.getActionParameters().put(UifParameters.NAVIGATE_TO_PAGE_ID, "AgendaStudentInquiryView-ViewRule-Page");
