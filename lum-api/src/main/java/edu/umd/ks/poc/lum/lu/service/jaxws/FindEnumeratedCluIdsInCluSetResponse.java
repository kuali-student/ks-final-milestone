...
@XmlRootElement(name = "findEnumeratedCluIdsInCluSetResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findEnumeratedCluIdsInCluSetResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
