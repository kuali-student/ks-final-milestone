...
@XmlRootElement(name = "findSimpleAntirequisitesResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findSimpleAntirequisitesResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
