...
@XmlRootElement(name = "searchForCluIdsResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "searchForCluIdsResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
