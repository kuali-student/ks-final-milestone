...
@XmlRootElement(name = "findClusForLuTypeResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findClusForLuTypeResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
