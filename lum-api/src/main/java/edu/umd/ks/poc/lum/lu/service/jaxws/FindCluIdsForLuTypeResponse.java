...
@XmlRootElement(name = "findCluIdsForLuTypeResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findCluIdsForLuTypeResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
