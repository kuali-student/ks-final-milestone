...
@XmlRootElement(name = "assignCluRelationResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "assignCluRelationResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
