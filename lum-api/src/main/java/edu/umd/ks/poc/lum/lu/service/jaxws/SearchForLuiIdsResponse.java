...
@XmlRootElement(name = "searchForLuiIdsResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "searchForLuiIdsResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
