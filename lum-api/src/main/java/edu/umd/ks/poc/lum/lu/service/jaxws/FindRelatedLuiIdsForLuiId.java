...
@XmlRootElement(name = "findRelatedLuiIdsForLuiId", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findRelatedLuiIdsForLuiId", namespace = "http://edu.umd.ks/poc/lum/lu")
