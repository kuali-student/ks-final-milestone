...
@XmlRootElement(name = "removeSimpleEquivalencyResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "removeSimpleEquivalencyResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
