...
@XmlRootElement(name = "findEquivalenciesForDisplay", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findEquivalenciesForDisplay", namespace = "http://edu.umd.ks/poc/lum/lu")
