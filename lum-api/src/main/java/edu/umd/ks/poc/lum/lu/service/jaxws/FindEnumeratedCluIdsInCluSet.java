...
@XmlRootElement(name = "findEnumeratedCluIdsInCluSet", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findEnumeratedCluIdsInCluSet", namespace = "http://edu.umd.ks/poc/lum/lu")
