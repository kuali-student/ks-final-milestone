...
@XmlRootElement(name = "findSimpleEquivalencies", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findSimpleEquivalencies", namespace = "http://edu.umd.ks/poc/lum/lu")
