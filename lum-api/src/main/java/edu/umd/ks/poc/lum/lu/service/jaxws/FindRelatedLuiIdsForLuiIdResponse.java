...
@XmlRootElement(name = "findRelatedLuiIdsForLuiIdResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findRelatedLuiIdsForLuiIdResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
