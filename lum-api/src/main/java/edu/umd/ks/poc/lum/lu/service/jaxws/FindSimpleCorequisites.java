...
@XmlRootElement(name = "findSimpleCorequisites", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findSimpleCorequisites", namespace = "http://edu.umd.ks/poc/lum/lu")
