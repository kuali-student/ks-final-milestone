...
@XmlRootElement(name = "removeSimplePrerequisiteResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "removeSimplePrerequisiteResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
