...
@XmlRootElement(name = "findAllowedLuRelationTypesForLui", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findAllowedLuRelationTypesForLui", namespace = "http://edu.umd.ks/poc/lum/lu")
