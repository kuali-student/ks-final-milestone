...
@XmlRootElement(name = "removeSimpleAntirequisiteResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "removeSimpleAntirequisiteResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
