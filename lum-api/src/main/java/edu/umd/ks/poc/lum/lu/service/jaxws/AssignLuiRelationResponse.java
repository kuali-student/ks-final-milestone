...
@XmlRootElement(name = "assignLuiRelationResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "assignLuiRelationResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
