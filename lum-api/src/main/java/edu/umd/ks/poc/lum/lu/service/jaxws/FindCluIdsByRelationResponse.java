...
@XmlRootElement(name = "findCluIdsByRelationResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findCluIdsByRelationResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
