...
@XmlRootElement(name = "findSimplePrerequisites", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findSimplePrerequisites", namespace = "http://edu.umd.ks/poc/lum/lu")
