...
@XmlRootElement(name = "findRelatedClusForCluIdResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findRelatedClusForCluIdResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
