...
@XmlRootElement(name = "searchForLuiRelationsResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "searchForLuiRelationsResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
