...
@XmlRootElement(name = "removeSimpleCorequisiteResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "removeSimpleCorequisiteResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
