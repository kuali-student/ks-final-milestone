...
@XmlRootElement(name = "removeSimpleAntirequisite", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "removeSimpleAntirequisite", namespace = "http://edu.umd.ks/poc/lum/lu")
