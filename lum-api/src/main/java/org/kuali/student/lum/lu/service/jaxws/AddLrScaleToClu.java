...
@XmlRootElement(name = "addLrScaleToClu", namespace = "http://student.kuali.org/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "addLrScaleToClu", namespace = "http://student.kuali.org/lum/lu", propOrder = {"lrScaleTypeKey","lrTypeKey","cluId"})
