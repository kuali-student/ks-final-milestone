...
@XmlRootElement(name = "getLrScaleTypesForLui", namespace = "http://student.kuali.org/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getLrScaleTypesForLui", namespace = "http://student.kuali.org/lum/lu", propOrder = {"luiId","lrTypeKey"})
