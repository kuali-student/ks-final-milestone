...
@XmlRootElement(name = "getSearchTypeResponse", namespace = "http://student.kuali.org/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getSearchTypeResponse", namespace = "http://student.kuali.org/lum/lu")
