...
@XmlRootElement(name = "getLuisInAtpByCluId", namespace = "http://student.kuali.org/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getLuisInAtpByCluId", namespace = "http://student.kuali.org/lum/lu", propOrder = {"cluId","atpKey"})
