...
@XmlRootElement(name = "searchForResults", namespace = "http://student.kuali.org/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "searchForResults", namespace = "http://student.kuali.org/lum/lu", propOrder = {"searchTypeKey","queryParamValues"})
