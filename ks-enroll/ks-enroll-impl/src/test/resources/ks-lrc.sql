...
INSERT INTO KSEN_LRC_RES_VALUE (ID,TYPE_ID,NAME,RT_DESCR_ID,VALUE,STATE_ID,RES_SCALE_ID) VALUES ('kuali.result.value.grade.letter.a','kuali.result.scale.type.grade','Excellent','RICHTEXT-222','A','kuali.result.value.state.approved','kuali.result.scale.grade.letter')
INSERT INTO KSEN_LRC_RES_VALUE (ID,TYPE_ID,NAME,RT_DESCR_ID,VALUE,STATE_ID,RES_SCALE_ID) VALUES ('kuali.result.value.grade.letter.b','kuali.result.scale.type.grade','Good','RICHTEXT-223','B','kuali.result.value.state.approved','kuali.result.scale.grade.letter')
INSERT INTO KSEN_LRC_RES_VALUE (ID,TYPE_ID,NAME,RT_DESCR_ID,VALUE,STATE_ID,RES_SCALE_ID) VALUES ('kuali.result.value.grade.letter.c','kuali.result.scale.type.grade','Average','RICHTEXT-224','C','kuali.result.value.state.approved','kuali.result.scale.grade.letter')
INSERT INTO KSEN_LRC_RES_VALUE (ID,TYPE_ID,NAME,RT_DESCR_ID,VALUE,STATE_ID,RES_SCALE_ID) VALUES ('kuali.result.value.grade.letter.d','kuali.result.scale.type.grade','Below Average','RICHTEXT-225','D','kuali.result.value.state.approved','kuali.result.scale.grade.letter')
INSERT INTO KSEN_LRC_RES_VALUE (ID,TYPE_ID,NAME,RT_DESCR_ID,VALUE,STATE_ID,RES_SCALE_ID) VALUES ('kuali.result.value.grade.letter.f','kuali.result.scale.type.grade','Failing','RICHTEXT-226','F','kuali.result.value.state.approved','kuali.result.scale.grade.letter')
