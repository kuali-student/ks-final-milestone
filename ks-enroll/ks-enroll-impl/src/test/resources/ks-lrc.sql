...
//LRC types
///////////////////////////////////////////////////////////////////////////
INSERT INTO KSEN_TYPE (ID,VER_NBR,TYPE_DESC,NAME) VALUES ('kuali.result.scale.grade.letter',1,'Standard A-F grading scale','A-F Grading Scale')
INSERT INTO KSEN_TYPE (ID,VER_NBR,TYPE_DESC,NAME) VALUES ('kuali.result.values.group.type.fixed',1,'A result grouping that includes just a single result value','Fixed')
INSERT INTO KSEN_TYPE (ID,VER_NBR,TYPE_DESC,NAME) VALUES ('kuali.result.values.group.type.range',1,'A grouping that indicates a range of numeric values with a specified increment. It is not necessary that all of the values within that range have been explicitly pre-defined','Range')
INSERT INTO KSEN_TYPE (ID,VER_NBR,TYPE_DESC,NAME) VALUES ('kuali.result.values.group.type.multiple',1,'Multiple explicitly named values from which one may be choosen','Multiple')
INSERT INTO KSEN_TYPE (ID,VER_NBR,TYPE_DESC,NAME) VALUES ('kuali.result.scale.type.grade',1,'The result of an assessment, typically of a course','Grade')
INSERT INTO KSEN_TYPE (ID,VER_NBR,TYPE_DESC,NAME) VALUES ('kuali.result.value.type.value',1,'The result value','Value')
