...
INSERT INTO KSEN_TYPE (ID, NAME, DESCR_PLAIN, REF_OBJECT_URI, VER_NBR) VALUES ('kuali.atp.type.winter', 'Winter', 'Winter Term', 'http://student.kuali.org/wsdl/atp/AtpInfo', 0)
...
//LuiTypeEntity
INSERT INTO KSEN_TYPE(ID, NAME, DESCR_PLAIN, VER_NBR)VALUES ('kuali.lui.type.course.offering', 'Course Offering', 'An offering of a course for a particular term', 0)
INSERT INTO KSEN_TYPE(ID, NAME, DESCR_PLAIN, VER_NBR)VALUES ('kuali.lui.type.registration.group', 'registration Group', 'The collection of activity offerings of a single course that are grouped together for registration purposes', 0)
INSERT INTO KSEN_TYPE(ID, NAME, DESCR_PLAIN, VER_NBR)VALUES ('kuali.lui.type.activity.offering.lecture', 'Lecture', 'Instructor presentation of course materials', 0)
INSERT INTO KSEN_TYPE(ID, NAME, DESCR_PLAIN, VER_NBR)VALUES ('kuali.lui.type.activity.offering.lab', 'Lab', 'Student working on projects in a defined laboratory space. Instructors are on-hand for students to ask questions and guidance', 0)
