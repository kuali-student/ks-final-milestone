...
//IssueEntity
INSERT INTO KSEN_HOLD_ISSUE (ID, NAME, HOLD_ISSUE_TYPE, HOLD_ISSUE_STATE, ORG_ID, DESCR_PLAIN, VER_NBR) VALUES ('Hold-Issue-1', 'Issue one', 'kuali.hold.issue.type.residency', 'kuali.hold.issue.state.active', '102', 'Issue-1-Desc', 0)
INSERT INTO KSEN_HOLD_ISSUE (ID, NAME, HOLD_ISSUE_TYPE, HOLD_ISSUE_STATE, ORG_ID, DESCR_PLAIN, VER_NBR) VALUES ('Hold-Issue-2', 'Issue two', 'kuali.hold.issue.type.residency', 'kuali.hold.issue.state.active', '102', 'Issue-2-Desc', 0)

//HoldEntity
INSERT INTO KSEN_HOLD (ID,  DESCR_PLAIN, PERS_ID, ISSUE_ID, HOLD_TYPE, HOLD_STATE, EFF_DT, RELEASED_DT, VER_NBR) VALUES ('Hold-1',  'RICHTEXT-Hold-301', '1', 'Hold-Issue-1', 'kuali.hold.type.student', 'kuali.hold.state.active', {ts '2011-01-01 00:00:00.0'}, {ts '2011-12-31 00:00:00.0'}, 0)
INSERT INTO KSEN_HOLD (ID,  DESCR_PLAIN, PERS_ID, ISSUE_ID, HOLD_TYPE, HOLD_STATE, EFF_DT, RELEASED_DT, VER_NBR) VALUES ('Hold-2',  'RICHTEXT-Hold-401', '1', 'Hold-Issue-1', 'kuali.hold.type.instructor', 'kuali.hold.state.active', {ts '2011-01-01 00:00:00.0'}, {ts '2011-12-31 00:00:00.0'}, 0)
