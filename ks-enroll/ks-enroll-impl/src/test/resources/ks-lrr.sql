...
INSERT INTO KSEN_TYPE (ID, NAME, DESCR_PLAIN, VER_NBR) VALUES ('kuali.lpr.roster.entry.type.automatic', 'Automatic', 'Don''t know what this is', 0)
INSERT INTO KSEN_TYPE (ID, NAME, DESCR_PLAIN, VER_NBR) VALUES ('kuali.lpr.trans.item.type.add', 'Add', 'Add course', 0)
INSERT INTO KSEN_TYPE (ID, NAME, DESCR_PLAIN, VER_NBR) VALUES ('kuali.lpr.trans.type.register', 'Register', 'Register', 0)
INSERT INTO KSEN_TYPE (ID, NAME, DESCR_PLAIN, VER_NBR) VALUES ('kuali.lpr.type.registrant', 'Registrant', 'Registrant who is taking the course', 0)
...
INSERT INTO KSEN_LRR(ID, LPR_ID, NAME, RT_DESCR_ID, LRR_STATE, LRR_TYPE, RESULT_VALUE_ID, VER_NBR) VALUES('student1-grade-final-lecture', 'student1', 'student1 grade final lecture', 'grade-final-lecture-desc', 'kuali.lrr.state.saved', 'kuali.lrr.type.final.grade.assigned', 'student1-grade-value-final-lecture', 0)
INSERT INTO KSEN_LRR(ID, LPR_ID, NAME, RT_DESCR_ID, LRR_STATE, LRR_TYPE, RESULT_VALUE_ID, VER_NBR) VALUES('student1-grade-interim-lecture', 'student1', 'student1 grade interim lecture', 'grade-interim-lecture-desc', 'kuali.lrr.state.saved', 'kuali.lrr.type.interim.grade', 'student1-grade-value-interim-lecture', 0)
INSERT INTO KSEN_LRR(ID, LPR_ID, NAME, RT_DESCR_ID, LRR_STATE, LRR_TYPE, RESULT_VALUE_ID, VER_NBR) VALUES('student2-grade-final-lecture', 'student2', 'student2 grade final lecture', 'grade-final-lecture-desc', 'kuali.lrr.state.saved', 'kuali.lrr.type.final.grade.assigned', 'student2-grade-value-final-lecture', 0)
INSERT INTO KSEN_LRR(ID, LPR_ID, NAME, RT_DESCR_ID, LRR_STATE, LRR_TYPE, RESULT_VALUE_ID, VER_NBR) VALUES('student2-grade-interim-lecture', 'student2', 'student2 grade interim lecture', 'grade-interim-lecture-desc', 'kuali.lrr.state.saved', 'kuali.lrr.type.interim.grade', 'student2-grade-value-interim-lecture', 0)
