...
public class AcalTestDataLoader {
    ...
    public void loadData() throws Exception {
        ...
        loadAtp("testAtpId2", "testAtp2", "2000-01-01 00:00:00.0", "2100-12-31 00:00:00.0", AtpServiceConstants.ATP_HOLIDAY_CALENDAR_TYPE_KEY, AtpServiceConstants.ATP_DRAFT_STATE_KEY, "Desc 102");
        loadAtp("testDeleteAtpId1", "testDeleteAtp1", "2012-01-01 00:00:00.0", "2100-12-31 00:00:00.0", AtpServiceConstants.ATP_HOLIDAY_CALENDAR_TYPE_KEY, AtpServiceConstants.ATP_DRAFT_STATE_KEY, "Desc 103");
        loadAtp("testDeleteAtpId2", "testDeleteAtp2", "2012-01-01 00:00:00.0", "2100-12-31 00:00:00.0", AtpServiceConstants.ATP_HOLIDAY_CALENDAR_TYPE_KEY, AtpServiceConstants.ATP_DRAFT_STATE_KEY, "Desc 104");
        loadAtp("testTermId1", "testTerm1", "2000-01-01 00:00:00.0", "2100-12-31 00:00:00.0", AtpServiceConstants.ATP_FALL_TYPE_KEY, AtpServiceConstants.ATP_DRAFT_STATE_KEY, "Desc 2");
        loadAtp("testTermId2", "testTerm2", "2000-01-01 00:00:00.0", "2100-12-31 00:00:00.0", AtpServiceConstants.ATP_SPRING_TYPE_KEY, AtpServiceConstants.ATP_DRAFT_STATE_KEY, "Desc 3");
        ...
        loadAtp("CAMPUSCALENDAR19901991", "Holiday Calendar 1990-1991", "1990-08-01 00:00:00.0", "1991-12-31 00:00:00.0", AtpServiceConstants.ATP_HOLIDAY_CALENDAR_TYPE_KEY, AtpServiceConstants.ATP_OFFICIAL_STATE_KEY, "1990-1991 Holiday Calendar");
        ...
        loadAtp("FALLTERM1990", "Fall Term 1990", "1990-08-01 00:00:00.0", "1990-12-31 00:00:00.0", AtpServiceConstants.ATP_FALL_TYPE_KEY, AtpServiceConstants.ATP_OFFICIAL_STATE_KEY, "Fall Term 1990");
        ...
        loadTerm("termRelationTestingTerm1", "testingTerm1", "2000-09-01 00:00:00.0", "2000-12-31 00:00:00.0", AtpServiceConstants.ATP_FALL_TYPE_KEY, AtpServiceConstants.ATP_DRAFT_STATE_KEY, "Desc term rich text 1");
        loadTerm("termRelationTestingTerm2", "testingTerm2", "2001-01-01 00:00:00.0", "2001-05-31 00:00:00.0", AtpServiceConstants.ATP_SPRING_TYPE_KEY, AtpServiceConstants.ATP_DRAFT_STATE_KEY, "Desc term rich text 2");
        loadTerm("termRelationTestingTerm3", "testingTerm3", "2000-09-01 00:00:00.0", "2000-12-31 00:00:00.0", AtpServiceConstants.ATP_FALL_TYPE_KEY, AtpServiceConstants.ATP_OFFICIAL_STATE_KEY, "Desc term rich text 7");
        ...
        loadTerm("termRelationTestingTerm5", "testingTerm3", "2000-09-01 00:00:00.0", "2000-12-31 00:00:00.0", AtpServiceConstants.ATP_FALL_TYPE_KEY, AtpServiceConstants.ATP_OFFICIAL_STATE_KEY, "Desc term rich text 10");
        ...
        loadMilestone("testId", "testId", "2011-07-10 00:00:00.0", "2011-07-20 00:00:00.0", AtpServiceConstants.MILESTONE_ADVANCED_REGISTRATION_PERIOD_TYPE_KEY, AtpServiceConstants.MILESTONE_DRAFT_STATE_KEY, false, false, true, false, null, "Desc 105");
        loadMilestone("testId2", "testId2", "2011-08-01 00:00:00.0", "2011-10-01 00:00:00.0", AtpServiceConstants.MILESTONE_REGISTRATION_PERIOD_TYPE_KEY, AtpServiceConstants.MILESTONE_DRAFT_STATE_KEY, false, false, true, false, null, "Desc 106");
        loadMilestone("testId3", "testId3", "2011-11-01 00:00:00.0", "2011-11-01 00:00:00.0", AtpServiceConstants.MILESTONE_DROP_DATE_TYPE_KEY, AtpServiceConstants.MILESTONE_DRAFT_STATE_KEY, false, true, false, false, null, "Desc 107");
        loadMilestone("testDeleteId", "testDeleteId", "2011-11-01 00:00:00.0", "2011-12-01 00:00:00.0", AtpServiceConstants.MILESTONE_REGISTRATION_PERIOD_TYPE_KEY, AtpServiceConstants.MILESTONE_DRAFT_STATE_KEY, false, false, false, false, null, "Desc 108");
        loadMilestone("FALLTERM1990REGISTRATION", "Fall Term Registration Period", "1990-08-01 00:00:00.0", "1990-09-09 00:00:00.0", AtpServiceConstants.MILESTONE_REGISTRATION_PERIOD_TYPE_KEY, AtpServiceConstants.MILESTONE_OFFICIAL_STATE_KEY, false, false, true, false, null, "Fall 1990 Registration");
        loadMilestone("FALLFIRSTBLOCK1990COURSESELECTIONEND", "Fall First Block Course Selection Period Ends", "1990-09-10 00:00:00.0", "1990-09-10 00:00:00.0", AtpServiceConstants.MILESTONE_COURSE_SELECTION_PERIOD_END_TYPE_KEY, AtpServiceConstants.MILESTONE_OFFICIAL_STATE_KEY, false, false, false, false, null, "Fall First Block Course Selection");
        loadMilestone("FALLFIRSTBLOCK1990DROPDATE", "Drop Deadlin", "1990-09-10 00:00:00.0", "1990-09-10 00:00:00.0", AtpServiceConstants.MILESTONE_DROP_DATE_TYPE_KEY, AtpServiceConstants.MILESTONE_OFFICIAL_STATE_KEY, false, false, false, false, null, "Deadline to Drop Fall First Block Classes");
        loadMilestone("FALLFIRSTBLOCK1990GRADESDUE", "Fall Grades Due", "1990-11-01 00:00:00.0", "1990-11-05 00:00:00.0", AtpServiceConstants.MILESTONE_GRADES_DUE_TYPE_KEY, AtpServiceConstants.MILESTONE_OFFICIAL_STATE_KEY, false, false, true, false, null, "First Block Grades Due");
        loadMilestone("FALLFIRSTBLOCK1990INSTRUCTIONPERIOD", "Fall First Block Instructional Period", "1990-09-03 00:00:00.0", "1990-11-01 00:00:00.0", AtpServiceConstants.MILESTONE_INSTRUCTIONAL_PERIOD_TYPE_KEY, AtpServiceConstants.MILESTONE_OFFICIAL_STATE_KEY, false, true, true, false, null, "Instruction Period");
        loadMilestone("FALLFIRSTBLOCK1990REGISTRATION", "Fall First Block Registration Period", "1990-08-01 00:00:00.0", "1990-09-09 00:00:00.0", AtpServiceConstants.MILESTONE_REGISTRATION_PERIOD_TYPE_KEY, AtpServiceConstants.MILESTONE_OFFICIAL_STATE_KEY, false, false, true, false, null, "Fall First Block 1990 Registration");
        loadMilestone("FALLTERM1990CENSUS", "Fall Term Census", "1990-09-24 00:00:00.0", "1990-09-25 00:00:00.0", AtpServiceConstants.MILESTONE_FINANCIAL_AID_CENSUS_TYPE_KEY, AtpServiceConstants.MILESTONE_OFFICIAL_STATE_KEY, false, true, false, true, "FALLTERM1990INSTRUCTIONPERIOD", "Census");
        loadMilestone("FALLTERM1990COMMENCEMENT", "Fall Commencement 1990", "1990-12-15 10:00:00.0", "1990-12-15 11:00:00.0", AtpServiceConstants.MILESTONE_COMMENCEMENT_TYPE_KEY, AtpServiceConstants.MILESTONE_OFFICIAL_STATE_KEY, false, false, false, false, null, "Commencement");
        loadMilestone("FALLTERM1990COURSESELECTIONEND", "Fall Term Course Selection Period Ends", "1990-09-10 00:00:00.0", "1990-09-10 00:00:00.0", AtpServiceConstants.MILESTONE_COURSE_SELECTION_PERIOD_END_TYPE_KEY, AtpServiceConstants.MILESTONE_OFFICIAL_STATE_KEY, false, false, false, false, null, "Fall Course Selection");
        loadMilestone("FALLTERM1990DROPDATE", "Drop Deadlin", "1990-09-10 00:00:00.0", "1990-09-10 00:00:00.0", AtpServiceConstants.MILESTONE_DROP_DATE_TYPE_KEY, AtpServiceConstants.MILESTONE_OFFICIAL_STATE_KEY, false, false, false, false, null, "Deadline to Drop Fall Term Classes");
        loadMilestone("FALLTERM1990FINALS", "Fall Finals", "1990-12-10 00:00:00.0", "1990-12-15 00:00:00.0", AtpServiceConstants.MILESTONE_FINAL_EXAM_PERIOD_TYPE_KEY, AtpServiceConstants.MILESTONE_OFFICIAL_STATE_KEY, false, true, true, false, null, "Fall Finals");
        loadMilestone("FALLTERM1990GRADESDUE", "Fall Grades Due", "1990-12-15 00:00:00.0", "1990-12-22 00:00:00.0", AtpServiceConstants.MILESTONE_GRADES_DUE_TYPE_KEY, AtpServiceConstants.MILESTONE_OFFICIAL_STATE_KEY, false, true, true, false, null, "Grades Due");
        loadMilestone("FALLTERM1990INSTRUCTIONPERIOD", "Fall Term Instructional Period", "1990-09-03 00:00:00.0", "1990-12-01 00:00:00.0", AtpServiceConstants.MILESTONE_INSTRUCTIONAL_PERIOD_TYPE_KEY, AtpServiceConstants.MILESTONE_OFFICIAL_STATE_KEY, false, true, true, false, null, "Instruction Period");
        loadMilestone("testKeyDate1", "testKeyDate1", "2001-09-10 00:00:00.0", "2001-09-20 00:00:00.0", AtpServiceConstants.MILESTONE_ADVANCED_REGISTRATION_PERIOD_TYPE_KEY, AtpServiceConstants.MILESTONE_DRAFT_STATE_KEY, false, false, true, false, null, "Desc term rich text 5");
        loadMilestone("testKeyDate2", "testKeyDate2", "2001-08-01 00:00:00.0", "2001-10-01 00:00:00.0", AtpServiceConstants.MILESTONE_REGISTRATION_PERIOD_TYPE_KEY, AtpServiceConstants.MILESTONE_DRAFT_STATE_KEY, false, false, true, false, null, "Desc term rich text 6");
        loadMilestone("THANKSGIVING1990", "Thanksgiving 1990", "1990-11-21 00:00:00.0", "1990-11-26 00:00:00.0", AtpServiceConstants.MILESTONE_THANKSGIVING_BREAK_TYPE_KEY, AtpServiceConstants.MILESTONE_OFFICIAL_STATE_KEY, false, true, true, false, null, "Thanksgiving Break");
        ...
        loadAtpAtpRel("ATPATPREL-1", "2011-01-01 00:00:00.0", "2100-01-01 00:00:00.0", AtpServiceConstants.ATP_ATP_RELATION_ACTIVE_STATE_KEY, "testAtpId1", AtpServiceConstants.ATP_ATP_RELATION_ASSOCIATED_TYPE_KEY, "testAtpId2");
