...
public class CourseOfferingTestDataLoader {
	...
	// coService.createCourseOffering("Lui-1", "atpId1", LuiServiceConstants.COURSE_OFFERING_TYPE_KEY, courseOfferingInfo, optionKeys, context)
 private void createCourseOffering(String id,
                      String name,
                      String cluId,
                      String atpId,
	 ...
	 CourseOfferingServiceDataUtils.createCourseOffering(id, atpId);
     ...
     luiInfo.setTypeKey(LuiServiceConstants.COURSE_OFFERING_TYPE_KEY);
     luiInfo.setStateKey(LuiServiceConstants.COURSE_OFFERING_PROCESS_STATE_KEYS[0]);
