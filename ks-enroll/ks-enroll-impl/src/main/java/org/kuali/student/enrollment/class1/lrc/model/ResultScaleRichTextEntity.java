...
public class ResultScaleRichTextEntity extends RichTextEntity {

    public ResultScaleRichTextEntity() {}

    public ResultScaleRichTextEntity(String plain, String formatted) {
        this.setFormatted(formatted);
        this.setPlain(plain);
    }

    public ResultScaleRichTextEntity(RichText rt) {
        if (null != rt) {
