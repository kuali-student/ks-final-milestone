...
public class AppointmentWindowRichTextEntity extends RichTextEntity {

    public AppointmentWindowRichTextEntity() {
    }

    public AppointmentWindowRichTextEntity(String plain, String formatted){
        this.setFormatted(formatted);
        this.setPlain(plain);
    }

    public AppointmentWindowRichTextEntity(RichText rt) {
        if (null != rt) {
