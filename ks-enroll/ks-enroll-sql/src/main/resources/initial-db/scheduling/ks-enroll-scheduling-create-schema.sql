...
CREATE UNIQUE INDEX KSEN_SCHED_RQST_P ON KSEN_SCHED_RQST
(ID   ASC)
/
...
ALTER TABLE KSEN_SCHED_RQST
	ADD CONSTRAINT  KSEN_SCHED_REQUEST_PK PRIMARY KEY (ID)   USING INDEX KSEN_SCHED_RQST_P
/
...
CREATE UNIQUE INDEX KSEN_SCHED_RQST_ATTR_P ON KSEN_SCHED_RQST_ATTR
(ID   ASC)
/
...
ALTER TABLE KSEN_SCHED_RQST_ATTR
	ADD CONSTRAINT  KSEN_SCHED_RQST_ATTR_P PRIMARY KEY (ID)   USING INDEX KSEN_SCHED_RQST_ATTR_P
/
...
CREATE UNIQUE INDEX KSEN_SCHED_RQST_CMP_P ON KSEN_SCHED_RQST_CMP
(ID   ASC)
/
...
ALTER TABLE KSEN_SCHED_RQST_CMP
	ADD CONSTRAINT  KSEN_SCHED_REQUEST_COM_PK PRIMARY KEY (ID)   USING INDEX KSEN_SCHED_RQST_CMP_P
/
...
CREATE UNIQUE INDEX KSEN_SCHED_RQST_CMP_BLDG_P ON KSEN_SCHED_RQST_CMP_BLDG
(ID   ASC)
/
...
ALTER TABLE KSEN_SCHED_RQST_CMP_BLDG
	ADD CONSTRAINT  KSEN_SCHED_RQST_COM_BLDG_PK PRIMARY KEY (ID)   USING INDEX KSEN_SCHED_RQST_CMP_BLDG_P
/
...
CREATE UNIQUE INDEX KSEN_SCHED_RQST_CMP_CAMPUS_P ON KSEN_SCHED_RQST_CMP_CAMPUS
(ID   ASC)
/
...
ALTER TABLE KSEN_SCHED_RQST_CMP_CAMPUS
	ADD CONSTRAINT  KSEN_SCHED_RQST_COM_CAMPUS_PK PRIMARY KEY (ID)   USING INDEX KSEN_SCHED_RQST_CMP_CAMPUS_P
/
...
CREATE UNIQUE INDEX KSEN_SCHED_RQST_CMP_ORG_P ON KSEN_SCHED_RQST_CMP_ORG
(ID   ASC)
/
...
ALTER TABLE KSEN_SCHED_RQST_CMP_ORG
	ADD CONSTRAINT  KSEN_SCHED_RQST_COM_ORG_PK PRIMARY KEY (ID)   USING INDEX KSEN_SCHED_RQST_CMP_ORG_P
/
...
CREATE UNIQUE INDEX KSEN_SCHED_RQST_CMP_ROOM_P ON KSEN_SCHED_RQST_CMP_ROOM
(ID   ASC)
/
...
ALTER TABLE KSEN_SCHED_RQST_CMP_ROOM
	ADD CONSTRAINT  KSEN_SCHED_RQST_COM_ROOM_PK PRIMARY KEY (ID)   USING INDEX KSEN_SCHED_RQST_CMP_ROOM_P
/
...
CREATE UNIQUE INDEX KSEN_SCHED_RQST_RT_P ON KSEN_SCHED_RQST_CMP_RT
(ID   ASC)
/
...
ALTER TABLE KSEN_SCHED_RQST_CMP_RT
	ADD CONSTRAINT  KSEN_SCHED_RQST_RT_PK PRIMARY KEY (ID)   USING INDEX KSEN_SCHED_RQST_RT_P
/
...
CREATE UNIQUE INDEX KSEN_SCHED_RQST_CMP_TMSLOT_P ON KSEN_SCHED_RQST_CMP_TMSLOT
(ID   ASC)
/
...
ALTER TABLE KSEN_SCHED_RQST_CMP_TMSLOT
	ADD CONSTRAINT  KSEN_SCHED_RQST_COM_TMSLOT_PK PRIMARY KEY (ID)   USING INDEX KSEN_SCHED_RQST_CMP_TMSLOT_P
/
