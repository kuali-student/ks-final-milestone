...
Insert into KSEN_ATP (ID,OBJ_ID,VER_NBR,CREATEID,CREATETIME,UPDATEID,UPDATETIME,START_DT,END_DT,NAME,ATP_STATE_ID,ATP_TYPE_ID,RT_DESCR_ID) values ('testTermId0',null,0,null,null,null,null, to_timestamp('15-SEP-10 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'), to_timestamp('16-DEC-10 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'), 'Fall 2010', 'kuali.atp.state.Draft','kuali.atp.type.Fall','RICHTEXT-201')
/
...
Insert into KSEN_ATP (ID,OBJ_ID,VER_NBR,CREATEID,CREATETIME,UPDATEID,UPDATETIME,START_DT,END_DT,NAME,ATP_STATE_ID,ATP_TYPE_ID,RT_DESCR_ID) values ('AcademicCalendar20102011',null,0,null,null,null,null, to_timestamp('01-SEP-10 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'), to_timestamp('31-AUG-11 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'), '2010-2011 Academic Calendar', 'kuali.atp.state.Draft','kuali.atp.type.AcademicCalendar','AcademicCalendar20102011')
/

Insert into KSEN_ATP (ID,OBJ_ID,VER_NBR,CREATEID,CREATETIME,UPDATEID,UPDATETIME,START_DT,END_DT,NAME,ATP_STATE_ID,ATP_TYPE_ID,RT_DESCR_ID) values ('Spring2011',null,0,null,null,null,null, to_timestamp('26-MAR-11 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'), to_timestamp('08-JUN-11 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'), 'Spring 2011', 'kuali.atp.state.Draft','kuali.atp.type.Spring','Spring2011')
/
