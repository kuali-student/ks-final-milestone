...
Insert into KSEN_ATP (ID,OBJ_ID,VER_NBR,CREATEID,CREATETIME,UPDATEID,UPDATETIME,START_DT,END_DT,NAME,ATP_STATE_ID,ATP_TYPE_ID,RT_DESCR_ID) values ('testTermId0',null,0,null,null,null,null, to_timestamp('26-MAR-11 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'), to_timestamp('08-JUN-11 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'), 'Spring 2011', 'kuali.atp.state.Draft','kuali.atp.type.Spring','RICHTEXT-201')
/
