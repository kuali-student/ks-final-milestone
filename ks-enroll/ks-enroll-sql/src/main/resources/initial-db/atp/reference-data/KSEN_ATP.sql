...
Insert into KSEN_ATP (ID,OBJ_ID,VER_NBR,CREATEID,CREATETIME,UPDATEID,UPDATETIME,START_DT,END_DT,NAME,ATP_STATE_ID,ATP_TYPE_ID,RT_DESCR_ID) values ('testTermId1',null,0,null,null,null,null, to_timestamp('28-SEP-11 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'), to_timestamp('16-DEC-11 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'), 'Fall 2011', 'kuali.atp.state.Draft','kuali.atp.type.Fall','RICHTEXT-201')
/
