...
--------------------------------------------------------
  ...
  ALTER TABLE "KSEN_LPR" ADD CONSTRAINT "FK1BE1597B1D2EFA44" FOREIGN KEY ("LPR_TYPE")
	  REFERENCES "KSEN_LPR_TYPE" ("TYPE_KEY") ENABLE
/
 
  ALTER TABLE "KSEN_LPR" ADD CONSTRAINT "FK1BE1597B61E975F6" FOREIGN KEY ("LPR_STATE")
