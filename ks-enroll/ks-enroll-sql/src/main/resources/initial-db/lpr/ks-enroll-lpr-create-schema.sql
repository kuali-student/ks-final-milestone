...
create table KSEN_LPR_ROSTER
   (
		...
		TM_QUANTITY number,
		CONSTRAINT KSEN_LPR_ROSTER_PK PRIMARY KEY (ID),
		CONSTRAINT KSEN_LPR_ROSTER_FK1 FOREIGN KEY (RT_DESCR_ID) REFERENCES KSEN_RICH_TEXT_T(ID)
   )
/
...
create table  KSEN_LPRROSTER_LUI_RELTN
  (
	    ...
	    LUI_ID varchar2(255),
	    CONSTRAINT KSEN_LPRROSTER_LUI_RELTN_FK1 FOREIGN KEY (LPRROSTER_ID) REFERENCES KSEN_LPR_ROSTER(ID),
	    CONSTRAINT KSEN_LPRROSTER_LUI_RELTN_FK2 FOREIGN KEY (LUI_ID) REFERENCES KSEN_LUI(ID)
  )
/
