...
INSERT INTO KSEN_LUI (ID, NAME, CLU_ID, LUI_TYPE, LUI_STATE, DESCR_PLAIN, DESCR_FORMATTED, EFF_DT, EXPIR_DT, VER_NBR, CREATETIME, CREATEID) VALUES ('Lui-4', 'Lui four',  'cluId4', 'kuali.lui.type.activity.offering.lecture', 'kuali.lui.state.draft', 'Lui-4-Desc', 'Lui-4-Desc', to_timestamp('01-JAN-11 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),to_timestamp('31-DEC-11 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM') , 0, TO_DATE('1-1-1970 00:00:00','MM-DD-YYYY HH24:Mi:SS'), 'admin')
/
