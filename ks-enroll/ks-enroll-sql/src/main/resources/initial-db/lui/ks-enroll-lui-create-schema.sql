...
ALTER TABLE KSEN_LUI
	ADD CONSTRAINT  KSEN_LUI_P PRIMARY KEY (ID)   USING INDEX KSEN_LUI_P
/
...
ALTER TABLE KSEN_LUI_ATTR
	ADD CONSTRAINT  LSEN_LUI_ATTR_P PRIMARY KEY (ID)   USING INDEX KSEN_LUI_ATTR_P
/
...
CREATE UNIQUE INDEX KSEN_LUI_CAMPUS_LOC_P ON KSEN_LUI_CAMPUS_LOC
(ID   ASC)
/


ALTER TABLE KSEN_LUI_CAMPUS_LOC
	ADD CONSTRAINT  KSEN_LUI_CAMPUS_LOC_P PRIMARY KEY (ID)   USING INDEX KSEN_LUI_CAMPUS_LOC_P
/
...
ALTER TABLE KSEN_LUI_CAPACITY
	ADD CONSTRAINT  KSEN_LUI_CAPACITY_P PRIMARY KEY (ID)   USING INDEX KSEN_LUI_CAPACITY_P
/
...
ALTER TABLE KSEN_LUI_CLUCLU_RELTN
	ADD CONSTRAINT  KSEN_LUI_CLUCLU_RELTN_P PRIMARY KEY (ID)   USING INDEX KSEN_LUI_CLUCLU_RELTN_P
/
...
ALTER TABLE KSEN_LUI_IDENT
	ADD CONSTRAINT  KSEN_LUI_IDENT_P PRIMARY KEY (ID)   USING INDEX KSEN_LUI_IDENT_P
/
...
ALTER TABLE KSEN_LUI_IDENT_ATTR
	ADD CONSTRAINT  KSEN_LUI_IDENT_ATTR_P PRIMARY KEY (ID)   USING INDEX KSEN_LUI_IDENT_ATTR_P
/
...
ALTER TABLE KSEN_LUI_LU_CD
	ADD CONSTRAINT  KSEN_LUI_LU_CD_P PRIMARY KEY (ID)   USING INDEX KSEN_LUI_LU_CD_P
/
...
ALTER TABLE KSEN_LUI_LU_CD_ATTR
	ADD CONSTRAINT  KSEN_LUI_LU_CD_ATTR_P PRIMARY KEY (ID)   USING INDEX KSEN_LUI_LU_CD_ATTR_P
/
...
ALTER TABLE KSEN_LUI_RESULT_VAL_GRP
	ADD CONSTRAINT  KSEN_LUI_RESULT_VAL_GRP_P PRIMARY KEY (ID)   USING INDEX KSEN_LUI_RESULT_VAL_GRP_P
/
...
ALTER TABLE KSEN_LUI_UNITS_CONT_OWNER
	ADD CONSTRAINT  KSEN_LUI_UNITS_CONT_OWNER_P PRIMARY KEY (ID)   USING INDEX KSEN_LUI_UNITS_CONT_OWNER_P
/
...
ALTER TABLE KSEN_LUI_UNITS_DEPLOYMENT
	ADD CONSTRAINT  KSEN_LUI_UNITS_DEPLOYMENT_P PRIMARY KEY (ID)   USING INDEX KSEN_LUI_UNITS_DEPLOYMENT_P
/
...
ALTER TABLE KSEN_LUICAPACITY_RELTN
	ADD CONSTRAINT  KSEN_REVENUE_P PRIMARY KEY (ID)   USING INDEX KSEN_REVENUE_P
/
...
ALTER TABLE KSEN_LUILUI_RELTN
	ADD CONSTRAINT  KSEN_LUILUI_RELTNP_P PRIMARY KEY (ID)   USING INDEX KSEN_LUILUI_RELTN_P
/
...
ALTER TABLE KSEN_LUILUI_RELTN_ATTR
	ADD CONSTRAINT  KSEN_LUILUI_RELTN_ATTR_P PRIMARY KEY (ID)   USING INDEX KSEN_LUILUI_RELTN_ATTR_P
/
