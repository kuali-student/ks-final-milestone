 ...
 */
public class LifecycleInfoAdminInquirableImpl
        extends InquirableImpl {

    private final static String KEY = "key";
    private transient StateService stateService;
    final Logger logger = Logger.getLogger(LifecycleInfoAdminInquirableImpl.class);

    @Override
    public LifecycleInfo retrieveDataObject(Map<String, String> parameters) {
        try {
            return getStateService().getLifecycle(parameters.get(KEY), getContextInfo());
