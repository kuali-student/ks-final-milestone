...
public class LRCServiceMockImpl implements LRCService
{
	...
	public List<ResultValueInfo> getResultValuesForResultValuesGroup(String resultValuesGroupKey, ContextInfo context)
		throws DoesNotExistException
		      ...
		      ,PermissionDeniedException
	{
		throw new OperationFailedException ("getResultValuesForResultValuesGroup has not been implemented");
	}
	// cache variable 
	// The LinkedHashMap is just so the values come back in a predictable order
	...
	public ResultScaleInfo getResultScale(String resultScaleKey, ContextInfo context)
		throws DoesNotExistException
		      ...
		      ,PermissionDeniedException
	{
		throw new OperationFailedException ("getResultScale has not been implemented");
	}
