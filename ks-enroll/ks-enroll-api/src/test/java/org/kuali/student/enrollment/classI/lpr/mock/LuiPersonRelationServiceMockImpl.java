...
//    }
    ...
    @Override
    public List<LprTransactionInfo> getLprTransactionsWithItemsByPersonAndAtp(String atpId, String personId,
    ...
    @Override
    public List<LuiPersonRelationInfo> getLprsByLuiAndType(String typeKey, String luiId, ContextInfo context)
            throws DoesNotExistException, InvalidParameterException, MissingParameterException,
            OperationFailedException, PermissionDeniedException {
        // TODO sambit - THIS METHOD NEEDS JAVADOCS
        return null;
