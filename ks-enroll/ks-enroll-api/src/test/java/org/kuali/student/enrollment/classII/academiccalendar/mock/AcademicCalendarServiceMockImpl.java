...
public class AcademicCalendarServiceMockImpl implements AcademicCalendarService {
	...
	/**
	 * 
	 * Simplified  mock impl of getAcademicCalendarsByKeyList(). 
	 * For the real impl: 
	 * get ATP for each key academicCalendarKey in the key list by invoking 
	...
	/**
	 * Simplified  mock impl of getAcademicCalendarKeysByType(). 
	 * For the real impl: 
	 * 1. get ATPs by type by calling AtpService.getAtpsByAtpType()
	 * 2. Filter  the AcademicCalendar ATPs
	 * 3. Get id of each Atp and invoke getAcademicCalendar() method
	 * 
	 * */
	...
	/**
	 * Simplified  mock impl of getAcademicCalendarsByYear(). 
	 * For the real impl: 
	 * 1. get ATPs by date  by calling AtpService.getAtpsByDate() 
	 * 2. Filter  the AcademicCalendar ATPs
	 * 3. Get id of each Atp and invoke getAcademicCalendar() method to get the ACInfo by id
	 * 
	 * */
	 ...
	 * For the real impl: 
	 * 1. get ATPs of AC type
	 * 2. Get the ACInfo object by getting id of each ATP and calling getAcademicCalendar()
	 * 3. Filter the ACs of the particular credentialProgramTypeKey  
	...
	/**
	 * Simplified Impl of createAcademicCalendar()
	 * For real Impl :
	 * Basic i/p validations:
	 * 1. validate the campus calendar exists in the DB or else throw validation exception
	 * 2.  validate the credential program exists
	 * 
	 * Impl: 
	 * 1. Transform and create ATPInfo out of the ACInfo
	...
	/**
	 * A simplified Impl of updateAcademicCalendar()
	 * For real Impl :
	 * Basic i/p validations:
	 * 1. validate the campus calendar exists in the DB or else throw validation exception
	 * 2. validate the credential program exists
	 ...
	 * Then for impl:
	 * 1. Transform and create ATPInfo out of the ACInfo
	 * 2. Go through the AtpService.updateAtp() to update an Atp for the AcademicCalendar
	 * 
	 */
	@Override
	 ...
	 * For real impl: 
	 * 1. Get the Atp by using the acKey and calling getAcademicCalendar()
	 * 2. Delete the Atp first by invoking AtpService.deleteAtp()
	 * 3. Delete any AtpAtpRelation for CampusCalendar, terms, CredentialProgram etc in the AcademicCalendar 
	 */
	@Override
	 ...
	 * A simplified mock impl
	 * For real impl: 
	 * 1. Convert to Atp and Copy ATp
	 * 2. Also modify any relations
	 * 3. Delete any AtpAtpRelation for CampusCalendar, terms, CredentialProgram etc in the AcademicCalendar 
	 */@Override
