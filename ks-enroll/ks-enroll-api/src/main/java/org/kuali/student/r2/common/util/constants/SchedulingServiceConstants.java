...
public class SchedulingServiceConstants {
    ...
    public static final String SCHEDULE_REQUEST_REQUESTED_STATE = "kuali.scheduling.schedule.request.state.requested";
    public static final String SCHEDULE_REQUEST_WITHDRAWN_STATE = "kuali.scheduling.schedule.request.state.withdrawn";
    public static final String SCHEDULE_REQUEST_PROCESSED_STATE = "kuali.scheduling.schedule.request.state.processed";
