 ...
 * @See <a
 *      href="https://test.kuali.org/confluence/display/KULSTU/Proposal+Service"
 *      >ProposalService</>
 * 
 */
...
public interface ProposalService extends DictionaryService, SearchService {
	 ...
	 */
	public List<ValidationResultInfo> validateProposal(
	 ...
	 *             unable to complete request
	 */
	public List<ProposalInfo> getProposalsByIdList(
			@WebParam(name = "proposalIdList") List<String> proposalIdList)
			throws DoesNotExistException, InvalidParameterException,
			MissingParameterException, OperationFailedException;
	 ...
	 *             unable to complete request
	 */
	public List<ProposalInfo> getProposalsByProposalType(
	 ...
	 * Reference Id
	 * 
	 * @param referenceTypeKey
	 *            Key of the Reference Type
	 * @param referenceId
	 ...
	 *             unable to complete request
	 */
	public List<ProposalInfo> getProposalsByReference(
	 ...
	 *             unable to complete request
	 */
	public List<ProposalInfo> getProposalsByState(
			@WebParam(name = "proposalState") String proposalState,
			@WebParam(name = "proposalTypeKey") String proposalTypeKey)
			throws DoesNotExistException, InvalidParameterException,
			MissingParameterException, OperationFailedException;
	 ...
	 *             unable to complete request
	 */
	public ProposalInfo getProposalByWorkflowId(
	 ...
	 * 
	 * @param proposalTypeKey
	 *            identifier of the Proposal Type for the Proposal being created
	 * @param proposalInfo
	 ...
	 */
	public ProposalInfo createProposal(
			@WebParam(name = "proposalTypeKey") String proposalTypeKey,
			@WebParam(name = "proposalInfo") ProposalInfo proposalInfo)
	 ...
	 * 
	 * @param proposalId
	 *            identifier for the Proposal to be updated
	 * @param proposalInfo
	 ...
	 */
	public ProposalInfo updateProposal(
			@WebParam(name = "proposalId") String proposalId,
			@WebParam(name = "proposalInfo") ProposalInfo proposalInfo)
	 ...
	 *             authorization failure
	 */
	public StatusInfo deleteProposal(
			@WebParam(name = "proposalId") String proposalId)
			throws DoesNotExistException, InvalidParameterException,
