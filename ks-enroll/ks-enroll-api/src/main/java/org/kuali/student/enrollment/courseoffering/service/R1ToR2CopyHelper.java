...
public class R1ToR2CopyHelper {
    ...
    public List<GradeValuesGroupInfo> copyResultValuesGroupList(List<org.kuali.student.lum.lrc.dto.ResultComponentInfo> r1List) {
        if (r1List == null) {
            return null;
        }
        List<GradeValuesGroupInfo> r2List = new ArrayList<GradeValuesGroupInfo>(r1List.size());
    ...
    public GradeValuesGroupInfo copyResultValuesGroup(org.kuali.student.lum.lrc.dto.ResultComponentInfo r1) {
        if (r1 == null) {
            return null;
        }
        GradeValuesGroupInfo r2 = new GradeValuesGroupInfo();
        r2.setAttributes(copyAttributes(r1.getAttributes()));
