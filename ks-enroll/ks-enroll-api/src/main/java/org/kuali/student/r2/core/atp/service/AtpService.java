 ...
 * supports the management of Academic Time Periods and their associated
 * Milestones. The intent is to provide a flexible but structured way to define
 * the various time frames that are used throughout the definition, offering and
 * scheduling of Learning Units. This is a catalogue service with basic
 * operations. Version: 1.0 (Dev)
 * 
 * @Author tom
...
public interface AtpService extends DataDictionaryService, TypeService, StateService {
    ...
    /**
     * Retrieves a list of Academic Time Periods where the supplied date falls
     * within the start and end date of the ATP inclusive of the date.
     * 
     * @param date a date
     * @param contextInfo information containing the principalId and locale
     *            information about the caller of service operation
     ...
     */
    public List<AtpInfo> getAtpsByDate(@WebParam(name = "date") Date date, @WebParam(name = "contextInfo") ContextInfo contextInfo) throws InvalidParameterException, MissingParameterException,
            OperationFailedException, PermissionDeniedException;

    /**
     * Retrieves a list of Academic Time Periods where the supplied date falls
     * within the start and end date of the ATP, inclusive of the date, and
     * whose type matches the specified ATP type.
     * 
     * @param date a date
     * @param atpTypeKey an identifier for an ATP Type
     * @param contextInfo information containing the principalId and locale
     *            information about the caller of service operation
     * @return a list of Academic Time Periods of the ATP Type that contain the
     *         supplied date
     * @throws InvalidParameterException contextInfo is not valid
     * @throws MissingParameterException date, atpTypeKey, or contextInfo is
     *             missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<AtpInfo> getAtpsByDateAndType(@WebParam(name = "date") Date date, @WebParam(name = "atpTypeKey") String atpTypeKey, @WebParam(name = "contextInfo") ContextInfo contextInfo)
            throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException;

    /**
     * Retrieves a list of Academic Time Periods that are totally contained
     * within the supplied dates. The entire ATP falls within the supplied dates
     * inclusive of the dates.
     * 
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<AtpInfo> getAtpsByDates(@WebParam(name = "startDate") Date startDate, @WebParam(name = "endDate") Date endDate, @WebParam(name = "contextInfo") ContextInfo contextInfo)
            throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException;

    /**
     * Retrieves the list of Academic Time Periods that are totally contained
     * within the supplied dates and whose type matches the supplied ATP type.
     * The entire ATP falls within the supplied dates inclusive of the dates.
     * 
     * @param startDate start date of range
     * @param endDate end date of range
     * @param atpTypeKey an identifier for an ATP Type
     * @param contextInfo information containing the principalId and locale
     *            information about the caller of service operation
     * @return a list of Academic Time Periods of the supplied ATP Type within
     *         the supplied dates
     * @throws InvalidParameterException contextInfo is not valid or startDate
     *             is greater than endDate
     * @throws MissingParameterException startDate, endDate, atpTypeKey, or
     *             conetxtInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<AtpInfo> getAtpsByDatesAndType(@WebParam(name = "startDate") Date startDate, @WebParam(name = "endDate") Date endDate, @WebParam(name = "atpTypeKey") String atpTypeKey,
    ...
    /**
     * Retrieves a list of Academic Time Periods whose start dates fall within
     * the supplied date range, inclusive of the start and end dates on the
     * supplied range.
     * 
     ...
     * @param contextInfo information containing the principalId and locale
     *            information about the caller of service operation
     * @return a list of Academic Time Periods with start dates within the
     *         supplied dates
     * @throws InvalidParameterException contextInfo is not valid or startDate
     *             is greater than endDate
     * @throws MissingParameterException datRangeStart, dateRangeEnd, or
     *             contextInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<AtpInfo> getAtpsByStartDateRange(@WebParam(name = "dateRangeStart") Date dateRangeStart, @WebParam(name = "dateRangeEnd") Date dateRangeEnd,
            @WebParam(name = "contextInfo") ContextInfo contextInfo) throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException;

    /**
     * Retrieves the list of Academic Time Periods whose start dates fall within
     * the supplied date range, inclusive of the start and end dates on the
     * range and whose type matches the specified ATP Type.
     * 
     * @param dateRangeStart start date of range
     * @param dateRangeEnd end date of range
     * @param atpTypeKey an identifier for an ATP Type
     ...
     *            information about the caller of service operation
     * @return a list of Academic Time Periods with start dates within the
     *         supplied dates and of the given ATP Type
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<AtpInfo> getAtpsByStartDateRangeAndType(@WebParam(name = "dateRangeStart") Date dateRangeStart, @WebParam(name = "dateRangeEnd") Date dateRangeEnd,
            @WebParam(name = "atpTypeKey") String atpTypeKey, @WebParam(name = "contextInfo") ContextInfo contextInfo) throws InvalidParameterException, MissingParameterException,
            OperationFailedException, PermissionDeniedException;
    ...
    /**
     * Searches for Academic Time Periods that meet the given search criteria.
     * 
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<AtpInfo> searchForAtps(@WebParam(name = "criteria") QueryByCriteria criteria, @WebParam(name = "contextInfo") ContextInfo contextInfo) throws InvalidParameterException,
            MissingParameterException, OperationFailedException, PermissionDeniedException;
     ...
     * perform all tests related to this ATP. If an identifier is present for
     * the ATP (and/or one of its contained sub-objects) and a record is found
     * for that identifier, the validation checks if the ATP can be shifted to
     * the new values. If a an identifier is not present or a record does not
     * exist, the validation checks if the ATP with the given data can be
     * created.
     * 
     ...
     *         succeeded
     * @throws DoesNotExistException validationTypeKey or atpTypeKey is not
     *             found
     * @throws InvalidParameterException atpInfo or contextInfo is not valid
     * @throws MissingParameterException validationTypeKey, atpTypeKey atpInfo,
     ...
     * 
     * @param atpAtpRelationId the identifier for the AtpAtpRelation to be
     *            retrieved
     * @param contextInfo information containing the principalId and locale
     *            information about the caller of service operation
     ...
     * @throws InvalidParameterException contextInfo is not valid
     * @throws MissingParameterException atpAtpRelationId or contextInfo is
     *             missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public AtpAtpRelationInfo getAtpAtpRelation(@WebParam(name = "atpAtpRelationId") String atpAtpRelationId, @WebParam(name = "contextInfo") ContextInfo contextInfo) throws DoesNotExistException,
            InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException;

    /**
     * Retrieves a list of AtpAtpRelations from a list of AtpAtpRelation Ids.
     ...
     * @throws InvalidParameterException contextInfo is not valid
     * @throws MissingParameterException atpAtpRelationids, an atpAtpRelationId
     *             in the atpAtpRelationIds, or contextInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException an authorization failure occurred
     */
     ...
     * @throws InvalidParameterException contextInfo is not valid
     * @throws MissingParameterException atpRelationTypeKey or contextInfo is
     *             missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<String> getAtpAtpRelationIdsByType(@WebParam(name = "atpAtpRelationTypeKey") String atpAtpRelationTypeKey, @WebParam(name = "contextInfo") ContextInfo contextInfo)
            throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException;
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<String> searchForAtpAtpRelationIds(@WebParam(name = "criteria") QueryByCriteria criteria, @WebParam(name = "contextInfo") ContextInfo contextInfo) throws InvalidParameterException,
            MissingParameterException, OperationFailedException, PermissionDeniedException;
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<AtpAtpRelationInfo> searchForAtpAtpRelations(@WebParam(name = "criteria") QueryByCriteria criteria, @WebParam(name = "contextInfo") ContextInfo contextInfo)
            throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException;
    ...
    /**
     * Validates an AtpAtpRelation. Depending on the value of validationType,
     * this validation could be limited to tests on just the current
     * AtpAtpRelation and its directly contained sub-objects or expanded to
     * perform all tests related to this AtpAtpRelation. If an identifier is
     * present for the AtpAtpRelation (and/or one of its contained sub-objects)
     * and a record is found for that identifier, the validation checks if the
     * AtpAtpRelation can be shifted to the new values. If an identifier is not
     * present or a record cannot be found for the identifier, the validation
     ...
     * @throws InvalidParameterException atpAtpRelationInfo or contextInfo is
     *             not valid
     * @throws MissingParameterException atpAtpRelationId, atpAtpRelationInfo,
     *             or contextInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException an authorization failure occurred
     * @throws ReadOnlyException an attempt at supplying information designated
     ...
     */
    public AtpAtpRelationInfo updateAtpAtpRelation(@WebParam(name = "atpAtpRelationId") String atpAtpRelationId, @WebParam(name = "atpAtpRelationInfo") AtpAtpRelationInfo atpAtpRelationInfo,
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public StatusInfo deleteAtpAtpRelation(@WebParam(name = "atpAtpRelationId") String atpAtpRelationId, @WebParam(name = "contextInfo") ContextInfo contextInfo) throws DoesNotExistException,
            InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException;
     ...
     * @throws InvalidParameterException contextInfo is not valid
     * @throws MissingParameterException milestoneId or contextInfo is missing
     *             or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public MilestoneInfo getMilestone(@WebParam(name = "milestoneId") String milestoneId, @WebParam(name = "contextInfo") ContextInfo contextInfo) throws DoesNotExistException,
            InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException;

    /**
     * Retrieves a list of Milestones from a list of Milestone Ids. The returned
    ...
    /**
     * Retrieves a list of Milestones that fall within a specified set of dates
     * inclusive of the dates.
     * 
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<MilestoneInfo> getMilestonesByDates(@WebParam(name = "startDate") Date startDate, @WebParam(name = "endDate") Date endDate, @WebParam(name = "contextInfo") ContextInfo contextInfo)
            throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException;
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<MilestoneInfo> searchForMilestones(@WebParam(name = "criteria") QueryByCriteria criteria, @WebParam(name = "contextInfo") ContextInfo contextInfo) throws InvalidParameterException,
            MissingParameterException, OperationFailedException, PermissionDeniedException;
    ...
    /**
     * Validates a Milestone. Depending on the value of validationType, this
     * validation could be limited to tests on just the current Milestone and
     * its directly contained sub-objects or expanded to perform all tests
     * related to this object. If an identifier is present for the Milestone
     * (and/or one of its contained sub-obejcts) and a record is found for that
     * identifier, the validation checks if the Milestone can be shifted to the
     ...
     * @return a list of validation results or an empty list if validation
     *         succeeded
     * @throws DoesNotExistException validationTypeKey or milestoneTypeKey is
     *             not found
     * @throws InvalidParameterException milestoneInfo or contextInfo is not
     *             valid
     * @throws MissingParameterException validationTypeKey, milestoneTypeKey,
     *             milestoneInfo, or contextInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<ValidationResultInfo> validateMilestone(@WebParam(name = "validationTypeKey") String validationTypeKey, @WebParam(name = "milestoneInfo") MilestoneInfo milestoneInfo,
            @WebParam(name = "contextInfo") ContextInfo contextInfo) throws DoesNotExistException, InvalidParameterException, MissingParameterException, OperationFailedException,
            PermissionDeniedException;

    /**
     * Create a new Milestone. The Milestone Id, Type, and Meta information may
     * not be set in the supplied data object.
     * 
     ...
     * @throws InvalidParameterException milestoneInfo or contextInfo is not
     *             valid
     * @throws MissingParameterException milestoneTypeKey, milestoneInfo, or
     *             contextInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException an authorization failure occurred
     * @throws ReadOnlyException an attempt at supplying information designated
     ...
     * @throws InvalidParameterException milestoneInfo or contextInfo is not
     *             valid
     * @throws MissingParameterException milestoneId, milestoneInfo, or
     *             contextInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException an authorization failure occurred
     * @throws ReadOnlyException an attempt at supplying information designated
     ...
     *             action was attempted on an out of date version
     */
    public MilestoneInfo updateMilestone(@WebParam(name = "milestoneId") String milestoneId, @WebParam(name = "milestoneInfo") MilestoneInfo milestoneInfo,
            @WebParam(name = "contextInfo") ContextInfo contextInfo) throws DataValidationErrorException, DoesNotExistException, InvalidParameterException, MissingParameterException,
            OperationFailedException, PermissionDeniedException, ReadOnlyException, VersionMismatchException;
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public StatusInfo deleteMilestone(@WebParam(name = "milestoneId") String milestoneId, @WebParam(name = "contextInfo") ContextInfo contextInfo) throws DoesNotExistException,
            InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException;
