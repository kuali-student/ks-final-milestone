 ...
 * {@link LuiPersonRelationTransactionItem}, in a single overall transaction.
 * 
 * @author Kuali Student Team (sambit)
 */
public interface LuiPersonRelationTransaction extends IdEntity {
    /**
     ...
     * @return
     */
    List<? extends LuiPersonRelationTransactionItem> getLprTransactionItems();
