...
public interface CourseOffering extends IdEntity {
    ...
    /**
     * The system assigned unique id to identify this Course Offering. Could be
     ...
     * <ul>
     * <li>An id is used when the actual value is unimportant and can therefore
     ...
     * <li>Ids are assumed to be of different values in different KS
     * implementations
     * <li>Id values are generated by the service implementations
     * <li>Id values are never expected to be used in Configuration or
     * Application code
     * </ul>
     * 
     * @name Unique Id
    ...
    /**
     * Unique identifier for the state of this course offering. i.e. draft,
     * submitted, approved, offered, canceled, etc
     * 
     * @name State Key
     * @required
     * @impl maps to the states that are defined in the
     *       kuali.course.offering.process with an initial state of draft
     */
    ...
    /**
     * A description of this Course Offering. This starts out the same as the
     ...
     * 
     * @name Description
     * @impl initially this is copied from the canonical course description and
     *       then updated and stored in the Lui description.
     */
    @Override
    ...
    /**
     * A unique identifier assigned to all approved courses that exist in the
     * catalog This is not updatable once initialized.
     * 
     * @name Course Id
     * @readOnly on updates
     * @required
     * @impl this maps the the version dependent id as the offering must point
     *       to one and only one version of the course. Maps to cluId in Lui.
     */
