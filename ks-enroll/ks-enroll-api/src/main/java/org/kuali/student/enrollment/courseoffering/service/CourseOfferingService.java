...
public interface CourseOfferingService extends DataDictionaryService {
     ...
     *            List of unique Ids of CourseOffering
     * @param context
     *            Context information containing the principalId and locale
     *            information about the caller of service operation
     * @return Course offering list
     * @throws DoesNotExistException
     *             courseOfferingId in the list not found
     * @throws InvalidParameterException
     *             invalid courseOfferingIds
     * @throws MissingParameterException
     *             missing courseOfferingIds
     * @throws OperationFailedException
     *             unable to complete request
     * @throws PermissionDeniedException
     *             authorization failure
     ...
     * 
     * @param courseId
     *            Unique Id of the Course (canonical)
     * @param termKey
     ...
     * @throws DoesNotExistException
     *             courseId or termKey not found
     * @throws InvalidParameterException
     *             invalid courseId or termKey
     * @throws MissingParameterException
     *             missing courseId or termKey
     * @throws OperationFailedException
     *             unable to complete request
     * @throws PermissionDeniedException
     *             authorization failure
     ...
     * @param termKey
     *            Unique key of the term in which the course is being offered
     * @param useIncludedTerm
     *            Indicates if the offerings from included term are also to be
     *            returned
     * @param context
     *            Context information containing the principalId and locale
     *            information about the caller of service operation
     ...
     * 
     * @param courseId
     *            Canonical course IdList of courseOffering Ids that the
     *            ActivityOffering will belong to
     * @param termKey
     *            Unique key of the term in which the course is being offered
     * @param formatIdList
     *            Canonical formats from the canonical course to be used for the
     *            course offering
     * @param context
     *            Context information containing the principalId and locale
     *            information about the caller of service operation
     ...
     *             the CourseOffering being created already exists
     * @throws DoesNotExistException
     *             courseId not found
     ...
     * 
     * @param courseOfferingId
     *            Id of CourseOffering to be updated
     * @param courseOfferingInfo
     *            Details of updates to the CourseOffering
     * @param context
     *            Context information containing the principalId and locale
     *            information about the caller of service operation
     ...
     * 
     * @param courseOfferingId
     *            the Id of the ActivityOffering to be deleted
     * @param context
     *            Context information containing the principalId and locale
     *            information about the caller of service operation
     ...
     * @param courseOfferingInfo
     *            the course offering information to be tested.
     * @param context
     *            Context information containing the principalId and locale
     *            information about the caller of service operation
     ...
     * @throws InvalidParameterException
     *             invalid courseOfferingId, statementTreeViewInfoList
     * @throws MissingParameterException
     *             invalid courseOfferingId, statementTreeViewInfoList
     * @throws OperationFailedException
     *             unable to complete request
     ...
     *            Identifier of the extent of validation
     * @param restrictionInfo
     *            the course offering restriction information to be tested.
     * @param context
     *            Context information containing the principalId and locale
     *            information about the caller of service operation
     * @return the results from performing the validation
    ...
    /**
     * This method returns the valid activity offerring types for a given
     * canonical activity type
     * 
     * @param activityTypeKey
     *            Key of the canonical activity type
     * @param context
     *            Context information containing the principalId and locale
     *            information about the caller of service operation
     * @return a list of valid activity offering Types
     ...
     *            Unique Id of the ActivityOffering
     * @param context
     *            Context information containing the principalId and locale
     *            information about the caller of service operation
     ...
     *            List of unique Ids of ActivityCourseOffering
     * @param context
     *            Context information containing the principalId and locale
     *            information about the caller of service operation
     * @return Activity offering list
     * @throws DoesNotExistException
     *             activityOfferingId in the list not found
     * @throws InvalidParameterException
     ...
     * 
     * @param courseOfferingIdList
     *            List of courseOffering Ids that the ActivityOffering will
     *            belong to
     * @param activityOfferingInfo
     *            Details of the ActivityOffering to be created
     * @param context
     *            Context information containing the principalId and locale
     *            information about the caller of service operation
     * @return newly created ActivityOffering
     * @throws AlreadyExistsException
     *             the ActivityOffering being created already exists
     * @throws DataValidationErrorException
     *             One or more values invalid for this operation
     * @throws InvalidParameterException
     *             One or more parameters invalid
     ...
     * 
     * @param activityOfferingId
     *            Id of the ActivityOffering to be assigned to course offerings
     * @param courseOfferingIdList
     *            List of courseOffering Ids that the ActivityOffering will
     *            belong to
     * @param context
     ...
     *             the ActivityOffering being created already exists
     * @throws DoesNotExistException
     *             activityOfferingId or courseOfferingId not found
     * @throws InvalidParameterException
     *             One or more parameters invalid
     * @throws MissingParameterException
     *             One or more parameters missing
     ...
     * 
     * @param activityOfferingId
     *            Id of ActivitOffering to be updated
     * @param activityOfferingInfo
     *            Details of updates to the ActivityOffering
     * @param context
     *            Context information containing the principalId and locale
     *            information about the caller of service operation
     ...
     *            Identifier of the extent of validation
     * @param activityOfferingInfo
     *            the activity offering information to be tested.
     * @param context
     *            Context information containing the principalId and locale
     *            information about the caller of service operation
     * @return the results from performing the validation
