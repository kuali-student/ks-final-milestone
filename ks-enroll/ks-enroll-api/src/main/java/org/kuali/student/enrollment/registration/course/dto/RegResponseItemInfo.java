...
public class RegResponseItemInfo extends HasAttributesAndMetaInfo implements
		RegResponseItem, Serializable {
	...
	public RegResponseItemInfo(RegResponseItem regResponseItem) {
		...
		if (null != regResponseItem) {
			this.courseRegistrationId = regResponseItem
					.getCourseRegistrationId();
			this.courseWaitlistEntryId = regResponseItem
