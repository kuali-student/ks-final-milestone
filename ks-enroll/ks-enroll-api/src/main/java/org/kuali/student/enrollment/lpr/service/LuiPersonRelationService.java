...
public interface LuiPersonRelationService extends DataDictionaryService, TypeService, StateService {
     ...
     *             authorization failure
     */
    public List<LuiPersonRelationInfo> getLprsByIdList(
     ...
     *             authorization failure
     */
    public List<String> getLuiIdsByPerson(@WebParam(name = "personId") String personId,
     ...
     *             authorization failure
     */
    public List<String> getPersonIdsByLui(@WebParam(name = "luiId") String luiId,
            @WebParam(name = "luiPersonRelationTypeKey") String luiPersonRelationTypeKey,
            @WebParam(name = "relationState") String relationState, @WebParam(name = "context") ContextInfo context)
     ...
     *             authorization failure
     */
    public List<LuiPersonRelationInfo> getLprsByLuiAndPerson(@WebParam(name = "personId") String personId,
     ...
     *             authorization failure
     */
    public List<String> getLprIdsByLuiAndPerson(@WebParam(name = "personId") String personId,
            @WebParam(name = "luiId") String luiId, @WebParam(name = "context") ContextInfo context)
            throws DoesNotExistException, DisabledIdentifierException, InvalidParameterException,
            MissingParameterException, OperationFailedException, PermissionDeniedException;
    ...
    public List<LuiPersonRelationInfo> getLprsByPersonAndTypeForAtp(@WebParam(name = "personId") String personId,
            @WebParam(name = "atpKey") String atpKey, @WebParam(name = "typeKey") String typeKey,
            @WebParam(name = "context") ContextInfo context) throws DoesNotExistException, InvalidParameterException,
            MissingParameterException, OperationFailedException, PermissionDeniedException;
    ...
    public List<LuiPersonRelationInfo> getLprsByPersonForAtpAndLuiType(@WebParam(name = "personId") String personId,
            @WebParam(name = "atpKey") String atpKey, @WebParam(name = "luiTypeKey") String luiTypeKey,
            @WebParam(name = "context") ContextInfo context) throws DoesNotExistException, InvalidParameterException,
            MissingParameterException, OperationFailedException, PermissionDeniedException;
     ...
     * @throws PermissionDeniedException
     */
    public List<LuiPersonRelationInfo> getLprsByPersonForAtpAndPersonType(@WebParam(name = "personId") String personId,
            @WebParam(name = "atpKey") String atpKey, @WebParam(name = "personTypeKey") String personTypeKey,
            @WebParam(name = "context") ContextInfo context) throws DoesNotExistException, InvalidParameterException,
            MissingParameterException, OperationFailedException, PermissionDeniedException;
     ...
     *             authorization failure
     */
    public String createLpr(@WebParam(name = "personId") String personId, @WebParam(name = "luiId") String luiId,
            @WebParam(name = "luiPersonRelationTypeKey") String luiPersonRelationTypeKey,
            @WebParam(name = "luiPersonRelationInfo") LuiPersonRelationInfo luiPersonRelationInfo,
