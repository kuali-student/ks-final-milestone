 ...
 *
 * @Author nina
 * @Since Mon Jul 12 14:12:33 EDT 2011
 *
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ExpenditureInfo", propOrder = {"id", "affiliatedOrgs",
       "attributes", "meta", "_futureElements"})
public class ExpenditureInfo extends HasAttributesAndMetaInfo implements CourseExpenditure, Serializable {
    ...
    public ExpenditureInfo(CourseExpenditure exp) {
        super(exp);
