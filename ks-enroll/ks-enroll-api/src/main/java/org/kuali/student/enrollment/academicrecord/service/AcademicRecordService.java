...
public interface AcademicRecordService {
     ...
     *
     * @param personId    an Id of a student
     * @param programId    Unique Id of the Course (canonical)
     * @param contextInfo Context information containing the principalId and
     *                    locale information about the caller of service
     *                    operation
     * @return a list of StudentCourseRecords for the specified course or empty
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<StudentCourseRecordInfo> getCompletedCourseRecordsForProgram(@WebParam(name = "personId") String personId,
    ...
    /**
     * This method returns the  GPA of a student for the current level TODO:
     * Grad GPA vs. Undergrad GPA Is this same as getGPAByProgram ?
     *
     * @param personId           an Id of a student
     * @param calculationTypeKey Unique key identifying the calculation. For
     *                           example, it may point to a description of rules
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public GPAInfo getGPAForLevel(@WebParam(name = "personId") String personId,
                                  @WebParam(name = "calculationTypeKey") String calculationTypeKey,
                                  @WebParam(name = "contextInfo") ContextInfo contextInfo)
            throws DoesNotExistException,
            InvalidParameterException,
    ...
    /**
     * This method returns the GPA of a student for the period of time indicated
     * by the given Academic Calendar.
     *
     * @param personId            an Id of a student
     ...
     *                            service operation
     * @return a GPA
     * @throws DoesNotExistException     personId or academicCalendarKey not
     *                                   found
     * @throws InvalidParameterException invalid contextInfo
     * @throws MissingParameterException personId, academicCalendarKey,
     *                                   calculationTypeKey or contextInfo is
     *                                   missing or null
     * @throws OperationFailedException  unable to complete request
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public GPAInfo getGPAForAcademicCalendar(@WebParam(name = "personId") String personId,
    ...
    /**
     * This method returns the summary of student programs currently enrolled
     * and not completed
     *
     * @param personId    an Id of a student
     * @param contextInfo Context information containing the principalId and
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<StudentProgramRecordInfo> getAllPrograms(@WebParam(name = "personId") String personId,
                                                         @WebParam(name = "contextInfo") ContextInfo contextInfo)
            throws DoesNotExistException,
            InvalidParameterException,
            MissingParameterException,
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<StudentTestScoreRecordInfo> getTestScore(@WebParam(name = "personId") String personId,
                                                         @WebParam(name = "contextInfo") ContextInfo contextInfo)
            throws DoesNotExistException,
            InvalidParameterException,
            MissingParameterException,
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<StudentTestScoreRecordInfo> getTestScoreByType(@WebParam(name = "personId") String personId,
    ...
    /**
     * This method returns the number of credits a student earned by courss
