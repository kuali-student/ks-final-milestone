...
public class PlanItemDao extends GenericEntityDao<PlanItemEntity> {
     ...
     */
    @SuppressWarnings("unchecked")
	public List<PlanItemEntity> getLearningPlanItemsByType(String learningPlanId, String learningPlanItemType) {
     ...
     */
    @SuppressWarnings("unchecked")
	public List<PlanItemEntity> getLearningPlanItemsByRefObjectIdByRefType(String learningPlanId, String refObjectId,
     ...
     */
    @SuppressWarnings("unchecked")
    public List<PlanItemEntity> getLearningPlanItemsByCategory(String learningPlanId, AcademicPlanServiceConstants
