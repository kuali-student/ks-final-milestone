...
public class AcademicContentLayoutManager {
    ...
    public DefaultCreateUpdateLayout<CluInfo> addSection(String type, String state) {
        layout.addSection(new String[] {"Academic Content", "Course Information"}, 
                new SimpleConfigurableSection<CluInfo>()
        );

        layout.addSection(new String[] {"Academic Content", "Learning Objectives"}, 
                new SimpleConfigurableSection<CluInfo>()
        );

        layout.addSection(new String[] {"Academic Content", "Syllabus"}, 
                new SimpleConfigurableSection<CluInfo>()
        );

        layout.addSection(new String[] {"Academic Content", "Learning Results"}, 
                new SimpleConfigurableSection<CluInfo>()
        );
