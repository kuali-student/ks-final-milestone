...
public class LumModelObject implements ILumModelObject {
   ...
   // private List<CluInfo> cluList = new ArrayList<CluInfo>();
    private String cluList; // = new ArrayList<String>();
    ...
    public boolean isShowSearchDialog() {
        System.out.println("lum object: GET flag:" + showSearchDialog);
        return showSearchDialog;
    }
    public void setShowSearchDialog(boolean showSearchDialog) {
        this.showSearchDialog = showSearchDialog;
        System.out.println("lum object: AFTER set flag:" + showSearchDialog);
    }    
    public String getCluList() {
        return cluList;
    }
    public void setCluList(String cluList) {
