...
public interface RequirementsServiceAsync {
    ...
    public void getNaturalLanguageForLuStatementInfo(String cluId, LuStatementInfo luStatementInfo, String nlUsageTypeKey, AsyncCallback<String> asyncCallback);
