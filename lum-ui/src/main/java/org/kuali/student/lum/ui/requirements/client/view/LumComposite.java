...
//  Button btnAddCourses;  
    ...
    private void prepareRationaleToComplexViewPanel(Panel parent) {
        ...
        topPanel.add(new Label("Rationale")); //messages.get("lum.rationale")));
        SimplePanel tempPanel = new SimplePanel();
        tempPanel.setWidth("350px");
...
//        btnAddCourses = new Button(messages.get("lum.addPreReqCourses"));
        parent.add(new Label("Prereq Course")); //messages.get("lum.prereqCourses")));
    ...
    private void prepareNaturalLanguagePanel(Panel parent) {
        ...
        parent.add(new Label("Natural Language")); //messages.get("lum.naturalLanguage")));
