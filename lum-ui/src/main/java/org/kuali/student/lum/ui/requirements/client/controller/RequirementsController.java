...
import org.kuali.student.lum.ui.requirements.client.model.RequirementComponentVO;
import org.kuali.student.lum.ui.requirements.client.model.StatementVO;
import org.kuali.student.lum.ui.requirements.client.view.LumComposite;
import org.kuali.student.lum.ui.requirements.client.view.LumRequirementDialog;
import org.kuali.student.lum.ui.requirements.client.view.LumSearchDialog;
import org.kuali.student.lum.ui.requirements.client.view.LumUIEventListener;
 ...
 * @author zzraly
 */
public class RequirementsController extends Controller implements LumUIEventListener {

    public static final String SCREEN_SIZE_WIDTH = "950px";
    public static final String SCREEN_SIZE_HEIGHT = "550px";
    public static final String VIEW_NAME = "org.kuali.student.lum.ui.requirements";
    ...
    final LumSearchDialog<LumModelObject> lumSearchDialog = new LumSearchDialog<LumModelObject>();
    ModelBinding<LumModelObject> lumSearchDialogBinding; 
    ...
    private void loadModelsData() {    	
        ...
        lumSearchDialogBinding = new ModelBinding<LumModelObject>(model, lumSearchDialog);
    ...
    private void doLayout() {
        VerticalPanel topBottomScreen = new VerticalPanel();
        SimplePanel navigationBar = new SimplePanel();
        navigationBar.add(new KSImage("images/navigationBar.jpg"));
        topBottomScreen.add(navigationBar);
        HorizontalPanel menuPageScreen = new HorizontalPanel();
        SimplePanel menu = new SimplePanel();
        menu.add(new KSImage("images/menu.jpg"));
        SimplePanel page = new SimplePanel();        
        page.add(lumComposite);
        menuPageScreen.add(menu);
        menuPageScreen.add(page);
        topBottomScreen.add(menuPageScreen);
        mainPanel.add(topBottomScreen);
    ...
    private void doEventListenerWiring() {
        ...
        lumSearchDialog.setUpListeners();
        lumSearchDialog.addLumUIEventListener(this);
    ...
    public void showSearchDialog() {
        // lumComposite.removeFromParent();
      //   mainPanel.add(lumRequirementDialog);
         lumModelObject.setShowSearchDialog(true);
         model.update(lumModelObject);             
     }    
    
    public void hideSearchDialog() {
        lumModelObject.setShowSearchDialog(false);
        model.update(lumModelObject);        
    }    
    
    public void updateExampleAndWorkArea() {
        System.out.println("In update example and work area...");
        model.update(lumModelObject); 
    }

    public void updateAlgebra(String algebra) {
        lumModelObject.setAlgebra(algebra);
        model.update(lumModelObject);
    }
    
    public void updateSelectedCourseList(String cluList)  {
        lumModelObject.setCluList(cluList);
        hideSearchDialog();        
    }      
}
