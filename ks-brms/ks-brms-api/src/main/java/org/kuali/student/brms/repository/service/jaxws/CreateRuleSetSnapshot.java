...
@XmlRootElement(name = "createRuleSetSnapshot", namespace = "http://student.kuali.org/wsdl/brms/RuleRepository")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "createRuleSetSnapshot", namespace = "http://student.kuali.org/wsdl/brms/RuleRepository", propOrder = {"ruleSetUUID","snapshotName","comment"})

public class CreateRuleSetSnapshot {
