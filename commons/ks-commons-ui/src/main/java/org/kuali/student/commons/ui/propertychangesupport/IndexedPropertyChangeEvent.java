...
public class IndexedPropertyChangeEvent extends PropertyChangeEvent {
     ...
     * @param oldValue
     *            the previous value of the property, or <code>null</code> if the <code>propertyName</code> is
     *            <code>null</code> or the previous value is unknown.
     * @param newValue
     *            the new value of the property, or <code>null</code> if the <code>propertyName</code> is
     *            <code>null</code> or the new value is unknown..
     * @param index
