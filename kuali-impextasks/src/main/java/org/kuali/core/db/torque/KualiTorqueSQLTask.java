...
public class KualiTorqueSQLTask extends TexenTask {
	...
	/**
	 * Map of data model name to database name. Should probably stick to the
	 * convention of them being the same but I know right now in a lot of cases
	 * they won't be.
	 */
	protected Hashtable dataModelDbMap;

	/**
	 * Hashtable containing the names of all the databases in our collection of
	 * schemas.
	 */
	...
	/**
	 * Name of the properties file that maps an SQL file to a particular
	 * database.
	 */
