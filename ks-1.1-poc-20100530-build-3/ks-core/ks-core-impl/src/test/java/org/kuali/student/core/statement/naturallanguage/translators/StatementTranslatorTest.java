...
//		executor.setRuleBaseCache(ruleBase);
	...
	public void testTranslateStatement1_English_EmptyCluId() throws Exception {
		...
		ReqComponent reqComp = NaturalLanguageUtil.createReqComponent("KUALI.CATALOG", "kuali.reqCompType.courseList.nof");
		reqComp.setId("req-1");
	...
	public void testTranslateStatement1_German() throws Exception {
		...
		String translation = germanTranslator.translate(stmt1, "KUALI.CATALOG");
	...
	public void testTranslateStatement1_EnglishGerman() throws Exception {
		...
		translation = englishTranslator.translate(stmt1, "KUALI.CATALOG");
		Assert.assertEquals("Student muss abgeschlossen 1 von MATH 152, MATH 180", translation);
	...
	public void testTranslateStatement1b() throws Exception {
		...
		ReqComponent reqComp = NaturalLanguageUtil.createReqComponent("KUALI.CATALOG", "kuali.reqCompType.courseList.1of2");
		reqComp.setId("req-1");
		reqComp.setReqComponentFields(fieldList);
		stmt1.setRequiredComponents(Arrays.asList(reqComp));
	...
	public void testTranslateStatement3() throws Exception {
		...
		ReqComponent reqComp1 = NaturalLanguageUtil.createReqComponent("KUALI.CATALOG", "kuali.reqCompType.courseList.nof");
		...
		ReqComponent reqComp2 = NaturalLanguageUtil.createReqComponent("KUALI.CATALOG", "kuali.reqCompType.courseList.nof");
	...
	public void testTranslateStatement5() throws Exception {
		...
		ReqComponent reqComp11 = NaturalLanguageUtil.createReqComponent("KUALI.CATALOG", "kuali.reqCompType.courseList.nof");
		reqComp11.setId("R1");
		...
		ReqComponent reqComp121 = NaturalLanguageUtil.createReqComponent("KUALI.CATALOG", "kuali.reqCompType.courseList.nof");
		reqComp121.setId("R2");
		...
		ReqComponent reqComp1221 = NaturalLanguageUtil.createReqComponent("KUALI.CATALOG", "kuali.reqCompType.courseList.nof");
		...
		ReqComponent reqComp1222 = NaturalLanguageUtil.createReqComponent("KUALI.CATALOG", "kuali.reqCompType.courseList.nof");
	...
	private Statement getComplexStatement() throws Exception {
		...
		ReqComponent reqComp3 = NaturalLanguageUtil.createReqComponent("KUALI.CATALOG", "kuali.reqCompType.courseList.nof");
		reqComp3.setId("Rq3");
		...
		ReqComponent reqComp4 = NaturalLanguageUtil.createReqComponent("KUALI.CATALOG", "kuali.reqCompType.courseList.nof");
		reqComp4.setId("Rq4");
		...
		ReqComponent reqComp5 = NaturalLanguageUtil.createReqComponent("KUALI.CATALOG", "kuali.reqCompType.courseList.nof");
		reqComp5.setId("Rq5");
		...
		ReqComponent reqComp6 = NaturalLanguageUtil.createReqComponent("KUALI.CATALOG", "kuali.reqCompType.courseList.nof");
		reqComp6.setId("Rq6");
		...
		ReqComponent reqComp7 = NaturalLanguageUtil.createReqComponent("KUALI.CATALOG", "kuali.reqCompType.courseList.nof");
		reqComp7.setId("Rq7");
		...
		ReqComponent reqComp8 = NaturalLanguageUtil.createReqComponent("KUALI.CATALOG", "kuali.reqCompType.courseList.nof");
		reqComp8.setId("Rq8");
		...
		ReqComponent reqComp9 = NaturalLanguageUtil.createReqComponent("KUALI.CATALOG", "kuali.reqCompType.courseList.nof");
		reqComp9.setId("Rq9");
