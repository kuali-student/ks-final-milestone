...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.SearchCriteriaTypeInfoHelper.Properties;


public class SearchCriteriaTypeInfoMetadata
{
	...
	public void loadChildMetadata (Metadata mainMeta, String type, String state,  RecursionCounter recursions)
	{
		...
		// metadata for queryParams
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.QUERY_PARAMS.getKey (), childMeta);
		...
		new QueryParamInfoMetadata ().loadChildMetadata (listMeta, type, state, recursions);
