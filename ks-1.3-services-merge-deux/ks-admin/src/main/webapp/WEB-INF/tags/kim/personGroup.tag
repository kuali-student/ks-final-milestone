          	...
          	<tr>
                ...
                <td align="left" valign="middle" class="infoline" >
                	<div align="center">
	                	...
	                	<kul:lookup boClassName="org.kuali.rice.kim.impl.group.GroupBo" fieldConversions="groupId:newGroup.groupId,kimTypeId:newGroup.groupType,groupName:newGroup.groupName,namespaceCode:newGroup.namespaceCode,kimTypeInfo.name:newGroup.kimGroupType.name" anchor="${tabKey}" />
