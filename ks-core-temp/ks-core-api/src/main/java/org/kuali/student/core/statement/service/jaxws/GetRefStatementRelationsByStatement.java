...
@XmlRootElement(name = "getRefStatementRelationsByStatement", namespace = "http://student.kuali.org/wsdl/statement")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getRefStatementRelationsByStatement", namespace = "http://student.kuali.org/wsdl/statement")

public class GetRefStatementRelationsByStatement {
