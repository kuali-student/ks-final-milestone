...
@XmlRootElement(name = "hasOrgPersonRelation", namespace = "http://student.kuali.org/wsdl/organization")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "hasOrgPersonRelation", namespace = "http://student.kuali.org/wsdl/organization", propOrder = {"orgId","personId","orgPersonRelationTypeKey"})
