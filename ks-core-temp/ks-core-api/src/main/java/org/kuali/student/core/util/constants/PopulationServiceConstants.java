...
// TODO kscm-123    public static final String REF_OBJECT_URI_POPULATION = NAMESPACE + "/" + PopulationInfo.class.getSimpleName();
// TODO kscm-123    public static final String REF_OBJECT_URI_POPULATION_RULE = NAMESPACE + "/" + PopulationRuleInfo.class.getSimpleName();
    public static final String REF_OBJECT_URI_POPULATION = NAMESPACE + "/" ;
    public static final String REF_OBJECT_URI_POPULATION_RULE = NAMESPACE + "/" ;
