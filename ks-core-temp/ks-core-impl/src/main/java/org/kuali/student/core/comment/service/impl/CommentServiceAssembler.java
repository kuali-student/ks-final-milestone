...
// TODO KSCM        dto.setAttributes(toAttributeMap(entity.getAttributes()));
    ...
    public static Comment toComment(boolean isUpdate,CommentInfo dto,CommentDao dao) throws InvalidParameterException, DoesNotExistException{
     ...
     // TODO KSCM        entity.setAttributes(toGenericAttributes(CommentAttribute.class,dto.getAttributes(),entity,dao));
    ...
    public static Tag toTag(boolean isUpdate,TagInfo dto, CommentDao dao) throws InvalidParameterException, DoesNotExistException{
     ...
     // TODO KSCM        entity.setAttributes(toGenericAttributes(TagAttribute.class,dto.getAttributes(),entity,dao));
    ...
    public static Comment toComment(Comment entity, String referenceId,
		...
		// TODO KSCM		entity.setAttributes(toGenericAttributes(CommentAttribute.class, dto
		// TODO KSCM				.getAttributes(), entity, commentDao));
