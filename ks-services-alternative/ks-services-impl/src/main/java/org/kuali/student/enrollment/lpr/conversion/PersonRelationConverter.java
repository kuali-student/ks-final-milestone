...
public class PersonRelationConverter implements Converter<LuiPersonRelation, LuiPersonRelationInfo> {
    ...
    private SimpleConverter<List<DynamicAttribute>, Map<String, String>> dynamicAttributeConverter;
    ...
    public void setDynamicAttributeConverter(SimpleConverter<List<DynamicAttribute>, Map<String, String>> dynamicAttributeConverter) {
