...
public class GoCancelGroup extends ButtonGroup<GoCancelEnum>{
    
    public GoCancelGroup(Callback<GoCancelEnum> callback){
        layout = new ButtonRow();
        this.addCallback(callback);
        
        addButton(GoCancelEnum.CANCEL);
        addButtonToSecondaryGroup(GoCancelEnum.GO);
        
        this.initWidget(layout);
    }
    
    private void addButton(final GoCancelEnum type){
    ...
    private void addButtonToSecondaryGroup(final GoCancelEnum type){
        KSButton button = new KSButton(type.getText(), new ClickHandler(){
