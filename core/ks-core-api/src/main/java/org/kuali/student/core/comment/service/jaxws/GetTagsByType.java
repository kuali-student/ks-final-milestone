...
@XmlRootElement(name = "getTagsByType", namespace = "http://student.kuali.org/wsdl/commentService")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getTagsByType", namespace = "http://student.kuali.org/wsdl/commentService", propOrder = {"referenceId","referenceTypeKey","tagTypeKey"})
...
public class GetTagsByType {
    ...
    @XmlElement(name = "tagTypeKey")
    private java.lang.String tagTypeKey;
    ...
    public java.lang.String getTagTypeKey() {
        return this.tagTypeKey;
    }

    public void setTagTypeKey(java.lang.String newTagTypeKey)  {
        this.tagTypeKey = newTagTypeKey;
    }
