...
@XmlRootElement(name = "rebuildRuleSetSnapshot", namespace = "http://student.kuali.org/wsdl/brms/RuleRepository")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "rebuildRuleSetSnapshot", namespace = "http://student.kuali.org/wsdl/brms/RuleRepository", propOrder = {"ruleSetUUID","snapshotName"})

public class RebuildRuleSetSnapshot {
