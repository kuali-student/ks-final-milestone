...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.orch.ModifyCreditCourseProposalHelper.Properties;


public class ModifyCreditCourseProposalMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "ModifyCreditCourseProposalMetadata");
