...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.CreditTypeInfoHelper.Properties;


public class CreditTypeInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "CreditTypeInfoMetadata");
