...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.DocumentTypeInfoHelper.Properties;


public class DocumentTypeInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "DocumentTypeInfoMetadata");
