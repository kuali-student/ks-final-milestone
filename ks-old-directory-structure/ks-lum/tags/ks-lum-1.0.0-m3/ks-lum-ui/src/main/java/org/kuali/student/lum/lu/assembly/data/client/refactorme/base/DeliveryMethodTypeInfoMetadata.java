...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.DeliveryMethodTypeInfoHelper.Properties;


public class DeliveryMethodTypeInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "DeliveryMethodTypeInfoMetadata");
