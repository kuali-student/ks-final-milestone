...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.TimeAmountInfoHelper.Properties;
...
public class TimeAmountInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "TimeAmountInfoMetadata");
