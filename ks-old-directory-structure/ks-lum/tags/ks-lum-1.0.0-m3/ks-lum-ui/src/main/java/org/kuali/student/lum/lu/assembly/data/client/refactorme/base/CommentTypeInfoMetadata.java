...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.CommentTypeInfoHelper.Properties;


public class CommentTypeInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "CommentTypeInfoMetadata");
