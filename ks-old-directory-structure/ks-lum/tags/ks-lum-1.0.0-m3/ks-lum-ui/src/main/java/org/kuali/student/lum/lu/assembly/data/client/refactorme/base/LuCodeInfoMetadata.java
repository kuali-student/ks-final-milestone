...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.LuCodeInfoHelper.Properties;


public class LuCodeInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "LuCodeInfoMetadata");
		...
		if (this.matches (type, state, "(default)", "(default)"))
		{
			...
			childMeta.getConstraints ().add (ConstraintMetadataBank.BANK.get ("lu.code.types"));
		}
