...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.CredentialTypeInfoHelper.Properties;


public class CredentialTypeInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "CredentialTypeInfoMetadata");
