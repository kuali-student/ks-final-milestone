...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.MembershipQueryInfoHelper.Properties;
...
public class MembershipQueryInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "MembershipQueryInfoMetadata");
		...
		{
			new QueryParamValueMetadata ().loadChildMetadata (listMeta, type, state, recursions);
		}
