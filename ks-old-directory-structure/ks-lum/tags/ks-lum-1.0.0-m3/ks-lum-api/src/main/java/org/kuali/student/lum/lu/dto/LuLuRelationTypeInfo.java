...
public class LuLuRelationTypeInfo implements Serializable, Idable, HasAttributes {
    ...
    /**
     * Short name of the LU to LU relationship type. This is primarily to be used by developers and may end up translated in the end system.
     */
    ...
    /**
     * Date and time that this LU to LU relationship type became effective. This is a similar concept to the effective date on enumerated values. When an expiration date has been specified, this field must be less than or equal to the expiration date.
     */
