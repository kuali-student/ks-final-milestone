...
@XmlRootElement
public class RuleDTO extends AbstractItemDTO implements java.io.Serializable {
     ...
     */
    public RuleDTO(final String name, 
     ...
     */
    public RuleDTO(final String uuid, 
    		final String name, 
    ...
    public String toString() {
        return "RuleDTO UUID=" + getUUID() + ", name=" + getName() + ", versionNumber=" + getVersionNumber();
    }
