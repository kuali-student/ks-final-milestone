...
public class GetDocumentTypesResponse {
    ...
    private java.util.List<DocumentTypeInfo> _return;

    public java.util.List<DocumentTypeInfo> getReturn() {
        return this._return;
    }

    public void setReturn(java.util.List<DocumentTypeInfo> new_return)  {
