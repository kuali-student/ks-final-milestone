...
public class ServiceTestDependencyInjectorListener extends
	...
	protected void injectDependencies(TestContext testContext) throws Exception {
		...
		for (Field f : testContext.getTestClass().getDeclaredFields()) {
			if (f.isAnnotationPresent(Client.class)) {
				...
				String serviceName = "";
				String serviceWsdlDocumentLocation = "http://localhost:"
						+ a.port() + "/Service/Service?wsdl";
				...
				clientFactory
						.setWsdlDocumentLocation(serviceWsdlDocumentLocation);
