...
---------------------------------------------
	...
	For example, to setup run config for maven command: "mvn -P build-gwt compile", do the following:
...
-----------------------------------------
	1. Run "mvn -P build-gwt compile" from cmd line (or use equivalent eclipse maven run configuration)
...
--------------------------------------
	...
	"mvn -P build-gwt compile gwt:gwt" OR "mvn -P build-gwt test" 
