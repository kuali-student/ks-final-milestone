...
public abstract class KualiTypeCodeInactivatableFromToBase extends InactivatableFromToImpl implements KualiTypeCode, AttributedBusinessObject {
	@Id
	@Column(name = "ID")
	private String id;
	...
	public KualiTypeCodeInactivatableFromToBase() {
		super();
	}
