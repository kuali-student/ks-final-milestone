...
public class MetaInfConfigConstants {
	...
	private static final String GA = ConfigUtils.getId(DeployProjectConstants.GROUP_ID, DeployProjectConstants.ARTIFACT_ID);
	...
	public static final String SQL_METAINF_CONFIG_ID = ConfigUtils.getId(GA, UTIL_SQL_CONTEXT_ID);
