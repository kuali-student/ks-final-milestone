...
@Configuration
public class DelegatingPropertySourceConfig extends MavenPropertySourceConfig {

    @Autowired
    Environment env;
    protected static final String PROVIDER_CLASS_KEY = "ks.propertysource.provider";
