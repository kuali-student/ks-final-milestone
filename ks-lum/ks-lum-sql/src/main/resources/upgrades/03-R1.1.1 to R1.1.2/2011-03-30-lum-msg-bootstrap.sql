-- Course logistics > Course formats > Activities > Duration Type (label) 
-- See KSLAB-1479 
...
/
-- Course logistics > Course formats > Activities > Duration Type (help bubble) 
-- See KSLAB-1479  
insert into KSMG_MESSAGE (ID, MSG_ID, LOCALE, GRP_NAME, MSG_VALUE, OBJ_ID, VER_NBR) 
...
/
-- Course logistics > Duration (section header instruction text) 
-- See KSLAB-1479 
...
/
-- Course logistics > Duration > Duration (label) AND 
-- Course logistics > Course formats > Activities > Duration (label)
-- See KSLAB-1479  
