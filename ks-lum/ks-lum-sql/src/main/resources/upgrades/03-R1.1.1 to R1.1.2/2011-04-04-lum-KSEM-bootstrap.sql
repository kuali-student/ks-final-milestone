...
insert into KSEMBEDDED.KSEM_ENUM_VAL_T (ID, ABBREV_VAL, CD, EFF_DT, EXPIR_DT, SORT_KEY, VAL, ENUM_KEY, OBJ_ID, VER_NBR) values ('850a28c9-ebfb-4199-8769-6693404ce4af', 'cross-listed', 'crossListed', to_date('2000-01-01', 'yyyy-mm-dd'), null, 1, 'Cross-listed Courses', 'kuali.dependency.course.types', SYS_GUID(), 1)
/
insert into KSEMBEDDED.KSEM_ENUM_VAL_T (ID, ABBREV_VAL, CD, EFF_DT, EXPIR_DT, SORT_KEY, VAL, ENUM_KEY, OBJ_ID, VER_NBR) values ('b7d8c960-fb52-4db9-8a02-99c6ad802d74', 'Jointly-Offered', 'joint', to_date('2000-01-01', 'yyyy-mm-dd'), null, 0, 'Jointly-Offered Courses', 'kuali.dependency.course.types', SYS_GUID(), 1)
/
...
/
insert into KSEMBEDDED.KSEM_ENUM_VAL_T (ID, ABBREV_VAL, CD, EFF_DT, EXPIR_DT, SORT_KEY, VAL, ENUM_KEY, OBJ_ID, VER_NBR) values ('09a9e57b-1078-4bfe-88fd-9bb7fc189b8c', 'Corequisite', 'kuali.statement.type.course.academicReadiness.coreq', to_date('2000-01-01', 'yyyy-mm-dd'), null, 0, 'Corequisite', 'kuali.dependency.course.types', SYS_GUID(), 1)
/
...
/
insert into KSEMBEDDED.KSEM_ENUM_VAL_T (ID, ABBREV_VAL, CD, EFF_DT, EXPIR_DT, SORT_KEY, VAL, ENUM_KEY, OBJ_ID, VER_NBR) values ('f32403a1-cc9d-4004-9a95-f5da290b55e2', 'cluSet', 'cluSet', to_date('2000-01-01', 'yyyy-mm-dd'), null, 2, 'All Course Sets', 'kuali.dependency.courseSet.types', SYS_GUID(), 4)
/
