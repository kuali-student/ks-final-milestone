...
insert into KSLO_LO_REPOSITORY (ID, CREATEID, CREATETIME, UPDATEID, UPDATETIME, VERSIONIND, EFF_DT, EXPIR_DT, NAME, RT_DESCR_ID, LO_ROOT_ID) values ('kuali.loRepository.key.singleUse', null, null, null, null, 1, {ts '2008-01-01 00:00:00.0'}, {ts '2010-01-01 00:00:00.0'},'singleUse', 'RICHTEXT-10', null);
