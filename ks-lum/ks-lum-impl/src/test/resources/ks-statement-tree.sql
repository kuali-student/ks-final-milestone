...
INSERT INTO KSST_REQ_COM_FIELD (ID, REQ_COM_FIELD_TYPE, VALUE) VALUES ('FIELD-4', 'kuali.reqComponent.field.type.requiredCount', '1')
...
INSERT INTO KSST_REQ_COM_FIELD (ID, REQ_COM_FIELD_TYPE, VALUE) VALUES ('FIELD-6', 'kuali.reqComponent.field.type.personid', 'Smith')
...
// STMT
INSERT INTO KSST_STMT (ID, CREATEID, CREATETIME, UPDATEID, UPDATETIME, VERSIONIND, NAME, RT_DESCR_ID, ST, OPERATOR, PARENT_STMT_ID,STMT_TYPE_ID) VALUES ('STMT-TV-1', 'CREATEID', {ts '2000-01-01 00:00:00.0'}, 'UPDATEID', {ts '2001-01-01 00:00:00.0'},1,'STMT TV 1','KSST_STMT.DESC.TV-1','ACTIVE','AND',null,'kuali.statement.type.program.entrance')
INSERT INTO KSST_STMT (ID, CREATEID, CREATETIME, UPDATEID, UPDATETIME, VERSIONIND, NAME, RT_DESCR_ID, ST, OPERATOR, PARENT_STMT_ID,STMT_TYPE_ID) VALUES ('STMT-TV-2', 'CREATEID', {ts '2000-01-01 00:00:00.0'}, 'UPDATEID', {ts '2001-01-01 00:00:00.0'},1,'STMT TV 2','KSST_STMT.DESC.TV-2','ACTIVE','AND','STMT-TV-1','kuali.statement.type.program.entrance')
INSERT INTO KSST_STMT (ID, CREATEID, CREATETIME, UPDATEID, UPDATETIME, VERSIONIND, NAME, RT_DESCR_ID, ST, OPERATOR, PARENT_STMT_ID,STMT_TYPE_ID) VALUES ('STMT-TV-3', 'CREATEID', {ts '2000-01-01 00:00:00.0'}, 'UPDATEID', {ts '2001-01-01 00:00:00.0'},1,'STMT TV 3','KSST_STMT.DESC.TV-3','ACTIVE','OR','STMT-TV-1','kuali.statement.type.program.entrance')
