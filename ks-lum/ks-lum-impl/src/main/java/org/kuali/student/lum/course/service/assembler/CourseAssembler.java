...
/**
 * Assembler for CourseInfo. Assembles/Disassemble CourseInfo from CluInfo and
 * other structures.
 * 
...
public class CourseAssembler implements BOAssembler<CourseInfo, CluInfo> {
	...
	public BaseDTOAssemblyNode<CourseInfo, CluInfo> disassemble(
		...
		List<BaseDTOAssemblyNode<?, ?>> formatResults = disassembleFormats(
				course, operation);
	...
	private List<BaseDTOAssemblyNode<?, ?>> disassembleFormats(
			CourseInfo course, NodeOperation operation)
			throws AssemblyException {
	...
	private List<BaseDTOAssemblyNode<?, ?>> disassembleJoints(
			CourseInfo course, NodeOperation operation)
			throws AssemblyException {
