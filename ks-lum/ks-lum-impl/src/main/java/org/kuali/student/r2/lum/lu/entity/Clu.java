...
@NamedQueries( {
    ...
    @NamedQuery(name = "Clu.findCurrentVersionInfo", query = "SELECT " +
    		"NEW org.kuali.student.r2.common.versionmanagement.dto.VersionDisplayInfo(c.id, c.version.versionIndId, c.version.sequenceNumber, c.version.currentVersionStart, c.version.currentVersionEnd, c.version.versionComment, c.version.versionedFromId) " +
    		"FROM Clu c " +
