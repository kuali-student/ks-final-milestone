...
public class LuServiceImpl implements CluService {
    ...
    @Override
    public List<LuiInfo> getLuisByIds(List<String> luiIdList, ContextInfo contextInfo) throws DoesNotExistException,
            InvalidParameterException, MissingParameterException, OperationFailedException,
            UnsupportedOperationException {
    ...
    @Override
    public List<String> getLuiIdsByCluId(String cluId, ContextInfo contextInfo) throws DoesNotExistException,
            InvalidParameterException, MissingParameterException, OperationFailedException,
            UnsupportedOperationException {
    ...
    @Override
    public List<String> getAllowedLuLuRelationTypesByLuiId(String luiId, String relatedLuiId, ContextInfo contextInfo)
            throws DoesNotExistException, InvalidParameterException, MissingParameterException,
            OperationFailedException, UnsupportedOperationException {
    ...
    @Override
    public List<LuiInfo> getLuisByRelation(String luiId, String luLuRelationTypeKey, ContextInfo contextInfo)
            throws DoesNotExistException, InvalidParameterException, MissingParameterException,
            OperationFailedException, UnsupportedOperationException {
        checkForMissingParameter(luiId, "luiId");
    ...
    @Override
    public List<String> getLuiIdsByRelation(String luiId, String luLuRelationTypeKey, ContextInfo contextInfo)
            throws DoesNotExistException, InvalidParameterException, MissingParameterException,
            OperationFailedException, UnsupportedOperationException {
        checkForMissingParameter(luiId, "luiId");
        checkForMissingParameter(luLuRelationTypeKey, "luLuRelationTypeKey");
    ...
    @Override
    public List<LuiInfo> getRelatedLuisByLuiId(String luiId, String luLuRelationTypeKey, ContextInfo contextInfo)
            throws DoesNotExistException, InvalidParameterException, MissingParameterException,
            OperationFailedException, UnsupportedOperationException {
        checkForMissingParameter(luiId, "luiId");
        checkForMissingParameter(luLuRelationTypeKey, "luLuRelationTypeKey");
    ...
    @Override
    public List<String> getRelatedLuiIdsByLuiId(String luiId, String luLuRelationTypeKey, ContextInfo contextInfo)
            throws DoesNotExistException, InvalidParameterException, MissingParameterException,
            OperationFailedException, UnsupportedOperationException {
        checkForMissingParameter(luiId, "luiId");
        checkForMissingParameter(luLuRelationTypeKey, "luLuRelationTypeKey");
    ...
    public Clu toCluForCreate(String luTypeKey, CluInfo cluInfo, ContextInfo contextInfo)
        ...
        if (cluInfo.getPrimaryInstructor() != null) {
            ...
            // TODO KSCM dozer mapping needs to be done for CluInfo between r1 and r2
            // note that in r1 cluInfo.getPrimaryInstructor().getAttributes() returns a Map and in r2 a List
        ...
        for (CluInstructorInfo instructorInfo : cluInfo.getInstructors()) {
            ...
            BeanUtils.copyProperties(instructorInfo, instructor,
                    new String[]{"attributes"});
            // TODO KSCM dozer mapping needs to be done for CluInstructorInfo between r1 and r2
            // note that in r1 instructorInfo.getAttributes() returns a Map and in r2 a List
            instructor.setAttributes(LuServiceAssembler.toGenericAttributes(
    ...
    @Override
    public List<ValidationResultInfo> validateLui(String validationType, LuiInfo luiInfo, ContextInfo contextInfo)
            throws DoesNotExistException, InvalidParameterException, MissingParameterException,
            OperationFailedException, UnsupportedOperationException {
    ...
    @Override
    @Transactional(readOnly = false)
    public StatusInfo deleteLui(String luiId, ContextInfo contextInfo) throws DependentObjectsExistException,
            DoesNotExistException, InvalidParameterException, MissingParameterException, OperationFailedException,
    ...
    public List<ValidationResultInfo> validateLuiLuiRelation(String validationType,
            LuiLuiRelationInfo luiLuiRelationInfo, ContextInfo contextInfo) throws DoesNotExistException,
            InvalidParameterException, MissingParameterException, OperationFailedException,
            UnsupportedOperationException {
        checkForMissingParameter(validationType, "validationType");
        ...
        Validator defaultValidator = validatorFactory.getValidator();
        List<ValidationResultInfo> validationResults = defaultValidator.validateObject(luiLuiRelationInfo,
                objStructure, contextInfo);
        return validationResults;
    }
    ...
    public LuiLuiRelationInfo createLuiLuiRelation(String luiId, String relatedLuiId, String luLuRelationTypeKey,
            LuiLuiRelationInfo luiLuiRelationInfo, ContextInfo contextInfo) throws AlreadyExistsException,
            CircularRelationshipException, DataValidationErrorException, DoesNotExistException,
            InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException,
            UnsupportedOperationException {
        checkForMissingParameter(luiId, "luiId");
        checkForMissingParameter(relatedLuiId, "relatedLuiId");
    ...
    public List<TypeInfo> getCluCluRelationTypes(ContextInfo contextInfo) throws InvalidParameterException,
            MissingParameterException, OperationFailedException, PermissionDeniedException {
        // TODO KSCM - THIS METHOD NEEDS JAVADOCS
        return null;
    }
