...
@XmlRootElement(name = "updateLuiState", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "updateLuiState", namespace = "http://student.kuali.org/wsdl/lu", propOrder = {"luiId","luState"})

public class UpdateLuiState {
