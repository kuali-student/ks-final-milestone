...
@XmlRootElement(name = "getLoLoRelation", namespace = "http://student.kuali.org/wsdl/lo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getLoLoRelation", namespace = "http://student.kuali.org/wsdl/lo")

public class GetLoLoRelation {
