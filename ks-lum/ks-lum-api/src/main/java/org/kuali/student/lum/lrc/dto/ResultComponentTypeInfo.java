 ...
 * @Author lindholm
 * @Since Tue Apr 21 13:47:26 PDT 2009
 * @See <a href="https://test.kuali.org/confluence/display/KULSTU/resultComponentTypeInfo+Structure">ResultComponentTypeInfo</>
 *
 */
//KSCM-130:  Add @XmlType
@XmlType(name = "ResultComponentTypeInfo", propOrder = {"id", "name", "desc", "effectiveDate", "expirationDate", "attributes"})
@XmlAccessorType(XmlAccessType.FIELD)
public class ResultComponentTypeInfo implements Serializable, Idable, HasAttributes {
