...
@XmlRootElement(name = "removeLrScaleFromClu", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "removeLrScaleFromClu", namespace = "http://student.kuali.org/wsdl/lu", propOrder = {"lrScaleTypeKey","lrTypeKey","cluId"})

public class RemoveLrScaleFromClu {
