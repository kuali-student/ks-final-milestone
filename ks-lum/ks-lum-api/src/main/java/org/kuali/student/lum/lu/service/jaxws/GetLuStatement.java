...
@XmlRootElement(name = "getLuStatement", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getLuStatement", namespace = "http://student.kuali.org/wsdl/lu")

public class GetLuStatement {
