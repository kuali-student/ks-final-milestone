...
@XmlRootElement(name = "getAllowedLuLuRelationTypeInfosByCluId", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getAllowedLuLuRelationTypeInfosByCluId", namespace = "http://student.kuali.org/wsdl/lu", propOrder = {"cluId","relatedCluId"})

public class GetAllowedLuLuRelationTypeInfosByCluId {
