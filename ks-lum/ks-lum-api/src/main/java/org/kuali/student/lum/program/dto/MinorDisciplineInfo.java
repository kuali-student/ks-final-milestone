...
import org.kuali.student.lum.program.infc.MinorDiscipline;
...
@XmlType(name = "MinorDisciplineInfo", propOrder = {"id", "typeKey", "stateKey", "name", "descr", "credentialProgramId", "programRequirements", "meta", "attributes" /*TODO KSCM-gwt-compile , "_futureElements" */})
