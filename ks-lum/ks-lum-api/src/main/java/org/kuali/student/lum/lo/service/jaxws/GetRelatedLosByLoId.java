...
@XmlRootElement(name = "getRelatedLosByLoId", namespace = "http://student.kuali.org/wsdl/lo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getRelatedLosByLoId", namespace = "http://student.kuali.org/wsdl/lo", propOrder = {"loId","loLoRelationType"})

public class GetRelatedLosByLoId {
