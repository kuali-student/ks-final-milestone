...
@XmlRootElement(name = "getCluResultTypesForLuType", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getCluResultTypesForLuType", namespace = "http://student.kuali.org/wsdl/lu")

public class GetCluResultTypesForLuType {
