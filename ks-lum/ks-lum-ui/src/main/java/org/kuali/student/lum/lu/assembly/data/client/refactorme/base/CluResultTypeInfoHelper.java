...
public class CluResultTypeInfoHelper
{
	...
	private CluResultTypeInfoHelper (Data data)
	{
		this.data = data;
	}
	
	public static CluResultTypeInfoHelper wrap (Data data)
	{
		if (data == null)
		{
			 return null;
		}
		return new CluResultTypeInfoHelper (data);
	}
