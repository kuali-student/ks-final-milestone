...
public class FeeInfoPerCreditFeeHelper
{
	...
	private FeeInfoPerCreditFeeHelper (Data data)
	{
		this.data = data;
	}
	
	public static FeeInfoPerCreditFeeHelper wrap (Data data)
	{
		if (data == null)
		{
			 return null;
		}
		return new FeeInfoPerCreditFeeHelper (data);
	}
