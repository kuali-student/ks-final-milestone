...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.ProposalInfoHelper.Properties;
...
public class ProposalInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "ProposalInfoMetadata");
		...
		// metadata for proposalReferenceType
		childMeta = new Metadata ();
