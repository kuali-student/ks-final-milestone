...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.ObjectStructureInfoHelper.Properties;


public class ObjectStructureInfoMetadata
{
	...
	public void loadChildMetadata (Metadata mainMeta, String type, String state,  RecursionCounter recursions)
	{
		...
		new TypeSelectorInfoMetadata ().loadChildMetadata (childMeta, type, state, recursions);
		
		// metadata for objectTypeKey
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.OBJECT_TYPE_KEY.getKey (), childMeta);
