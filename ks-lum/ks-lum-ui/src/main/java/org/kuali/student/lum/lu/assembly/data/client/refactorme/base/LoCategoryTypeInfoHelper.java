...
public class LoCategoryTypeInfoHelper
{
	...
	private LoCategoryTypeInfoHelper (Data data)
	{
		this.data = data;
	}
	
	public static LoCategoryTypeInfoHelper wrap (Data data)
	{
		if (data == null)
		{
			 return null;
		}
		return new LoCategoryTypeInfoHelper (data);
	}
