...
public class OrgOrgRelationInfoHelper
{
	...
	private OrgOrgRelationInfoHelper (Data data)
	{
		this.data = data;
	}
	
	public static OrgOrgRelationInfoHelper wrap (Data data)
	{
		if (data == null)
		{
			 return null;
		}
		return new OrgOrgRelationInfoHelper (data);
	}
	...
	{
		data.set (Properties.RELATED_ORG_ID.getKey (), value);
	}
	
	
	public String getRelatedOrgId ()
	{
		return (String) data.get (Properties.RELATED_ORG_ID.getKey ());
	}
