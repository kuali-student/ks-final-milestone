...
public class AtpSeasonalTypeInfoHelper
{
	...
	private AtpSeasonalTypeInfoHelper (Data data)
	{
		this.data = data;
	}
	
	public static AtpSeasonalTypeInfoHelper wrap (Data data)
	{
		if (data == null)
		{
			 return null;
		}
		return new AtpSeasonalTypeInfoHelper (data);
	}
