...
public class OrgPersonRelationTypeInfoHelper
{
	...
	private OrgPersonRelationTypeInfoHelper (Data data)
	{
		this.data = data;
	}
	
	public static OrgPersonRelationTypeInfoHelper wrap (Data data)
	{
		if (data == null)
		{
			 return null;
		}
		return new OrgPersonRelationTypeInfoHelper (data);
	}
