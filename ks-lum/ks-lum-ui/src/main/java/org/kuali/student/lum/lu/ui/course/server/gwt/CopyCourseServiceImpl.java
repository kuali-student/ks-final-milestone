...
//TODO KSCM-578 import org.kuali.student.lum.lu.dto.AffiliatedOrgInfo;
...
public class CopyCourseServiceImpl {
	...
	private void resetIds(CourseInfo course) {
		...
		// TODO KSCM-578 
		// TODO KSCM-578 for(ResultComponentInfo result:course.getCreditOptions()){
		// TODO KSCM-578 	result.setId(null);
		// TODO KSCM-578 }
		...
		//Clear Expenditures
		// TODO KSCM-578 for(AffiliatedOrgInfo orgInfo:course.getExpenditure().getAffiliatedOrgs()){
		// TODO KSCM-578 	orgInfo.setId(null);
		// TODO KSCM-578 }
		//Clear Fees
		...
		for(CourseRevenueInfo revenue:course.getRevenues()){
			revenue.setId(null);
			// TODO KSCM-578 for(AffiliatedOrgInfo orgInfo:revenue.getAffiliatedOrgs()){
			// TODO KSCM-578 	orgInfo.setId(null);
			// TODO KSCM-578 }
		}
		//Clear variation ids
