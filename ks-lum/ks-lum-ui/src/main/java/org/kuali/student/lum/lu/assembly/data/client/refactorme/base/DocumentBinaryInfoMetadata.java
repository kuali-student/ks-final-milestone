...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.DocumentBinaryInfoHelper.Properties;


public class DocumentBinaryInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "DocumentBinaryInfoMetadata");
		...
		mainMeta.getProperties ().put (Properties.BINARY.getKey (), childMeta);
