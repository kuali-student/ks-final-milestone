...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.orch.BrowseCourseCatalogBySubjectAreaHelper.Properties;


public class BrowseCourseCatalogBySubjectAreaMetadata
{
	...
	public void loadChildMetadata (Metadata mainMeta, String type, String state,  RecursionCounter recursions)
	{
		...
		LookupMetadataBank.setLookups (childMeta, "kuali.lu.browse.CourseCatalogBySubjectArea");
