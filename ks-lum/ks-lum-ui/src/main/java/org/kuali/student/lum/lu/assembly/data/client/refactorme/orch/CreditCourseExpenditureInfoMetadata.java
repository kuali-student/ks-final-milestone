...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.orch.CreditCourseExpenditureInfoHelper.Properties;


public class CreditCourseExpenditureInfoMetadata
{
	...
	public void loadChildMetadata (Metadata mainMeta, String type, String state,  RecursionCounter recursions)
	{
		...
		// metadata for ExpenditureOrg
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.EXPENDITURE_ORG.getKey (), childMeta);
