...
public class LuCodeTypeInfoHelper
{
	...
	private LuCodeTypeInfoHelper (Data data)
	{
		this.data = data;
	}
	
	public static LuCodeTypeInfoHelper wrap (Data data)
	{
		if (data == null)
		{
			 return null;
		}
		return new LuCodeTypeInfoHelper (data);
	}
