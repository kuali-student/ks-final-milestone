...
public class LoRepositoryInfoHelper
{
	...
	private LoRepositoryInfoHelper (Data data)
	{
		this.data = data;
	}
	
	public static LoRepositoryInfoHelper wrap (Data data)
	{
		if (data == null)
		{
			 return null;
		}
		return new LoRepositoryInfoHelper (data);
	}
	...
	public void setRootLoId (String value)
	{
		data.set (Properties.ROOT_LO_ID.getKey (), value);
	}
	
	
	public String getRootLoId ()
	{
		return (String) data.get (Properties.ROOT_LO_ID.getKey ());
	}
