...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.CluPublicationInfoHelper.Properties;


public class CluPublicationInfoMetadata
{
	...
	public void loadChildMetadata (Metadata mainMeta, String type, String state,  RecursionCounter recursions)
	{
		...
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.VARIANTS.getKey (), childMeta);
		...
		new FieldInfoMetadata ().loadChildMetadata (listMeta, type, state, recursions);
