...
public class BaccLearningObjectivesViewConfiguration extends AbstractSectionConfiguration {
    ...
    public static BaccLearningObjectivesViewConfiguration createSpecial() {
        ...
        return new BaccLearningObjectivesViewConfiguration(new VerticalSectionView(ProgramSections.LEARNING_OBJECTIVES_VIEW, title, ProgramConstants.PROGRAM_MODEL_ID, new EditableHeader(title, ProgramSections.LEARNING_OBJECTIVES_EDIT)));
    }
