...
/
INSERT INTO "KSEMBEDDED"."KRIM_PERM_T" (PERM_ID, OBJ_ID, VER_NBR, PERM_TMPL_ID, NMSPC_CD, NM, DESC_TXT, ACTV_IND) VALUES ('3204', '93ebf19d-5942-4ac3-bd52-8a77a4cdd17b', '1', '4000', 'KS-SYS', 'Open Document - DISAPPROVE', 'Open Document, with status DISAPPROVE 'Y')
/
INSERT INTO "KSEMBEDDED"."KRIM_PERM_ATTR_DATA_T" (ATTR_DATA_ID, OBJ_ID, VER_NBR, PERM_ID, KIM_TYP_ID, KIM_ATTR_DEFN_ID, ATTR_VAL) VALUES ('20002', 'b6d9a8d7-7046-4279-8ca2-c8d1d2a5c98c', '1', '3204', '8', '2000', 'D')
/
INSERT INTO "KSEMBEDDED"."KRIM_ROLE_PERM_T" (ROLE_PERM_ID, OBJ_ID, VER_NBR, ROLE_ID, PERM_ID, ACTV_IND) VALUES ('7002', '9285456b-def1-412f-9a80-b5effcc2de84', '1', '7000', '3204', 'Y')
/
INSERT INTO "KSEMBEDDED"."KRIM_PERM_T" (PERM_ID, OBJ_ID, VER_NBR, PERM_TMPL_ID, NMSPC_CD, NM, DESC_TXT, ACTV_IND) VALUES ('3205', '2e948c9d-6f01-4901-be1b-e3a62a5849c7', '1', '4000', 'KS-SYS', 'Open Document - CANCEL', 'Open Document, with status CANCEL 'Y')
/
INSERT INTO "KSEMBEDDED"."KRIM_PERM_ATTR_DATA_T" (ATTR_DATA_ID, OBJ_ID, VER_NBR, PERM_ID, KIM_TYP_ID, KIM_ATTR_DEFN_ID, ATTR_VAL) VALUES ('20003', '145d666d-4ac3-425b-b6ee-ef6c0761e2b8', '1', '3205', '8', '2000', 'X')
/
INSERT INTO "KSEMBEDDED"."KRIM_ROLE_PERM_T" (ROLE_PERM_ID, OBJ_ID, VER_NBR, ROLE_ID, PERM_ID, ACTV_IND) VALUES ('7003', '187c7629-7a5f-46d5-9a25-9dc54a0d1ea0', '1', '7000', '3205', 'Y')
/
