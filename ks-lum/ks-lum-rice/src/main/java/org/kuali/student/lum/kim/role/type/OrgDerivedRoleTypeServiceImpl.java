		...
		try {
			...
			if(includedOrgPersonRelationTypes!=null){
				for(String orgPersonRelationType:includedOrgPersonRelationTypes){
					...
					// TODO KSCM-429 principalIds = orgService.getPersonIdsForOrgByRelationType(orgId, orgPersonRelationType, contextInfo);
			...
			//Otherwise get all members of the organization except for the excluded
				...
				// TODO KSCM-429 relations = orgService.getAllOrgPersonRelationsByOrg(orgId, contextInfo);
