...
@XmlRootElement(name = "getBusinessRuleByAnchorResponse", namespace = "http://student.kuali.org/wsdl/brms/RuleManagement")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getBusinessRuleByAnchorResponse", namespace = "http://student.kuali.org/wsdl/brms/RuleManagement")

public class GetBusinessRuleByAnchorResponse {
