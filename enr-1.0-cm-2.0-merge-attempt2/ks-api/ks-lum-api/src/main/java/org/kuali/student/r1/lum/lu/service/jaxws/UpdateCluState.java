...
@XmlRootElement(name = "updateCluState", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "updateCluState", namespace = "http://student.kuali.org/wsdl/lu", propOrder = {"cluId","luState"})
