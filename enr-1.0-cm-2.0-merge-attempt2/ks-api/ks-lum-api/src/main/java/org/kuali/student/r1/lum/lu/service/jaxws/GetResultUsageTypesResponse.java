...
@XmlRootElement(name = "getResultUsageTypesResponse", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getResultUsageTypesResponse", namespace = "http://student.kuali.org/wsdl/lu")

public class GetResultUsageTypesResponse {
    ...
    public void setReturn(java.util.List<ResultUsageTypeInfo> new_return)  {
