...
Rails::Initializer.run do |config|
  ...
  config.gem 'activerecord-oracle_enhanced-adapter', :lib => 'active_record/connection_adapters/oracle_enhanced_adapter', :version => '1.3.0'
  config.gem 'cucumber', :version => '0.9.2'
  ...
  config.gem 'gherkin', :lib => false, :version => '2.2.8'
