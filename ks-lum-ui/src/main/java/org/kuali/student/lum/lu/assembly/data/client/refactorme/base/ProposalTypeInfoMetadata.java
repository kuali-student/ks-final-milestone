...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.ProposalTypeInfoHelper.Properties;


public class ProposalTypeInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "ProposalTypeInfoMetadata");
