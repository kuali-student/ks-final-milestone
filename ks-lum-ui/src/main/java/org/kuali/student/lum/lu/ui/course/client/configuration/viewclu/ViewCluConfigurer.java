...
public class ViewCluConfigurer {
    ...
    private static final String STYLE_SECTION = "KS-LUM-Section";
    private static final String STYLE_SECTION_DIVIDER = "KS-LUM-Section-Divider";
...
//      section.addSection(generateVersionCodesSection());
    ...
    private static VerticalSection generateSummaryDetails(SectionTitle title) {
        ...
        governance.addStyleName(STYLE_SECTION);
        governance.addStyleName(STYLE_SECTION_DIVIDER);
        ...
        logistics.addStyleName(STYLE_SECTION);
        logistics.addStyleName(STYLE_SECTION_DIVIDER);
        ...
        information.addStyleName(STYLE_SECTION);
        information.addStyleName(STYLE_SECTION_DIVIDER);
