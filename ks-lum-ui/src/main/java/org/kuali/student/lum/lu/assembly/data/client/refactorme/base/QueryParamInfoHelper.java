...
public class QueryParamInfoHelper
{
	...
	private QueryParamInfoHelper (Data data)
	{
		this.data = data;
	}
	
	public static QueryParamInfoHelper wrap (Data data)
	{
		if (data == null)
		{
			 return null;
		}
		return new QueryParamInfoHelper (data);
	}
