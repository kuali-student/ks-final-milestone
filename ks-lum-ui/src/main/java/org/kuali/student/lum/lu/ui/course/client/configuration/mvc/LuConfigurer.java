...
public class LuConfigurer {
    ...
    public enum LuSections {
        CLU_BEGIN, AUTHOR, GOVERNANCE, COURSE_LOGISTICS, COURSE_INFO, LEARNING_OBJECTIVES, COURSE_REQUISITES, ACTIVE_DATES, FINANCIALS, PGM_REQUIREMENTS, ATTACHMENTS, COMMENTS, DOCUMENTS, DEMO_SECTION
    }

    public static void configureCluProposal(ConfigurableLayout layout) {
        /*
         * Map<String, Field> result = LUDictionaryManager.getInstance().getFields("cluInfo", "kuali.lu.type.CreditCourse",
         * "draft"); for (String key : result.keySet()) { System.out.println("<bean parent=\"enCourse\" " +
         * "p:id=\"kuali.lu.type.CreditCourse:" + "draft:" + key + "\"" + "\tp:value=\"\"/>"); } result =
         * LUDictionaryManager.getInstance().getFields("cluIdentifierInfo", "kuali.lu.type.creditcourse.identifier.official",
         * "active"); System.out.println(result.size()); for (String key : result.keySet()) { System.out.println("<bean
         * parent=\"enCourse\" " + "p:id=\"kuali.lu.type.creditcourse.identifier.official:" + "active:" + key + "\"" +
         * "\tp:value=\"\"/>"); } result = LUDictionaryManager.getInstance().getFields("proposalInfo", "lutype.shell.course",
         * "proposed"); for (String key : result.keySet()) { System.out.println("<bean parent=\"enCourse\" " +
         * "p:id=\"lutype.shell.course:" + "proposed:" + key + "\"" + "\tp:value=\"\"/>"); }
         */
    ...
    private static void addCourseRequisitesSection(ConfigurableLayout layout) {
        ...
        // CREDITS
        /*
         * TO Do - once we have a section that allows for flow between rule screens VerticalSection enrollmentSection = new
         * VerticalSection(); enrollmentSection.setSectionTitle(SectionTitle.generateH2Title("Enrollment Restrictions"));
         * enrollmentSection.addField(new FieldDescriptor("rationalle", "Rationalle", Type.STRING));
         * enrollmentSection.addField(new FieldDescriptor("rules", "Rules", Type.STRING)); enrollmentSection.addWidget(new
         * KSButton()); section.addSection(enrollmentSection);
         */
    ...
    public static void addGovernanceSection(ConfigurableLayout layout) {
        ...
        // section.addField(createMVCFieldDescriptor("campusLocationInfo", LUConstants.STRUCTURE_CLU_INFO, CLU_TYPE,
        // CLU_STATE));
    ...
    public static void addCourseInfoSection(ConfigurableLayout layout) {
        ...
        crossListed.addField(new FieldDescriptor("crossListClus", null, Type.LIST, new CrossListedList()));// TODO Key is
                                                                                                            // probably wrong
        ...
        offeredJointly.addField(new FieldDescriptor("jointClus", null, Type.LIST, new OfferedJointlyList()));// TODO Key
                                                                                                                // is
                                                                                                                // probably
                                                                                                                // wrong
        ...
        versionCodes.addField(new FieldDescriptor("luLuRelationType.alias", null, Type.LIST, new VersionCodeList()));// TODO
                                                                                                                        // Key
                                                                                                                        // is
                                                                                                                        // probably
                                                                                                                        // wrong
    ...
    public static class CrossListedList extends MultiplicityComposite {
        ...
        public Widget createItem() {
            ...
            ns.addField(new FieldDescriptor("department", "Department", Type.STRING));// TODO OrgSearch goes here, wrong
                                                                                        // key
            ns.nextRow();
            ns.setCurrentFieldLabelType(FieldLabelType.LABEL_TOP);
    ...
    public static void addCourseLogistics(ConfigurableLayout layout) {
        ...
        learningResults.addField(new FieldDescriptor("evalType", "Evaluation Type", Type.STRING)); // TODO EVAL TYPE
                                                                                                    // ENUMERATION ????
    ...
    public static class CourseActivityList extends MultiplicityComposite {
        ...
        public Widget createItem() {
            ...
            activity.addField(new FieldDescriptor("duration", "Activity Duration", Type.STRING)); // TODO dropdown need
                                                                                                    // here?
            activity.nextRow();
            activity.setCurrentFieldLabelType(FieldLabelType.LABEL_TOP);
