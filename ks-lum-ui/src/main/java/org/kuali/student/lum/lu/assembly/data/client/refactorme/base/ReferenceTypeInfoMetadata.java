...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.ReferenceTypeInfoHelper.Properties;


public class ReferenceTypeInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "ReferenceTypeInfoMetadata");
