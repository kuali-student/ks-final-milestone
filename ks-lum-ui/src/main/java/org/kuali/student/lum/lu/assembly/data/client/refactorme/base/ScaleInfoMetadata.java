...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.ScaleInfoHelper.Properties;


public class ScaleInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "ScaleInfoMetadata");
