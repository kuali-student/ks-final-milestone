...
public class DateRangeTypeInfoHelper
{
	...
	private DateRangeTypeInfoHelper (Data data)
	{
		this.data = data;
	}
	
	public static DateRangeTypeInfoHelper wrap (Data data)
	{
		if (data == null)
		{
			 return null;
		}
		return new DateRangeTypeInfoHelper (data);
	}
