...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.orch.CreditCourseDurationHelper.Properties;
...
public class CreditCourseDurationMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "CreditCourseDurationMetadata");
