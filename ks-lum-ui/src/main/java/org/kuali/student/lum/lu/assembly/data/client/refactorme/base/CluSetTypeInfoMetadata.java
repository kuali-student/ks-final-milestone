...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.CluSetTypeInfoHelper.Properties;


public class CluSetTypeInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "CluSetTypeInfoMetadata");
