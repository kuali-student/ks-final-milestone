...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.LrDefinitionSetInfoHelper.Properties;


public class LrDefinitionSetInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "LrDefinitionSetInfoMetadata");
