...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.AdminOrgInfoHelper.Properties;


public class AdminOrgInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "AdminOrgInfoMetadata");
