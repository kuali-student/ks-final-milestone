...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.CreditInfoHelper.Properties;


public class CreditInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "CreditInfoMetadata");
