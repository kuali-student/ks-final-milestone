...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.TagTypeInfoHelper.Properties;


public class TagTypeInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "TagTypeInfoMetadata");
