...
public class CluLoRelationTypeInfoHelper
{
	...
	private CluLoRelationTypeInfoHelper (Data data)
	{
		this.data = data;
	}
	
	public static CluLoRelationTypeInfoHelper wrap (Data data)
	{
		if (data == null)
		{
			 return null;
		}
		return new CluLoRelationTypeInfoHelper (data);
	}
