...
public class AtpDurationTypeInfoHelper
{
	...
	private AtpDurationTypeInfoHelper (Data data)
	{
		this.data = data;
	}
	
	public static AtpDurationTypeInfoHelper wrap (Data data)
	{
		if (data == null)
		{
			 return null;
		}
		return new AtpDurationTypeInfoHelper (data);
	}
