...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.LrTypeInfoHelper.Properties;


public class LrTypeInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "LrTypeInfoMetadata");
