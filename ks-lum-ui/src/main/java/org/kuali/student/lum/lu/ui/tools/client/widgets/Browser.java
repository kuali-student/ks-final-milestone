                                                    ...
                                                    TranslatableValueWidget
{
 ...
 private void setupBasicSearch (LookupMetadata inLookupMetadata)
 {
  ...
  if (inLookupMetadata.getWidget () == LookupMetadata.Widget.SUGGEST_BOX)
  {
   ...
   if (config.canEdit)
   {
    final SearchSuggestOracle orgSearchOracle =
     new SearchSuggestOracle (inLookupMetadata);
   ...
   if (config.canEdit)
   {
    ...
    searchRpcServiceAsync.search (sr, new AsyncCallback<SearchResult> ()
    {
     ...
     public void onSuccess (SearchResult results)
     {
      if (results != null)
      {
       ((KSDropDown) basicWidget.get ()).setListItems (new SearchResultListItems (results.
        getRows ()));
      }
      else
      {
  ...
  { //default to text box
   ...
   basicWidget = new BasicWidget (config != null && config.canEdit
    ? new KSTextBox () : new KSLabel ());
                                                     ...
                                                     TranslatableValueWidget
 {
  ...
  public Value getValue ()
  {
   ...
   else if (basicWidget instanceof KSSuggestBox)
   {
    ...
    {
     StringValue value =
      new StringValue (((KSSuggestBox) basicWidget).getValue ());
     return value;
    }
    else
    {
