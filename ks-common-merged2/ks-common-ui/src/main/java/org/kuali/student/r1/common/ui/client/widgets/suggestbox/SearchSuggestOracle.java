...
package org.kuali.student.r1.common.ui.client.widgets.suggestbox;
...
import org.kuali.student.r1.common.ui.client.service.SearchServiceFactory;
import org.kuali.student.r1.common.ui.client.widgets.KSErrorDialog;
import org.kuali.student.r1.common.ui.client.widgets.notification.LoadingDiv;
...
public class SearchSuggestOracle extends IdableSuggestOracle{
    ...
    private List<org.kuali.student.r1.common.ui.client.mvc.Callback<IdableSuggestion>> searchCompletedCallbacks = new ArrayList<org.kuali.student.r1.common.ui.client.mvc.Callback<IdableSuggestion>>();
        	...
        	searchService.search(searchRequest, new KSAsyncCallback<SearchResult>(){
                ...
                public void onSuccess(SearchResult results) {
                    ...
                    if (searchCompletedCallbacks != null &&
                        ...
                        for (org.kuali.student.r1.common.ui.client.mvc.Callback<IdableSuggestion> callback : searchCompletedCallbacks) {
...
/*    
    ...
    @Override
    public void getSuggestionByIdSearch(String id, final org.kuali.student.r1.common.ui.client.mvc.Callback<IdableSuggestion> callback) {
    ...
    @Override
    public void addSearchCompletedCallback(org.kuali.student.r1.common.ui.client.mvc.Callback<IdableSuggestion> callback) {
