...
import org.kuali.student.r1.common.ui.client.configurable.mvc.multiplicity.MultiplicityComposite.StyleType;
...
public class DisplayItem extends MultiplicityItem {
    ...
    /**
     * @see org.kuali.student.r1.common.ui.client.configurable.mvc.multiplicity.MultiplicityItem#clear()
     */
    @Override
    public void clear() {
        loaded = false;
    ...
    /**
     * @see org.kuali.student.r1.common.ui.client.configurable.mvc.multiplicity.MultiplicityItem#redraw()
     */
    @Override
    public void redraw() {
