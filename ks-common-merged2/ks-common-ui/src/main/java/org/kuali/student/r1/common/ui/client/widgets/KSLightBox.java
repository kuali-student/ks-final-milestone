...
public class KSLightBox extends DialogBox {
    ...
    /**
     * Adds a {@link org.kuali.student.r1.common.ui.client.widgets.field.layout.button.ButtonGroup} to the button panel at the bottom of the lightbox. 
     * @param group
     */
    @SuppressWarnings("rawtypes")
    public void addButtonGroup(org.kuali.student.r1.common.ui.client.widgets.field.layout.button.ButtonGroup group) {
        buttonPanel.add(group);
    }
    
    /**
     * Adds a {@link org.kuali.student.r1.common.ui.client.widgets.buttongroups.ButtonGroup} to the button panel at the bottom of the lightbox.
     * @param group
     */
    @SuppressWarnings("rawtypes")
    public void addButtonGroup(org.kuali.student.r1.common.ui.client.widgets.buttongroups.ButtonGroup group) {
        buttonPanel.add(group);
