...
public abstract class UpdatableMultiplicityComposite extends MultiplicityComposite {
    ...
    /**
     * @see org.kuali.student.r1.common.ui.client.configurable.mvc.multiplicity.MultiplicityComposite#getItemDecorator()
     */
    @Override
    public MultiplicityItem getItemDecorator(StyleType style) {
        org.kuali.student.r1.common.ui.client.configurable.mvc.sections.RemovableItemWithHeader item = new org.kuali.student.r1.common.ui.client.configurable.mvc.sections.RemovableItemWithHeader(style, readOnly);
        item.setItemLabel(itemLabel + " " + itemCount);            
        return item;
    }

    /**
     * @see org.kuali.student.r1.common.ui.client.configurable.mvc.multiplicity.MultiplicityComposite#generateAddWidget()
     */
