...
import org.kuali.student.r1.common.ui.client.configurable.mvc.binding.MultiplicityCompositeBinding;
    ...
    public ModelWidgetBinding<?> getModelWidgetBinding() {
        if(modelWidgetBinding == null){
            if(fieldElement.getFieldWidget() instanceof RichTextEditor){
            	modelWidgetBinding = org.kuali.student.r1.common.ui.client.configurable.mvc.binding.RichTextBinding.INSTANCE;
            } else if (fieldElement.getFieldWidget() instanceof KSCheckBox){
            	modelWidgetBinding = org.kuali.student.r1.common.ui.client.configurable.mvc.binding.HasValueBinding.INSTANCE;
        	    ...
        	    modelWidgetBinding = org.kuali.student.r1.common.ui.client.configurable.mvc.binding.HasTextBinding.INSTANCE;
            } else if (fieldElement.getFieldWidget() instanceof KSSelectItemWidgetAbstract){
                modelWidgetBinding = org.kuali.student.r1.common.ui.client.configurable.mvc.binding.SelectItemWidgetBinding.INSTANCE;
            } else if (fieldElement.getFieldWidget() instanceof HasDataValue){
            	modelWidgetBinding = org.kuali.student.r1.common.ui.client.configurable.mvc.binding.HasDataValueBinding.INSTANCE;
