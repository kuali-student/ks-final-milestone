...
@XmlRootElement(name = "removeCommentResponse", namespace = "http://student.kuali.org/commentService")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "removeCommentResponse", namespace = "http://student.kuali.org/commentService")
