...
@XmlRootElement(name = "removePositionRestrictionFromOrg", namespace = "http://student.kuali.org/wsdl/organization")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "removePositionRestrictionFromOrg", namespace = "http://student.kuali.org/wsdl/organization", propOrder = {"orgId","orgPersonRelationTypeKey"})
