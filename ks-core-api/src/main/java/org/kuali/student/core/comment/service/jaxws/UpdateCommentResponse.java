...
@XmlRootElement(name = "updateCommentResponse", namespace = "http://student.kuali.org/commentService")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "updateCommentResponse", namespace = "http://student.kuali.org/commentService")
