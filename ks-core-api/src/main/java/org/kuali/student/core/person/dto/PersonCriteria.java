...
/**
 *Query to return some information related to people.
Specifies a search for people.
 */ 
...
public class PersonCriteria implements Serializable {
    ...
    /**
     * The types this search should be executed against. A type of "personInfo" is automatically included. Types are restricted to those within the service.
     */
