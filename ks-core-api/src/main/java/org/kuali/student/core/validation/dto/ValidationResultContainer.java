...
public class ValidationResultContainer implements Serializable {
	...
	/**
	 * Adds an message to the result. If the error level is greater than the
	 * current error level, then the specified error level becomes the current
	 * error level.
	 * 
	 * @param level
	...
	public void setValidationResults(
		...
		for (ValidationResultInfo val : validationResults) {
			if (val.getErrorLevel().getLevel() > errorLevel.getLevel()) {
				errorLevel = val.getErrorLevel();
			}
	...
	/**
	 * @param derivedMinOccurs
	 *            the derivedMinOccurs to set
	 */
	...
	/**
	 * @param derivedMaxOccurs
	 *            the derivedMaxOccurs to set
	 */
	...
	/**
	 * @param derivedMinLength
	 *            the derivedMinLength to set
	 */
	...
	/**
	 * @param derivedMaxLength
	 *            the derivedMaxLength to set
	 */
