...
@XmlRootElement(name = "getDocumentCategory", namespace = "http://student.kuali.org/core/document")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getDocumentCategory", namespace = "http://student.kuali.org/core/document")
