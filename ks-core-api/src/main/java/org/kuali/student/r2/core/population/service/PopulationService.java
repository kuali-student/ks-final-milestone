...
@WebService(name = "PopulationService", targetNamespace = PopulationServiceConstants.NAMESPACE)
...
public interface PopulationService {
     ...
     * @throws DoesNotExistException populationId not found
     * @throws InvalidParameterException contextInfo is not valid
     * @throws MissingParameterException populationId or contextInfo
     *         is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException authorization failure
     */
     ...
     * @throws InvalidParameterException contextInfo is not valid
     * @throws MissingParameterException populationTypeId or
     *         contextInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException authorization failure
     */
     ...
     * @throws InvalidParameterException contextInfo is not valid
     * @throws MissingParameterException populationRuleId or
     *         contextInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException authorization failure
     */
    ...
    /**
     * Validates a Population. Depending on the value of
     ...
     * identifier is present for the Population and a record is found
     * for that identifier, the validation checks if the Population
     * can be shifted to the new values. If a record cannot be found
     * for the identifier, it is assumed that the record does not
     * exist and as such, the checks performed will be much shallower,
     ...
     * @param populationTypeKey a Population Type
     * @param populationInfo the Population information to be tested
     * @param contextInfo information containing the principalId and
     *        locale information about the caller of service operation
     * @return Results from performing the validation
     * @throws DoesNotExistException validationTypeId or
     *         populationTypeKey is not found
     * @throws InvalidParameterException populationInfo or contextInfo
     *         is not valid
     * @throws MissingParameterException validationTypeKey,
     *         populationTypeKey, populationInfo, or contextInfo is
     *         missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException authorization failure
     */
    public List<ValidationResultInfo> validatePopulation(@WebParam(name = "validationTypeKey") String validationTypeKey, 
                                                         @WebParam(name = "populationTypeKey") String populationTypeKey, 
     ...
     *
     * @param populationTypeKey a Population Type key
     ...
     *         for this operation
     * @throws DoesNotExistException populatiomTypeKey does not exist
     *         or is not supported
     * @throws InvalidParameterException contextInfo or populationInfo
     *         is not valid
     * @throws MissingParameterException populationTypeKey,
     *         populationInfo, or contextInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException authorization failure
     * @throws ReadOnlyException an attempt at supplying information
     *         designated as read-only
     */
    public PopulationInfo createPopulation(@WebParam(name = "populationTypeKey") String populationTypeKey, 
                                           @WebParam(name = "populationInfo") PopulationInfo populationInfo,
                                           @WebParam(name = "contextInfo") ContextInfo contextInfo)
     ...
     * @throws InvalidParameterException populationInfo or contextInfo
     *         is not valid
     * @throws MissingParameterException populationId,
     *         populationInfo, or contextInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException authorization failure
     * @throws ReadOnlyException an attempt at supplying information
     ...
     *
     * @param populationRuleTypeKey a PopulationRule type to be retrieved
     * @param contextInfo information containing the principalId and
     *        locale information about the caller of service operation
     * @return a list of PopulationRule Ids
     * @throws InvalidParameterException contextInfo is not valid
     * @throws MissingParameterException populationRuleTypeKey or
     *         contextInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException authorization failure
     */
    public List<String> getPopulationRuleIdsByType(@WebParam(name = "populationRuleTypeKey") String populationRuleTypeKey,
                                                   @WebParam(name = "contextInfo") ContextInfo contextInfo)
        throws InvalidParameterException,
               MissingParameterException,
               OperationFailedException,
     ...
     * Population is related. (this should probably be multiple even
     * if we constrain it to one).
     *
     ...
     *
     * @param validationTypeKey the identifier of the extent of validation
     * @param populationRuleTypeKey a PopulationRule Type key
     * @param populationRuleInfo the PopulationRule information to be tested
     * @param contextInfo information containing the principalId and
     *        locale information about the caller of service operation
     * @return Results from performing the validation
     * @throws DoesNotExistException validationTypeKey or
     *         populationRuleTypeKey is not found
     * @throws InvalidParameterException populationRuleInfo or
     *         contextInfo is not valid
     * @throws MissingParameterException validationTypeKey,
     *         populationRuleTypeKey, populationRuleInfo, or contextInfo
     *         is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException authorization failure
     */
    public List<ValidationResultInfo> validatePopulationRule(@WebParam(name = "validationTypeKey") String validationTypeKey,
                                                             @WebParam(name = "populationRuleInfo") PopulationRuleInfo populationRuleInfo,
                                                             @WebParam(name = "contextInfo") ContextInfo contextInfo)
        throws DoesNotExistException,
               InvalidParameterException,
               MissingParameterException,
     ...
     * @throws DataValidationErrorException one or more values invalid
     *         for this operation
     * @throws DoesNotExistException populationRuleTypeKey does not
     *         exist or is not supported
     * @throws InvalidParameterException populationRuleInfo or
     *         contextInfo is not valid
     * @throws MissingParameterException populationRuleTypeKey,
     *         populationuleInfo, or contextInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException authorization failure
     * @throws ReadOnlyException an attempt at supplying information
     *         designated as read-only
     */
    public PopulationRuleInfo createPopulationRule(@WebParam(name = "populationRuleTypeKey") String populationRuleTypeKey, 
                                                   @WebParam(name = "populationRuleInfo") PopulationRuleInfo populationRuleInfo,
                                                   @WebParam(name = "contextInfo") ContextInfo contextInfo)
        throws DataValidationErrorException,
               DoesNotExistException,
     ...
     * @param populationRuleInfo the details of updates to
     *        PopulationRule being updated
     * @param contextInfo information containing the principalId and
     *        locale information about the caller of service operation
     ...
     * @throws InvalidParameterException populationRuleInfo or
     *         contextInfo is not valid
     * @throws MissingParameterException populationRuleId,
     *         populationRuleInfo, or contextInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException authorization failure
     * @throws ReadOnlyException an attempt at supplying information
     *         designated as read-only
     ...
     * @throws InvalidParameterException contextInfo is not valid
     * @throws MissingParameterException populationRuleId,
     *         populationId, or contextInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException authorization failure
     */
     ...
     * @throws InvalidParameterException contextInfo is not valid
     * @throws MissingParameterException populationCategoryId or
     *         contextInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException authorization failure
     */
     ...
     * @throws InvalidParameterException contextInfo is not valid
     * @throws MissingParameterException PopulationTypeKey or
     *         contextInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException authorization failure
     */
     ...
     * @return Results from performing the validation
     * @throws DoesNotExistException validationTypeKey or
     *         populationCategoryTypeKey is not found
     * @throws InvalidParameterException populationCategoryInfo or
     *         contextInfo is not valid
     * @throws MissingParameterException validationTypeKey,
     *         populationCategoryTypeKey, populationCategoryInfo, or
     *         contextInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException authorization failure
     */
     ...
     * @throws DataValidationErrorException one or more values invalid
     *         for this operation
     * @throws DoesNotExistException populationCategoryTypeKey is not
     *         found or not supported
     * @throws InvalidParameterException populationCategoryInfo or
     *         contextInfo is not valid
     * @throws MissingParameterException populationCategoryInfo or
     *         contextInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException authorization failure
     * @throws ReadOnlyException an attempt at supplying information
     ...
     * @param populationCategoryInfo the details of updates to
     *        PopulationCategory being updated
     * @param contextInfo information containing the principalId and
     *        locale information about the caller of service operation
     ...
     * @throws InvalidParameterException populationCategoryInfo or
     *         contextInfo is not valid
     * @throws MissingParameterException populationCategoryId,
     *         populationCategoryInfo, or contextInfo is missing or
     *         null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException authorization failure
     * @throws ReadOnlyException an attempt at supplying information
     ...
     * @throws InvalidParameterException contextInfo is not valid
     * @throws MissingParameterException populationId,
     *         populationCategoryId, or contextInfo is missing or null
     * @throws OperationFailedException unable to complete request
     * @throws PermissionDeniedException authorization failure
     */
