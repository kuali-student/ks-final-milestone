 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.dto.enumeration.student.kuali.org}ContextValueDescriptor" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class SupportedContexts {
     ...
     * This is why there is not a <CODE>set</CODE> method for the contextValueDescriptor property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getContextValueDescriptor().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ContextValueDescriptor> getContextValueDescriptor() {
        if (contextValueDescriptor == null) {
            contextValueDescriptor = new ArrayList<ContextValueDescriptor>();
        }
