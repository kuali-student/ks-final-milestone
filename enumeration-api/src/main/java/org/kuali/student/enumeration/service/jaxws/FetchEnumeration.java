...
@XmlRootElement(name = "fetchEnumeration", namespace = "http://student.kuali.org/wsdl/EnumerationService")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "fetchEnumeration", namespace = "http://student.kuali.org/wsdl/EnumerationService", propOrder = {"enumerationKey","enumContextKey","contextValue","contextDate"})
