...
BEGIN
  ...
  select TIMESTAMP '2014-06-01 00:00:00.000' into var_curVerEndDate from dual;
  ...
  UPDATE KSLU_CLU set ST = 'Retired', CURR_VER_END=var_curVerEndDate, EXPIR_DT=var_expDate, LAST_ATP='kuali.atp.2014Spring', VER_NBR = VER_NBR+1
...
BEGIN
  ...
  select TIMESTAMP '2014-09-01 00:00:00.000' into var_curVerEndDate from dual;
  ...
  UPDATE KSLU_CLU set ST = 'Retired', CURR_VER_END=var_curVerEndDate, EXPIR_DT=var_expDate, LAST_ATP='kuali.atp.2014Summer1', VER_NBR = VER_NBR+1
    WHERE OFFIC_CLU_ID = var_offic_clu_id;
