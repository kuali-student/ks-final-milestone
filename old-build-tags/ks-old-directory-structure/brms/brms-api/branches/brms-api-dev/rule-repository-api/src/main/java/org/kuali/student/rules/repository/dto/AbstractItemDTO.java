...
public abstract class AbstractItemDTO implements java.io.Serializable {
     ...
     */
    public AbstractItemDTO(final String name, 
     ...
     */
    public AbstractItemDTO(final String uuid, final String name, final long versionNumber) {
