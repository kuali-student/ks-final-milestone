...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.ConstraintDescriptorInfoHelper.Properties;


public class ConstraintDescriptorInfoMetadata
{
	...
	public void loadChildMetadata (Metadata mainMeta, String type, String state,  RecursionCounter recursions)
	{
		...
		// metadata for serverSide
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.SERVER_SIDE.getKey (), childMeta);
		childMeta.setDataType (Data.DataType.BOOLEAN);
		childMeta.setWriteAccess (Metadata.WriteAccess.ALWAYS);
		if (this.matches (type, state, "(default)", "(default)"))
		{
		...
		// metadata for lookupKey
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.LOOKUP_KEY.getKey (), childMeta);
		childMeta.setDataType (Data.DataType.STRING);
		childMeta.setWriteAccess (Metadata.WriteAccess.ALWAYS);
		if (this.matches (type, state, "(default)", "(default)"))
		{
		...
		// metadata for specialValidatorKey
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.SPECIAL_VALIDATOR_KEY.getKey (), childMeta);
		childMeta.setDataType (Data.DataType.STRING);
		childMeta.setWriteAccess (Metadata.WriteAccess.ALWAYS);
		if (this.matches (type, state, "(default)", "(default)"))
		{
		...
		// metadata for messageKey
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.MESSAGE_KEY.getKey (), childMeta);
		childMeta.setDataType (Data.DataType.STRING);
		childMeta.setWriteAccess (Metadata.WriteAccess.ALWAYS);
		if (this.matches (type, state, "(default)", "(default)"))
		{
		...
		// metadata for dictionaryKey
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.DICTIONARY_KEY.getKey (), childMeta);
		childMeta.setDataType (Data.DataType.STRING);
		childMeta.setWriteAccess (Metadata.WriteAccess.ALWAYS);
		if (this.matches (type, state, "(default)", "(default)"))
		{
