...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.orch.FindProposalHelper.Properties;


public class FindProposalMetadata
{
	...
	public void loadChildMetadata (Metadata mainMeta, String type, String state,  RecursionCounter recursions)
	{
		...
		LookupMetadataBank.setLookups (childMeta, "kuali.proposal.lookup.Proposals");
