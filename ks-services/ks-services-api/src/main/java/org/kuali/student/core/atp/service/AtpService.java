 ...
 * <p>This service supports the management of Academic Time Periods
...
public interface AtpService extends SearchService, DictionaryService {
    ...
    public List<DateRangeInfo> getDateRangesByDate(@WebParam(name="searchDate")Date searchDat, @WebParam(name = "context") ContextInfo contexte) throws InvalidParameterException, MissingParameterException, OperationFailedException;
