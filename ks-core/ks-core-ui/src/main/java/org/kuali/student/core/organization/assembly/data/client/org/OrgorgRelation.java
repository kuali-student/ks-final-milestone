...
public class OrgorgRelation extends ModifiableData implements Serializable{
	private static final long serialVersionUID = 1L;

	public enum Properties implements PropertyEnum {
		ID("id"),TYPE("orgType"),NAME("orgOrgName"),ABBREVIATION("orgAbbr"),DESCRIPTION("orgDesc"),
	...
	public OrgorgRelation(){
	    super(OrgorgRelation.class.getName());
	}
