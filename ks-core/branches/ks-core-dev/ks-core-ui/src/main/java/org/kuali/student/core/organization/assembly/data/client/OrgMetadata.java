...
import org.kuali.student.core.organization.assembly.data.client.OrgHelper.Properties;
...
public class OrgMetadata
{
	...
	public void loadChildMetadata (Metadata mainMeta, String type, String state,  RecursionCounter recursions)
	{
		...
		// metadata for Abbr
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.ABBR.getKey (), childMeta);
		childMeta.setDataType (Data.DataType.STRING);
		childMeta.setWriteAccess (Metadata.WriteAccess.ALWAYS);
		...
		new OrgVersionsMetadata ().loadChildMetadata (listMeta, type, state, recursions);
