...
public class CoreConverterTest {
    ...
    public void testStatementTreeViewInfo() {
        ...
        Assert.assertEquals(r1.getType(), r2.getTypeKey());
        org.kuali.student.r1.core.statement.dto.StatementTreeViewInfo r1Reconverted = R1R2ConverterUtil.convert(r2, org.kuali.student.r1.core.statement.dto.StatementTreeViewInfo.class);
        Assert.assertEquals(r1Reconverted.getReqComponents().get(0).getState(), r2.getReqComponents().get(0).getStateKey());
        Assert.assertEquals(r1Reconverted.getStatements().get(0).getReqComponents().get(0).getDesc().getPlain(), r2.getStatements().get(0).getReqComponents().get(0).getDescr().getPlain());
        Assert.assertEquals(r1Reconverted.getStatements().get(0).getReqComponents().get(0).getType(), r2.getStatements().get(0).getReqComponents().get(0).getTypeKey());
    }
    
    @Test
    public void testXXX() {
        StatementTreeViewInfo r2 = createStatementTree();
        org.kuali.student.r1.core.statement.dto.StatementTreeViewInfo r1 = R1R2ConverterUtil.convert(r2, org.kuali.student.r1.core.statement.dto.StatementTreeViewInfo.class);
        Assert.assertEquals(r2.getStatements().get(0).getTypeKey(), r1.getStatements().get(0).getType());
    }
    ...
    private static StatementTreeViewInfo createStatementTree() {
        ...
        statementTree.setDescr(getR2RichTextInfoData());
        ...
        subTree1.setDescr(getR2RichTextInfoData());
        ...
        subTree2.setDescr(getR2RichTextInfoData());
    ...
    private static RichTextInfo getR2RichTextInfoData() {
        RichTextInfo r2 = new RichTextInfo();
        r2.setFormatted("R2 Formatted");
        r2.setPlain("R2 Plain");
        return r2;
    }
