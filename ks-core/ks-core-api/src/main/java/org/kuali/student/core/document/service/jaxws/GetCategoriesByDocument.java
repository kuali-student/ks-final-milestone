...
@XmlRootElement(name = "getCategoriesByDocument", namespace = "http://student.kuali.org/wsdl/document")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getCategoriesByDocument", namespace = "http://student.kuali.org/wsdl/document")
