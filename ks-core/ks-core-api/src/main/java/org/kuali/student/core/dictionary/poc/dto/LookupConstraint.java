...
public class LookupConstraint extends BaseConstraint { 
    ...
    private String resultReturnKey; //key of searchResultColumn to map back to this field
    protected List<LookupConstraintParamMapping> lookupParams; //maps fields to search params?
