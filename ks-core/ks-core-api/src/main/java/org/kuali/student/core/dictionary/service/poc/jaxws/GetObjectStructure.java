...
@XmlRootElement(name = "getObjectStructure", namespace = "http://student.kuali.org/wsdl/course")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getObjectStructure", namespace = "http://student.kuali.org/wsdl/course")
