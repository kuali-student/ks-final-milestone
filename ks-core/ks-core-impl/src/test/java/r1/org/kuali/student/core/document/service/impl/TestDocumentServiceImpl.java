...
package r1.org.kuali.student.core.document.service.impl;
...
//        }
    ...
    public void testDocRelationsCrud() throws Exception{
        ...
        try{
        	client.createRefDocRelation(relation.getRefObjectTypeKey(), relation.getRefObjectId(), relation.getDocumentId(), relation.getType(), relation, contextInfo);
        	assertTrue(false);
	    ...
	    RefDocRelationInfo created = client.createRefDocRelation(relation.getRefObjectTypeKey(), relation.getRefObjectId(), relation.getDocumentId(), relation.getType(), relation, contextInfo);
