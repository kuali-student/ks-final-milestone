...
@Daos( { @Dao(value = "org.kuali.student.r2.core.messages.dao.impl.MessageManagementDAOImpl", testDataFile = "classpath:messages-test-beans.xml") })
...
public class MessageServiceImplTest extends AbstractServiceTest{    
    ...
    @Client(value = "org.kuali.student.r2.core.messages.service.impl.MessageServiceImpl")
