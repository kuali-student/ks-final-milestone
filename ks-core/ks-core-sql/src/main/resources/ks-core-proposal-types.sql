...
insert into KSPR_PROPOSAL_TYPE (TYPE_KEY, TYPE_DESC, EFF_DT, EXPIR_DT, NAME) values ('kuali.proposal.type.course.modify', 'A modify course proposal type', {ts '2000-01-01 00:00:00.0'}, {ts '2000-12-31 00:00:00.0'},'Modify Course Proposal');
insert into KSPR_PROPOSAL_TYPE (TYPE_KEY, TYPE_DESC, EFF_DT, EXPIR_DT, NAME) values ('kuali.proposal.type.course.retire', 'A retire course proposal type', {ts '2000-01-01 00:00:00.0'}, {ts '2000-12-31 00:00:00.0'},'Retire Course Proposal');
