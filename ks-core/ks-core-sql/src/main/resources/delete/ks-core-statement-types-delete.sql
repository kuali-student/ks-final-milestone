...
DELETE FROM KSST_RSTMT_RTYP_JN_STMT_TYP WHERE REF_STMT_REL_TYPE_ID = 'clu.recommendedpreparation' AND STMT_TYPE_ID = 'kuali.statement.type.course.recommendedPreparation';
...
DELETE FROM KSST_RSTMT_RTYP_JN_OSUB_TYP WHERE REF_STMT_REL_TYPE_ID = 'clu.recommendedpreparation' AND OBJ_SUB_TYPE_ID = 'course';
...
DELETE FROM KSST_REF_STMT_REL_TYPE WHERE TYPE_KEY = 'clu.recommendedpreparation';
...
DELETE FROM KSST_NL_USAGE_TYPE WHERE TYPE_KEY = 'KUALI.RULE.EXAMPLE';
DELETE FROM KSST_NL_USAGE_TYPE WHERE TYPE_KEY = 'KUALI.RULE.COMPOSITION';
