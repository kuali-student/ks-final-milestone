...
BEGIN
  ...
  IF temp > 0 THEN EXECUTE IMMEDIATE 'ALTER TABLE trv_acct ADD (OBJ_ID VARCHAR2(36))'; 
    END IF;
END;
/
...
BEGIN
  SELECT COUNT(*) INTO temp FROM user_tables WHERE table_name = 'trv_acct';
  IF temp > 0 THEN EXECUTE IMMEDIATE 'ALTER TABLE trv_acct ADD (VER_NBR NUMBER(8) DEFAULT 0)'; 
    END IF;
END;
/
...
BEGIN
  ...
  IF temp > 0 THEN EXECUTE IMMEDIATE 'ALTER TABLE trv_acct_type ADD (OBJ_ID VARCHAR2(36))'; 
    END IF;
END;
/
...
BEGIN
  SELECT COUNT(*) INTO temp FROM user_tables WHERE table_name = 'trv_acct_type';
  IF temp > 0 THEN EXECUTE IMMEDIATE 'ALTER TABLE trv_acct_type ADD (VER_NBR NUMBER(8) DEFAULT 0)'; 
    END IF;
END;
/
...
BEGIN
  ...
  IF temp > 0 THEN EXECUTE IMMEDIATE 'ALTER TABLE trv_acct_fo ADD (OBJ_ID VARCHAR2(36))';
    END IF;
END;
/
...
BEGIN
  SELECT COUNT(*) INTO temp FROM user_tables WHERE table_name = 'trv_acct_fo';
  IF temp > 0 THEN EXECUTE IMMEDIATE 'ALTER TABLE trv_acct_fo ADD (VER_NBR NUMBER(8) DEFAULT 0)'; 
    END IF;
END;
/
...
BEGIN
  ...
  IF temp > 0 THEN EXECUTE IMMEDIATE 'ALTER TABLE trv_acct_ext ADD (OBJ_ID VARCHAR2(36))'; 
    END IF;
END;
/
...
BEGIN
  SELECT COUNT(*) INTO temp FROM user_tables WHERE table_name = 'trv_acct_ext';
  IF temp > 0 THEN EXECUTE IMMEDIATE 'ALTER TABLE trv_acct_ext ADD (VER_NBR NUMBER(8) DEFAULT 0)'; 
    END IF;
END;
/
...
/
--KSCM-560 start
update KRIM_PERM_T set NM = 'Blanket Approve 1' where PERM_ID = '10033'
/
update KRIM_PERM_T set NM = 'Blanket Approve 2' where PERM_ID = '10034'
/
--KSCM-560 end
...
-- 
--KREW_DOC_TYP_ATTR_T
update KREW_DOC_TYP_ATTR_T set DOC_TYP_ID ='3006'  where DOC_TYP_ATTRIB_ID ='2009'
/
update KREW_DOC_TYP_ATTR_T set RULE_ATTR_ID ='1014'  where DOC_TYP_ATTRIB_ID ='2009'
/
insert into KREW_DOC_TYP_ATTR_T 
(DOC_TYP_ATTRIB_ID, DOC_TYP_ID, ORD_INDX, RULE_ATTR_ID)
values ('2010','3047','1','1645')
/

insert into KREW_DOC_TYP_ATTR_T 
(DOC_TYP_ATTRIB_ID, DOC_TYP_ID, ORD_INDX, RULE_ATTR_ID)
values ('2011','3058','1','1645')
/

insert into KREW_DOC_TYP_ATTR_T 
(DOC_TYP_ATTRIB_ID, DOC_TYP_ID, ORD_INDX, RULE_ATTR_ID)
values ('2012','3067','1','1645')
/      

insert into KREW_DOC_TYP_ATTR_T 
(DOC_TYP_ATTRIB_ID, DOC_TYP_ID, ORD_INDX, RULE_ATTR_ID)
values ('2013','3092','1','1645')
/       
   
insert into KREW_DOC_TYP_ATTR_T 
(DOC_TYP_ATTRIB_ID, DOC_TYP_ID, ORD_INDX, RULE_ATTR_ID)
values ('2014','3093','1','1645')
/       

insert into KREW_DOC_TYP_ATTR_T 
(DOC_TYP_ATTRIB_ID, DOC_TYP_ID, ORD_INDX, RULE_ATTR_ID)
values ('2015','3102','1','1645')
/  
insert into KREW_DOC_TYP_ATTR_T 
(DOC_TYP_ATTRIB_ID, DOC_TYP_ID, ORD_INDX, RULE_ATTR_ID)
values ('3009','4001','1','1645')
/          
---KREW_DOC_TYP_PLCY_RELN_T
update KREW_DOC_TYP_PLCY_RELN_T set VER_NBR = 7 where VER_NBR =3
/
insert into KREW_DOC_TYP_PLCY_RELN_T(DOC_PLCY_NM, DOC_TYP_ID, OBJ_ID, PLCY_NM, VER_NBR)
values('ALLOW_UNREQUESTED_ACTION', '3021',sys_guid(), '0', 2)
/

insert into KREW_DOC_TYP_PLCY_RELN_T(DOC_PLCY_NM, DOC_TYP_ID, OBJ_ID, PLCY_NM, VER_NBR)
values('LOOK_FUTURE', '3009',sys_guid(), '1', 10)
/     
--
insert into KRIM_GRP_MBR_T(GRP_ID, GRP_MBR_ID, MBR_ID, MBR_TYP_CD,OBJ_ID, VER_NBR)
values('2000', '1207', 'admin', 'P' ,sys_guid(),1)
/ 

update KRMS_AGENDA_T set TYP_ID = 'T1005' where AGENDA_ID = 'T1000'
/
insert into KRIM_ENTITY_CACHE_T(ENTITY_ID, ENTITY_TYP_CD, FIRST_NM, LAST_NM, OBJ_ID, PRNCPL_ID, PRNCPL_NM, PRSN_NM)
values('1100', 'PERSON', 'admin', 'admin' ,sys_guid(),'admin','admin', 'admin, admin' )
/ 

insert into KREW_RTE_NODE_T(ACTVN_TYP, DOC_TYP_ID, FNL_APRVR_IND, MNDTRY_RTE_IND, NM, RTE_NODE_ID, TYP,VER_NBR)
values('P', '4004', '0', '0' ,'PreRoute','3912', 'org.kuali.rice.kew.engine.node.InitialNode', 1 )
/       
...
ALTER TABLE krms_rule_t MODIFY (prop_id VARCHAR2(40) DEFAULT '' NOT NULL)
/
-- 2nd level prop
...
/
--KSCM-560
update KRIM_ROLE_PERM_T set ROLE_ID = '10001' where ROLE_PERM_ID = '1069'
/
--KSCM-560
update KRIM_ROLE_PERM_T set ROLE_ID = '10002' where ROLE_PERM_ID = '1070'
/
--
-- 2010-01-31.sql
--
...
DECLARE temp NUMBER;
BEGIN
  SELECT COUNT(*) INTO temp FROM USER_TABLES WHERE TABLE_NAME = 'KRMS_CNTXT_VLD_ACTN_T';
  IF temp > 0 THEN EXECUTE IMMEDIATE 'drop table krms_cntxt_vld_actn_t';
      END IF;
END;
/
...
DECLARE temp NUMBER;
BEGIN
  SELECT COUNT(*) INTO temp FROM USER_SEQUENCES WHERE SEQUENCE_NAME = 'KRMS_CNTXT_VLD_ACTN_S';
  IF temp > 0 THEN EXECUTE IMMEDIATE 'drop sequence krms_cntxt_vld_actn_s';
      END IF;
END;
/
...
DECLARE temp NUMBER;
BEGIN
  SELECT COUNT(*) INTO temp FROM USER_TABLES WHERE TABLE_NAME = 'KRMS_CNTXT_VLD_AGENDA_T';
  IF temp > 0 THEN EXECUTE IMMEDIATE 'drop table krms_cntxt_vld_agenda_t';
      END IF;
END;
/
...
DECLARE temp NUMBER;
BEGIN
  SELECT COUNT(*) INTO temp FROM USER_SEQUENCES WHERE SEQUENCE_NAME = 'KRMS_CNTXT_VLD_AGENDA_S';
  IF temp > 0 THEN EXECUTE IMMEDIATE 'drop sequence krms_cntxt_vld_agenda_s';
      END IF;
END;
/
...
DECLARE temp NUMBER;
BEGIN
  SELECT COUNT(*) INTO temp FROM USER_TABLES WHERE TABLE_NAME = 'KRMS_CNTXT_VLD_RULE_T';
  IF temp > 0 THEN EXECUTE IMMEDIATE 'drop table krms_cntxt_vld_rule_t';
      END IF;
END;
/
...
DECLARE temp NUMBER;
BEGIN
  SELECT COUNT(*) INTO temp FROM USER_SEQUENCES WHERE SEQUENCE_NAME = 'KRMS_CNTXT_VLD_RULE_S';
  IF temp > 0 THEN EXECUTE IMMEDIATE 'drop sequence krms_cntxt_vld_rule_s';
      END IF;
END;
/
