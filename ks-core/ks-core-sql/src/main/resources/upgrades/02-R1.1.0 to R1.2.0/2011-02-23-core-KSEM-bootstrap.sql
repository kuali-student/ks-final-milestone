...
insert into KSEMBEDDED.KSEM_ENUM_T (ENUM_KEY, DESCR, EFF_DT, EXPIR_DT, NAME, OBJ_ID, VER_NBR) values ('kuali.lu.adminOrg', 'Organization Types for Clu Admin Org', '2001-02-01 00:00:00.0', null, 'Clu Admin Org Types', '77534766-F76F-D61F-1A1C-FC091CD6E1C8', 1)
/
insert into KSEMBEDDED.KSEM_ENUM_VAL_T (ID, ABBREV_VAL, CD, EFF_DT, EXPIR_DT, SORT_KEY, VAL, ENUM_KEY, OBJ_ID, VER_NBR) values ('b75a9fac-fa91-4cf1-93ee-890189a454f9', 'Curriculum Oversight', 'kuali.adminOrg.type.CurriculumOversight', '2001-02-01 00:00:00.0', null, 0, 'Curriculum Oversight', 'kuali.lu.adminOrg', 'C2EE8902-F36E-7DB6-95B1-31D9CE7DEC2C', 1)
/
insert into KSEMBEDDED.KSEM_ENUM_VAL_T (ID, ABBREV_VAL, CD, EFF_DT, EXPIR_DT, SORT_KEY, VAL, ENUM_KEY, OBJ_ID, VER_NBR) values ('a5d39acc-80d8-4cba-a8bb-13cce6561ab8', 'Administering Org', 'kuali.adminOrg.type.Administration', '2001-02-01 00:00:00.0', null, 0, 'Admistering Org', 'kuali.lu.adminOrg', 'B9635CBC-F773-C9BA-57B0-60277A9F945B', 1)
/
...
/
insert into KSEMBEDDED.KSEM_ENUM_VAL_T (ID, ABBREV_VAL, CD, EFF_DT, EXPIR_DT, SORT_KEY, VAL, ENUM_KEY, OBJ_ID, VER_NBR) values ('91c476ec-89f5-4386-a52f-ab69064d0caa', 'Deployment Unit', 'kuali.adminOrg.type.DeploymentUnit', '2001-02-01 00:00:00.0', null, 0, 'Deployment Unit', 'kuali.lu.adminOrg', '32E1BA4A-C282-48C6-7C09-53C2A28AAC4B', 1)
/
...
/
insert into KSEMBEDDED.KSEM_ENUM_VAL_T (ID, ABBREV_VAL, CD, EFF_DT, EXPIR_DT, SORT_KEY, VAL, ENUM_KEY, OBJ_ID, VER_NBR) values ('67e99363-5be4-4996-aeef-aad3172c314f', 'Institution', 'kuali.adminOrg.type.Institution', '2001-02-01 00:00:00.0', null, 0, 'Institution', 'kuali.lu.adminOrg', '38FB30CE-E9C8-F362-F1CD-3C01AE0FCF67', 1)
/
insert into KSEMBEDDED.KSEM_CTX_T (ID, CTX_KEY, CTX_VAL, OBJ_ID, VER_NBR) values ('9', 'kuali.lu.adminOrg.courseProgramCurriculumOrg', 'default', '26CF642F33B4406AA80E1B2728F39810', 0)
/
insert into KSEMBEDDED.KSEM_CTX_T (ID, CTX_KEY, CTX_VAL, OBJ_ID, VER_NBR) values ('7', 'kuali.lu.adminOrg.courseCurriculumOrg', 'default', 'EDEF94613FC94E0997ABE89742135756', 0)
/
insert into KSEMBEDDED.KSEM_CTX_T (ID, CTX_KEY, CTX_VAL, OBJ_ID, VER_NBR) values ('8', 'kuali.lu.adminOrg.programCurriculumOrg', 'default', '44D6BD7C7149459CA8E87DE10BC65A5A', 0)
/
insert into KSEMBEDDED.KSEM_CTX_JN_ENUM_VAL_T (ENUM_VAL_ID, CTX_ID) values ('b75a9fac-fa91-4cf1-93ee-890189a454f9', '9')
/
insert into KSEMBEDDED.KSEM_CTX_JN_ENUM_VAL_T (ENUM_VAL_ID, CTX_ID) values ('4fa57988-a40c-45c6-8b21-3a419389cc9c', '9')
/
insert into KSEMBEDDED.KSEM_CTX_JN_ENUM_VAL_T (ENUM_VAL_ID, CTX_ID) values ('b75a9fac-fa91-4cf1-93ee-890189a454f9', '7')
/
insert into KSEMBEDDED.KSEM_CTX_JN_ENUM_VAL_T (ENUM_VAL_ID, CTX_ID) values ('4fa57988-a40c-45c6-8b21-3a419389cc9c', '8')
/
