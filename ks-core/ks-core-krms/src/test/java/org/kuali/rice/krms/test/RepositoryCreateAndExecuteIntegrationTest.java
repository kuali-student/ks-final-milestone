...
public class RepositoryCreateAndExecuteIntegrationTest extends AbstractBoTest {
    ...
    static final String CONTEXT1 = "Context1 Nina";
...
// KS        ContextDefinition contextDefintion1 = contextRepository.getContextByNameAndNamespace(CONTEXT1, KSNAMESPACE);        
...
// KS            contextDefintion1 = createContextDefinition(KSNAMESPACE, CONTEXT1, Collections.singletonMap(
// KS                    CONTEXT1_QUALIFIER, CONTEXT1_QUALIFIER_VALUE));
