...
@XmlRootElement(name = "replaceRuleSetSnapshot", namespace = "http://student.kuali.org/wsdl/brms/RuleRepository")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "replaceRuleSetSnapshot", namespace = "http://student.kuali.org/wsdl/brms/RuleRepository", propOrder = {"ruleSetUUID","snapshotName","comment"})

public class ReplaceRuleSetSnapshot {
