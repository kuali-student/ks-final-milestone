...
@XmlRootElement(name = "getRuleSetSnapshot", namespace = "http://student.kuali.org/wsdl/brms/RuleRepository")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getRuleSetSnapshot", namespace = "http://student.kuali.org/wsdl/brms/RuleRepository", propOrder = {"ruleSetUUID","snapshotName"})

public class GetRuleSetSnapshot {
