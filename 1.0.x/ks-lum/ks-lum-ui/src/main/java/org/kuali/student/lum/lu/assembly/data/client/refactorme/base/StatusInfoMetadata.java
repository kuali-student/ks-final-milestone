...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.StatusInfoHelper.Properties;
...
public class StatusInfoMetadata
{
	...
	public void loadChildMetadata (Metadata mainMeta, String type, String state,  RecursionCounter recursions)
	{
		...
		// metadata for success
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.SUCCESS.getKey (), childMeta);
