...
public class OrgOrgRelationTypeInfoHelper
{
	...
	public enum Properties implements PropertyEnum
	{
		...
		REV_NAME ("revName"),
		REV_DESC ("revDesc"),
		ORG_HIERARCHY_KEY ("orgHierarchyKey"),
	...
	private OrgOrgRelationTypeInfoHelper (Data data)
	{
		this.data = data;
	}
	
	public static OrgOrgRelationTypeInfoHelper wrap (Data data)
	{
		if (data == null)
		{
			 return null;
		}
		return new OrgOrgRelationTypeInfoHelper (data);
	}
	...
	{
		data.set (Properties.ORG_HIERARCHY_KEY.getKey (), value);
	}
	
	
	public String getOrgHierarchyKey ()
	{
		return (String) data.get (Properties.ORG_HIERARCHY_KEY.getKey ());
	}
