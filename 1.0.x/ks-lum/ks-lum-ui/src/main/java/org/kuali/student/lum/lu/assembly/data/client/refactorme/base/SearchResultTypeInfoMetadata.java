...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.SearchResultTypeInfoHelper.Properties;


public class SearchResultTypeInfoMetadata
{
	...
	public void loadChildMetadata (Metadata mainMeta, String type, String state,  RecursionCounter recursions)
	{
		...
		// metadata for resultColumns
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.RESULT_COLUMNS.getKey (), childMeta);
		...
		new ResultColumnInfoMetadata ().loadChildMetadata (listMeta, type, state, recursions);
