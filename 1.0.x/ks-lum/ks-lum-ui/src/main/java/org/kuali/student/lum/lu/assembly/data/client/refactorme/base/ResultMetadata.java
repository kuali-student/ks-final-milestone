...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.ResultHelper.Properties;
...
public class ResultMetadata
{
	...
	public void loadChildMetadata (Metadata mainMeta, String type, String state,  RecursionCounter recursions)
	{
		...
		// metadata for resultCell
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.RESULT_CELL.getKey (), childMeta);
		...
		new ResultCellMetadata ().loadChildMetadata (childMeta, type, state, recursions);
