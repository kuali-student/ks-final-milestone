...
public class MilestoneInfoHelper
{
	...
	private MilestoneInfoHelper (Data data)
	{
		this.data = data;
	}
	
	public static MilestoneInfoHelper wrap (Data data)
	{
		if (data == null)
		{
			 return null;
		}
		return new MilestoneInfoHelper (data);
	}
	...
	{
		data.set (Properties.MILESTONE_DATE.getKey (), value);
	}
	
	
	public Date getMilestoneDate ()
	{
		return (Date) data.get (Properties.MILESTONE_DATE.getKey ());
	}
