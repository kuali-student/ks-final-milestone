...
public class MilestoneTypeInfoHelper
{
	...
	private MilestoneTypeInfoHelper (Data data)
	{
		this.data = data;
	}
	
	public static MilestoneTypeInfoHelper wrap (Data data)
	{
		if (data == null)
		{
			 return null;
		}
		return new MilestoneTypeInfoHelper (data);
	}
