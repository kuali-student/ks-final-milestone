...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.OrgPositionRestrictionInfoHelper.Properties;


public class OrgPositionRestrictionInfoMetadata
{
	...
	public void loadChildMetadata (Metadata mainMeta, String type, String state,  RecursionCounter recursions)
	{
		...
		// metadata for orgPersonRelationTypeKey
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.ORG_PERSON_RELATION_TYPE_KEY.getKey (), childMeta);
		childMeta.setDataType (Data.DataType.STRING);
		childMeta.setWriteAccess (Metadata.WriteAccess.ALWAYS);
		if (this.matches (type, state, "(default)", "(default)"))
		{
		...
		// metadata for minNumRelations
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.MIN_NUM_RELATIONS.getKey (), childMeta);
		...
		// metadata for maxNumRelations
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.MAX_NUM_RELATIONS.getKey (), childMeta);
		childMeta.setDataType (Data.DataType.STRING);
		childMeta.setWriteAccess (Metadata.WriteAccess.ALWAYS);
		if (this.matches (type, state, "(default)", "(default)"))
		{
