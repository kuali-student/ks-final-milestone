...
@XmlRootElement(name = "getClusFromCluSet", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getClusFromCluSet", namespace = "http://student.kuali.org/wsdl/lu")

public class GetClusFromCluSet {
