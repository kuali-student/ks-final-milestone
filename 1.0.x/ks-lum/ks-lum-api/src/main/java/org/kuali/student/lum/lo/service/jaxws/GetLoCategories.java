...
@XmlRootElement(name = "getLoCategories", namespace = "http://student.kuali.org/wsdl/lo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getLoCategories", namespace = "http://student.kuali.org/wsdl/lo")

public class GetLoCategories {
