...
@XmlRootElement(name = "createLoResponse", namespace = "http://student.kuali.org/wsdl/lo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "createLoResponse", namespace = "http://student.kuali.org/wsdl/lo")

public class CreateLoResponse {
