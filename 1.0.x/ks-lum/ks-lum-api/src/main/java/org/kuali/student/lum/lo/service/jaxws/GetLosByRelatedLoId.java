...
@XmlRootElement(name = "getLosByRelatedLoId", namespace = "http://student.kuali.org/wsdl/lo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getLosByRelatedLoId", namespace = "http://student.kuali.org/wsdl/lo", propOrder = {"relatedLoId","loLoRelationType"})

public class GetLosByRelatedLoId {
