...
@XmlRootElement(name = "getLoResponse", namespace = "http://student.kuali.org/wsdl/lo")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getLoResponse", namespace = "http://student.kuali.org/wsdl/lo")

public class GetLoResponse {
