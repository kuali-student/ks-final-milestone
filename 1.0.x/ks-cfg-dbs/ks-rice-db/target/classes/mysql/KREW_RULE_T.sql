...
INSERT INTO KREW_RULE_T (ACTVN_DT,ACTV_IND,CUR_IND,DLGN_IND,DOC_TYP_NM,FRC_ACTN,NM,OBJ_ID,RULE_BASE_VAL_DESC,RULE_ID,RULE_TMPL_ID,RULE_VER_NBR,TMPL_RULE_IND,VER_NBR)
  VALUES (STR_TO_DATE( '20100222225442', '%Y%m%d%H%i%s' ),1,1,0,'CluCollaboratorDocument',1,'3CEF703C-3916-76CF-4A2A-041356E1A3CB','B8A98C3A-9491-5823-4823-DB5652DE6031','principal id routing test',1656,1654,0,0,1)
/
