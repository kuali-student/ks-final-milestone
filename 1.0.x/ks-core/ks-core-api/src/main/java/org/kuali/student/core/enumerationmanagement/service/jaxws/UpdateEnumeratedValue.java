...
@XmlRootElement(name = "updateEnumeratedValue", namespace = "http://student.kuali.org/wsdl/EnumerationManagementService")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "updateEnumeratedValue", namespace = "http://student.kuali.org/wsdl/EnumerationManagementService", propOrder = {"enumerationKey","code","enumeratedValue"})
