...
/**
 * Contains meta data about one Rule Element within a business rule. Rule Element can represent a logical operator (AND, OR,
 * XOR, NOT), a parentheses (left or right) or a proposition. If Rule Element type is Proposition then the object has one
 * Rule Proposition associated with it.
 * 
...
public class RuleElement {
     ...
     * @param description
     */
    public RuleElement(RuleElementType operation, Integer ordinalPosition, String name, String description,
            RuleProposition ruleProposition) {
        // this.id = id;
