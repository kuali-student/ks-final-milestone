...
<div class="body">
    ...
    <ul class="chan">
        <li><a class="portal_link" title="Create Hold Issue" href="${ConfigProperties.lum.application.url}/kr-krad/holdIssueInfoController?viewId=holdCreateView&methodToCall=start">Create Hold Issue</a></li>
