...
<div class="body">
    <ul class="chan">
        ...
        <li><a class="portal_link" title="Developer Test Widget" href="${ConfigProperties.lum.application.url}/kr-krad/devTestWidget?viewId=devTestWidgetView&pageId=devTestWidgetPageId&methodToCall=start">Developer Test Widget</a></li>
