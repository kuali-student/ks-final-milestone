...
public interface CommentRpcServiceAsync extends BaseRpcService {
    /**
     ...
     * @throws Exception
     */
    public void getComments(String referenceId, String referenceTypeKey, AsyncCallback<CommentInfo> callback) throws Exception;
    /**
     ...
     * @throws Exception
     */
    public void getCommentsByType(String referenceId, String referenceTypeKey, String commentTypeKey, AsyncCallback<CommentInfo> callback) throws Exception;
