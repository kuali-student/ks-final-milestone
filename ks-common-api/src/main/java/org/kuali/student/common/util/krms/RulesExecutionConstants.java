...
public class RulesExecutionConstants {
    ...
    public static final String PERSON_ID_TERM_NAME = "personId";
    ...
    public static final Term COMPLETED_COURSE_IDS_TERM = new Term(STUDENT_COMPLETED_COURSE_IDS_TERM_NAME);
    public static final Term ENROLLED_COURSE_IDS_TERM = new Term(STUDENT_ENROLLED_COURSE_IDS_TERM_NAME);
    public static final Term STUDENT_DECEASED_TERM = new Term(STUDENT_DECEASED_TERM_NAME);
