...
public final class PropositionParameter extends AbstractDataTransferObject implements PropositionParameterContract {
	...
	@XmlElement(name = PropositionParameter.Elements.ID, required=true)
	private String id;
	@XmlElement(name = PropositionParameter.Elements.PROP_ID, required=true)
	private String propId;
	@XmlElement(name = PropositionParameter.Elements.VALUE, required=true)
	private String value;
	@XmlElement(name = PropositionParameter.Elements.TERM_VALUE, required=true)
	private TermDefinition termValue;
	@XmlElement(name = PropositionParameter.Elements.PARM_TYPE, required=true)
	private String parameterType;
	@XmlElement(name = PropositionParameter.Elements.SEQUENCE, required=true)
	 ...
	 */
    private PropositionParameter(PropositionParameter.Builder builder) {
    ...
    public static class Builder implements PropositionParameterContract, ModelBuilder, Serializable {
        ...
        public static PropositionParameter.Builder create(String id, String propId, String value, String parameterType, Integer sequenceNumber) {
        	return new PropositionParameter.Builder(id, propId, value, parameterType, sequenceNumber);
        }
        ...
        public static PropositionParameter.Builder create(PropositionParameter propositionParameter) {
            ...
            PropositionParameter.Builder builder =  new PropositionParameter.Builder(propositionParameter.getId(), propositionParameter.getPropId(), propositionParameter.getValue(), propositionParameter.getParameterType(), propositionParameter.getSequenceNumber());
        ...
        public static PropositionParameter.Builder create(PropositionParameter.Builder inputBuilder) {
            ...
            PropositionParameter.Builder builder =  new PropositionParameter.Builder(inputBuilder.getId(), inputBuilder.getPropId(), inputBuilder.getValue(), inputBuilder.getParameterType(), inputBuilder.getSequenceNumber());
