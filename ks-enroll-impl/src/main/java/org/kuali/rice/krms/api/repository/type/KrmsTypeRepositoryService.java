...
public interface KrmsTypeRepositoryService {
    ...
    ////
    /**
     * This will create a {@link KrmsTypeDefinition} exactly like the parameter
     * passed in.
     *
     * @param krmsType - KrmsType
     * @throws IllegalArgumentException if the krmsType is +
     * @throws IllegalStateException if the KrmsType already exists in the
     * system
     */
     ...
     * @throws IllegalStateException if the KrmsType does not exist in the
     * system
     */
     ...
     * @return a KRMS KrmsType object with the given id. A null reference is
     * returned if an invalid or non-existant id is supplied.
     */
     ...
     *
     * @return A krms type object with the given namespace and name if one with
     * that name and namespace exists. Otherwise, null is returned.
     *
     * @throws IllegalArgumentException if the given namespaceCode or name is a
     * null or blank value
     * @throws IllegalStateException if multiple krms types exist with the same
     * name and namespace
     */
     ...
     * @throws IllegalArgumentException if the given namespaceCode is a null or
     * blank value
     */
     ...
     * @throws IllegalArgumentException if the given contextId is a null or
     * blank value
     */
     ...
     * @throws IllegalArgumentException if the given agendaTypeId or contextId
     * is a null or blank value
     */
     ...
     * @throws IllegalArgumentException if the given ruleTypeId or contextId is
     ...
     * @throws IllegalArgumentException if the given actionTypeId or contextId
     * is a null or blank value
     */
     ...
     *
     * @param attributeDefinitionId the id of the attribute definition to
     * retrieve
     *
     * @return the attribute definition matching the given id, or null if no
     * corresponding attribute definition could be found with the given id value
     * @throws IllegalArgumentException if the given attributeDefinitionId is a
     * null or blank value
     */
     ...
     *
     * @param namespaceCode the namespace under which to locate the attribute
     * definition
     * @param name the name of the attribute definition to retrieve
     *
     * @return the attribute definition matching the give namespace code and
     * name, or null if no corresponding attribute definition could be located
     *
     * @throws RiceIllegalArgumentException if the given namespaceCode or name
     * is a null or blank value
     */
