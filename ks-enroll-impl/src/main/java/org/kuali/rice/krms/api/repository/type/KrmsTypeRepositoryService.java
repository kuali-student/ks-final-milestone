...
public interface KrmsTypeRepositoryService {
   ...
   /**
     ...
     * @param sequenceNumber to search on
     * @return type type relations with that sequence number
     */
    @WebMethod(operationName = "findTypeTypeRelationsBySequenceNumber")
    @WebResult(name = "typeTypeRelations")
    List<TypeTypeRelation> findTypeTypeRelationsBySequenceNumber(@WebParam(name = "sequenceNumber") Integer sequenceNumber)
        throws RiceIllegalArgumentException;
