 ...
 * @see org.kuali.rice.krms.api.repository.proposition.PropositionParameterContract
 */
...
//    	this.compoundSequenceNumber = null;
	...
	/**
     * This builder is used to construct instances of KRMS Proposition.  It enforces the constraints of the {@link org.kuali.rice.krms.api.repository.proposition.PropositionDefinitionContract}.
     */
    public static class Builder implements PropositionDefinitionContract, ModelBuilder, Serializable {
        ...
        /**
         * Creates a builder by populating it with data from the given {@link org.kuali.rice.krms.api.repository.proposition.PropositionDefinitionContract}.
         *
