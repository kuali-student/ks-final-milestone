 ...
 */
public class ScheduleAdjustmentEndTermResolver extends KeyDateTermResolverSupport<String> {
    ...
    public String getOutput() {
        return RulesExecutionConstants.SCHEDULE_ADJUSTMENT_END_TERM.getName();
    }
