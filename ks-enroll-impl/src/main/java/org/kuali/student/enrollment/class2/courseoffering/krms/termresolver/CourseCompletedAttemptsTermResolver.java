 ...
 *
 * This class is a term resolver for retrieving the number of completed
 ...
 */
public class CourseCompletedAttemptsTermResolver implements TermResolver<Integer> {

    @Override
    public String getOutput() {
        return KSKRMSServiceConstants.TERM_RESOLVER_COURSE_COMPLETED_ATTEMPTS;
    }
