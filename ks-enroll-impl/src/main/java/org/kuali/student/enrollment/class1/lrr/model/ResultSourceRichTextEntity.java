...
public class ResultSourceRichTextEntity extends RichTextEntity {

    public ResultSourceRichTextEntity() {}

    public ResultSourceRichTextEntity(String plain, String formatted) {
        this.setFormatted(formatted);
        this.setPlain(plain);
    }

    public ResultSourceRichTextEntity(RichText rt) {
        if (null != rt) {
