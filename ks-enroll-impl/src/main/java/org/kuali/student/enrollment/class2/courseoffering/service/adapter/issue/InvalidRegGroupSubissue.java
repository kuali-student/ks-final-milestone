 ...
 */
public class InvalidRegGroupSubissue implements CourseOfferingAutogenSubIssue {
    String courseOfferingId;
    Set<String> regGroupIds;

    public InvalidRegGroupSubissue(String courseOfferingId) {
    ...
    public String getName() {
        return CourseOfferingAutogenSubIssue.INVALID_REG_GROUPS;
    }
