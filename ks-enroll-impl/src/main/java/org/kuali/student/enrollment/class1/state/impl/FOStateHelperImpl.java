 ...
 */
public class FOStateHelperImpl implements StateHelper {
	
	private static final Logger log = LoggerFactory.getLogger(FOStateHelperImpl.class);
	
    CourseOfferingService courseOfferingService;
    public FOStateHelperImpl() {
    }
    ...
    public String getStateKey(String entityId, ContextInfo context) throws InvalidParameterException, MissingParameterException, DoesNotExistException, OperationFailedException, PermissionDeniedException {
        FormatOfferingInfo fo = getCourseOfferingService().getFormatOffering(entityId, context);
        return fo.getStateKey();
    }
}
