 ...
 * @author nwright
 */
// TODO: KSENROLL-12394 remove when we implement the GES Service replace thise creates with SQL INSERTS
@Deprecated
public class GesServiceDataLoadingDecorator extends GesServiceDecorator {

    public GesServiceDataLoadingDecorator() {
    }

    public GesServiceDataLoadingDecorator(GesService nextDecorator) {
        super();
