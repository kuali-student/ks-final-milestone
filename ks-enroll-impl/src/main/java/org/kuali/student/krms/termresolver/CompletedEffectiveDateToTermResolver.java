...
public class CompletedEffectiveDateToTermResolver implements TermResolver<List<StudentCourseRecordInfo>> {	
    ...
    public String getOutput() {
        return KSKRMSExecutionConstants.COMPLETED_EFFECTIVE_DATE_TO_TERM_NAME;
    }
