...
public class EnrolledCourseCodeTermResolver implements TermResolver<List<CourseRegistrationInfo>> {	
    ...
    public String getOutput() {
        return KSKRMSExecutionConstants.ENROLLED_COURSE_CODE_TERM_NAME;
    }
