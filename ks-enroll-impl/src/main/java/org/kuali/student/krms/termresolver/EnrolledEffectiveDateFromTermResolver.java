...
public class EnrolledEffectiveDateFromTermResolver implements TermResolver<List<CourseRegistrationInfo>> {	
    ...
    public String getOutput() {
        return KSKRMSExecutionConstants.ENROLLED_EFFECTIVE_DATE_FROM_TERM_NAME;
    }
