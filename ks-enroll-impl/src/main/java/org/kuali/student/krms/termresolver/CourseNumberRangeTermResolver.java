...
public class CourseNumberRangeTermResolver implements TermResolver<List<StudentCourseRecordInfo>> {	
    ...
    public String getOutput() {
        return KSKRMSExecutionConstants.COURSE_NUMBER_RANGE_TERM_NAME;
    }
