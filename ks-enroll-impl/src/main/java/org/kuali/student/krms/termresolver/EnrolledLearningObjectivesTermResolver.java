...
public class EnrolledLearningObjectivesTermResolver implements TermResolver<List<CourseRegistrationInfo>> {	
    ...
    public String getOutput() {
        return KSKRMSExecutionConstants.ENROLLED_LEARNING_OBJECTIVES_TERM_NAME;
    }
