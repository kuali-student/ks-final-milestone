...
public class CompletedCourseSetTermResolver implements TermResolver<List<StudentCourseRecordInfo>> {	
    ...
    public String getOutput() {
        return KSKRMSExecutionConstants.COMPLETED_COURSE_SET_TERM_NAME;
    }
