...
public class CompletedLearningObjectivesTermResolver implements TermResolver<List<StudentCourseRecordInfo>> {	
    ...
    public String getOutput() {
        return KSKRMSExecutionConstants.COMPLETED_LEARNING_OBJECTIVES_TERM_NAME;
    }
