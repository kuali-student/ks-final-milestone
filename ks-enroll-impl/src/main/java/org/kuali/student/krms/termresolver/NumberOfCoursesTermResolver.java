...
public class NumberOfCoursesTermResolver implements TermResolver<List<StudentCourseRecordInfo>> {	
    ...
    public String getOutput() {
        return KSKRMSExecutionConstants.NUMBER_OF_COURSES_TERM_NAME;
    }
