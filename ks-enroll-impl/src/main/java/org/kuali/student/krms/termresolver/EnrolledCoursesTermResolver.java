...
public class EnrolledCoursesTermResolver implements TermResolver<List<CourseRegistrationInfo>> {	
    ...
    public String getOutput() {
        return KSKRMSExecutionConstants.ENROLLED_COURSES_TERM_NAME;
    }
