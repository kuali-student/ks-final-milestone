...
public class ProcessIntegrationTestPopulationServiceDataLoadingDecorator extends PopulationServiceDecorator implements PopulationService {

    public ProcessIntegrationTestPopulationServiceDataLoadingDecorator() {
    }

    public ProcessIntegrationTestPopulationServiceDataLoadingDecorator(PopulationService nextDecorator) {
