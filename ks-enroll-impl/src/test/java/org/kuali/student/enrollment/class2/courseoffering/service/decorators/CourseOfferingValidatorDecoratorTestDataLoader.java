...
public class CourseOfferingValidatorDecoratorTestDataLoader extends SearchServiceMockImplAbstractDataLoader {
    ...
    protected void loadData() {
        ...
        row1.put("lu.resultColumn.cluType", LuServiceConstants.COURSE_ACTIVITY_LECTURE_TYPE_KEY);
        ...
        row1.put(ActivityOfferingSearchServiceImpl.SearchResultColumns.AO_TYPE, LuiServiceConstants.LECTURE_ACTIVITY_OFFERING_TYPE_KEY);
        ...
        row2.put(ActivityOfferingSearchServiceImpl.SearchResultColumns.AO_TYPE, LuiServiceConstants.LECTURE_ACTIVITY_OFFERING_TYPE_KEY);
