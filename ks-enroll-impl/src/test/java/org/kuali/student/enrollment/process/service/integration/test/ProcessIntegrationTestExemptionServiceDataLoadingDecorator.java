...
import org.kuali.student.core.exemption.service.decorators.ExemptionServiceDecorator;
 ...
 * @author nwright
 */
public class ProcessIntegrationTestExemptionServiceDataLoadingDecorator extends ExemptionServiceDecorator {

    public ProcessIntegrationTestExemptionServiceDataLoadingDecorator() {
    }

    public ProcessIntegrationTestExemptionServiceDataLoadingDecorator(ExemptionService nextDecorator) {
        super();
    ...
    public void init() {
        ...
        ExemptionRequestInfo request1 = _createRequest(ProcessIntegrationTestConstants.PERSON_ID_JOHNNY_MANNING_2374, context);
        ExemptionInfo exemption1 = this._createCheckExemption(request1, context);

        ExemptionRequestInfo request2 = _createRequest(ProcessIntegrationTestConstants.PERSON_ID_EDDIE_PITTMAN_2406, context);
        Date endDate2;
        try {
        ...
        ExemptionRequestInfo request3 = _createRequest(ProcessIntegrationTestConstants.PERSON_ID_TRACY_BURTON_2132, context);
        Date endDate3;
        try {
    ...
    private ExemptionInfo _createCheckExemption(ExemptionRequestInfo request, ContextInfo context) {
        ...
        info.setCheckId(ProcessIntegrationTestConstants.CHECK_ID_REGISTRATION_PERIOD_IS_OPEN);
        try {
    ...
    private ExemptionInfo _createMilestoneDateExemption(ExemptionRequestInfo request, Date endDate, ContextInfo context) {
        ...
        info.setName(request.getName());
        info.setProcessKey(ProcessServiceConstants.PROCESS_KEY_ELIGIBILITY_FOR_TERM);
        info.setCheckId(ProcessIntegrationTestConstants.CHECK_ID_REGISTRATION_PERIOD_IS_NOT_CLOSED);
