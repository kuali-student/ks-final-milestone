...
INSERT INTO KSPL_LRNG_PLAN (ID, OBJ_ID, VER_NBR, STUDENT_ID,  TYPE_ID, CREATEID, CREATETIME, DESCR_FORMATTED, DESCR_PLAIN,NAME ) values ('lp3', 'obj-lp3', 0, 'student2', 'kuali.academicplan.type.plan', 'student2', {ts '2012-01-02 00:00:00.0'}, '<p>Student 2 Learning Plan 3</p>',  'Student 2 Learning Plan 3','plan3 name');
INSERT INTO KSPL_LRNG_PLAN (ID, OBJ_ID, VER_NBR, STUDENT_ID,  TYPE_ID, CREATEID, CREATETIME, DESCR_FORMATTED, DESCR_PLAIN,NAME ) values ('lp4', 'obj-lp4', 0, 'student2', 'kuali.academicplan.type.plan', 'student2', {ts '2012-02-03 00:00:00.0'}, '<p>Student 2 Learning Plan 4</p>',  'Student 2 Learning Plan 4','plan4 name');
...
INSERT INTO KSPL_LRNG_PLAN_ITEM (ID, VER_NBR, REF_OBJ_ID, REF_OBJ_TYPE_KEY, TYPE_ID, CATEGORY, PLAN_ID, CREATEID, CREATETIME, DESCR_FORMATTED, DESCR_PLAIN, NAME) VALUES ('lp1-i1', 0, '006476b5-18d8-4830-bbb6-2bb9e79600fb', 'kuali.lu.type.CreditCourse', 'kuali.academicplan.type.item.course', 'WISHLIST', 'lp1', 'student1', {ts '2012-01-01 00:00:00.0'}, '<p>Comment 1</p>',  'Comment 1', 'lp1-i1 name');
INSERT INTO KSPL_LRNG_PLAN_ITEM (ID, VER_NBR, REF_OBJ_ID, REF_OBJ_TYPE_KEY, TYPE_ID, CATEGORY, PLAN_ID, CREATEID, CREATETIME, DESCR_FORMATTED, DESCR_PLAIN, NAME ) VALUES ('lp1-i1.x', 0, '006476b5-18d8-4830-bbb6-2bb9e79600fb', 'kuali.lu.type.NonCreditCourse', 'kuali.academicplan.type.item.course', 'WISHLIST', 'lp1', 'student1', {ts '2012-01-01 00:00:00.0'}, '<p>Comment 1.x</p>',  'Comment 1.x', 'lp1-i1.x name');
...
INSERT INTO KSPL_LRNG_PLAN_ITEM (ID, VER_NBR, REF_OBJ_ID, REF_OBJ_TYPE_KEY, TYPE_ID, CATEGORY, PLAN_ID, CREATEID, CREATETIME, DESCR_FORMATTED, DESCR_PLAIN, NAME ) VALUES ('lp1-i6', 0, '00edd03d-d7c0-4151-b7f0-8977951c75bd', 'kuali.lu.type.CreditCourse', 'kuali.academicplan.type.item.course', 'PLANNED', 'lp1', 'student1', {ts '2012-01-01 00:00:00.0'}, '<p>Very Important</p>',  'Very Important','lp1-i6 name');
...
INSERT INTO KSPL_LRNG_PLAN_ITEM (ID, VER_NBR, REF_OBJ_ID, REF_OBJ_TYPE_KEY, TYPE_ID, CATEGORY, PLAN_ID, CREATEID, CREATETIME, DESCR_FORMATTED, DESCR_PLAIN, NAME) VALUES ('lp3-i2', 0, '008739f0-8e62-4f98-88d1-30e6ac779b11', 'kuali.lu.type.CreditCourse', 'kuali.academicplan.type.item.course', 'WISHLIST', 'lp3', 'student2', {ts '2012-01-01 00:00:00.0'}, '<p>Maybe Spring 13</p>',  'Maybe Spring 13', 'lp3-i3 name');
...
INSERT INTO KSPL_LRNG_PLAN_ITEM (ID, VER_NBR, REF_OBJ_ID, REF_OBJ_TYPE_KEY, TYPE_ID, CATEGORY, PLAN_ID, CREATEID, CREATETIME, DESCR_FORMATTED, DESCR_PLAIN, NAME) VALUES ('lp4-i1', 0, '0099ce3a-0fe8-4586-96b6-c42f6db7c11e', 'kuali.lu.type.CreditCourse', 'kuali.academicplan.type.item.course', 'WHATIF', 'lp4', 'student2', {ts '2012-01-01 00:00:00.0'}, '<p>Comment 2</p>',  'Comment 2', 'lp4-i2 name');
