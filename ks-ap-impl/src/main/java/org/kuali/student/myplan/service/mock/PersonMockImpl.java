...
public class PersonMockImpl extends TransientBusinessObjectBase implements Person {
	...
	protected String entityId="1100";
	protected String entityTypeCode="PERSON";
	// name data
	protected String firstName = "admin";
	protected String middleName = "";
	protected String lastName = "admin";

	protected String name = "admin admin";
	// address data
	...
	// email data
	protected String emailAddress = "test@email.edu";
	// phone data
	...
	protected String campusCode = "BL";
	//protected Campus campus;
	// external identifier data
	protected Map<String,String> externalIdentifiers = null;
	// employment data
	protected String employeeStatusCode = "T";
	protected EntityEmploymentStatusBo employeeStatus;
	protected String employeeTypeCode = "T";
	protected EntityEmploymentTypeBo employeeType;
	protected String primaryDepartmentCode = "BL-BL";
	protected String employeeId = "0000000102";

	protected KualiDecimal baseSalaryAmount = KualiDecimal.ZERO;
	protected boolean active = true;

	public PersonMockImpl() {}

	public PersonMockImpl(Principal principal, String personEntityTypeCode) {
		this( principal, null, personEntityTypeCode );
	}

	public PersonMockImpl(Principal principal, EntityDefault entity, String personEntityTypeCode) {
		setPrincipal( principal, entity, personEntityTypeCode );
	}

	public PersonMockImpl(String principalId, String personEntityTypeCode) {
		this( getIdentityService().getPrincipal(principalId), personEntityTypeCode );
	}

	public PersonMockImpl(EntityDefaultInfoCacheBo p) {
		entityId = "1100";
		principalId = "admin";
		principalName = "admin";
		entityTypeCode = null;
		...
		name = "admin admin";
		campusCode = "BL";
		primaryDepartmentCode = "BL-BL";
		employeeId = "0000000102";
