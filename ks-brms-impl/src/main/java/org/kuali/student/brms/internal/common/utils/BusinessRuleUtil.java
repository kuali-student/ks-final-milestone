...
public class BusinessRuleUtil {
     ...
     */
    public static String createFunctionalString(BusinessRuleInfo rule) {

        Collection<RuleElementInfo> ruleElements = rule.getBusinessRuleElementList();
     ...
     * @return
     */
    public static String createAdjustedRuleFunctionString(BusinessRuleInfo rule) {
     ...
     */
    public static Map<String, RulePropositionInfo> getRulePropositions(BusinessRuleInfo rule) {
