...
public class DocumentationMojo extends DataModelTaskMojo {
	 ...
	 * 
	 * @parameter property="outputDir" expression="${project.build.directory}/generated-docs/impex"
	 */
	 ...
	 * 
	 * @parameter property="reportFile" expression="../../impex/report.${project.artifact.artifactId}.doc.generation"
	 */
	@SuppressWarnings("unused")
	 ...
	 * 
	 * @parameter property="contextPropertiesPath" expression="${project.build.directory}/impex/context.doc.properties"
	 */
	@SuppressWarnings("unused")
	...
	protected PropertiesConfiguration getMojoContextProperties() {
		...
		configuration.addProperty(OUTPUT_FORMAT_CONTEXT_PROPERTY, getOutputFormat());
