...
@XmlRootElement(name = "createBulkRelationshipsForPerson", namespace = "http://student.kuali.org/poc/wsdl/learningunit/luipersonrelation")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "createBulkRelationshipsForPerson", namespace = "http://student.kuali.org/poc/wsdl/learningunit/luipersonrelation")

public class CreateBulkRelationshipsForPerson {

    @XmlElement(name = "personId")
    private java.lang.String personId;
    @XmlElement(name = "luiIdList")
    private java.util.List<String> luiIdList;
    ...
    public java.util.List<String> getLuiIdList() {
        return this.luiIdList;
    }
    
    public void setLuiIdList( java.util.List<String> newLuiIdList ) {
