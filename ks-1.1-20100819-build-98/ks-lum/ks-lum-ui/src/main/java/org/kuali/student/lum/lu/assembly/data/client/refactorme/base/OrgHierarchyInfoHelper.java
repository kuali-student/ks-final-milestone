...
public class OrgHierarchyInfoHelper
{
	...
	private OrgHierarchyInfoHelper (Data data)
	{
		this.data = data;
	}
	
	public static OrgHierarchyInfoHelper wrap (Data data)
	{
		if (data == null)
		{
			 return null;
		}
		return new OrgHierarchyInfoHelper (data);
	}
	...
	{
		data.set (Properties.ROOT_ORG_ID.getKey (), value);
	}
	
	
	public String getRootOrgId ()
	{
		return (String) data.get (Properties.ROOT_ORG_ID.getKey ());
	}
