...
public class RuleExecutionServiceImpl implements RuleExecutionService {
	...
	private RuleSetInfo getRuleSet(BusinessRuleInfo businessRule, String ruleSetUUID) 
		...
		if (businessRule.getState().equals(BusinessRuleStatus.ACTIVE.toString())) {
    		...
    		ruleSet = this.ruleRespositoryService.getRuleSetSnapshot(ruleSetUUID, SnapshotName);
    	} else {
    		ruleSet = this.ruleRespositoryService.getRuleSet(ruleSetUUID);
    	}
		return ruleSet;
	}
    ...
    private FactResultInfo findFact(String factTypeKey, FactStructureInfo fs) throws OperationFailedException, DoesNotExistException {
    	...
    	FactResultInfo factResult = this.factFinderService.getFact(factTypeKey, fs);
    	return factResult;
    }
    ...
    private FactTypeInfo findFactType(String factTypeKey) throws OperationFailedException, DoesNotExistException {
		...
		FactTypeInfo factType = this.factFinderService.getFactType(factTypeKey);
		return factType;
    }
		...
		throws DoesNotExistException, InvalidParameterException, MissingParameterException, OperationFailedException
	{
    	...
    	List<BusinessRuleInfo> businessRuleInfoList = this.ruleManagementService.getBusinessRuleByAnchorList(businessRuleAnchorInfoList);
		...
		throws DoesNotExistException, InvalidParameterException, MissingParameterException, OperationFailedException 
	{
    	...
    	BusinessRuleInfo businessRule = this.ruleManagementService.getDetailedBusinessRuleInfo(businessRuleId);
		...
		throws DoesNotExistException, InvalidParameterException, MissingParameterException, OperationFailedException 
	{
    	...
    	// Retrieve business rule
    	BusinessRuleInfo businessRule = this.ruleManagementService.fetchDetailedBusinessRuleInfo(businessRuleId);
		addRuleSet(businessRule);
    ...
    public ExecutionResultInfo executeBusinessRuleTest(final BusinessRuleInfo businessRule, final Map<String,String> exectionParamMap)
		...
		RuleSetInfo ruleSet = this.ruleRespositoryService.translateBusinessRule(businessRule);
