...
public class SimpleStorageServiceWagon extends AbstractWagon {
	...
	protected void showAuthenticationInfo(AuthenticationInfo ai) {
		StringBuffer sb = new StringBuffer();
		sb.append("------------------------------------------\n");
		sb.append("username=" + ai.getUserName() + "\n");
		sb.append("password=" + ai.getPassword() + "\n");
		sb.append("passphrase=" + ai.getPassphrase() + "\n");
		sb.append("privateKey=" + ai.getPrivateKey() + "\n");
		sb.append("------------------------------------------\n");
