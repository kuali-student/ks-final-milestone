...
INSERT INTO KSST_RICH_TEXT_T (ID, FORMATTED, PLAIN) VALUES ('KSST_REQ_COM.DESC.9', '<p>Requirement Component 9</p>', 'Req Comp 9')
...
INSERT INTO KSST_STMT (ID, CREATEID, CREATETIME, UPDATEID, UPDATETIME, VERSIONIND, NAME, RT_DESCR_ID, ST, OPERATOR, PARENT_STMT_ID,STMT_TYPE_ID) VALUES ('PROGREQ-1', 'CREATEID', {ts '2000-01-01 00:00:00.0'}, 'UPDATEID', {ts '2001-01-01 00:00:00.0'},1,'PROGREQ STMT TV 1','KSST_STMT.DESC.14','ACTIVE','OR',null,'kuali.luStatementType.prereqAcademicReadiness')
