...
@XmlRootElement(name = "isCluInCluSet", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "isCluInCluSet", namespace = "http://student.kuali.org/wsdl/lu", propOrder = {"cluId","cluSetId"})
