...
@XmlRootElement(name = "getCluLoRelationTypesResponse", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getCluLoRelationTypesResponse", namespace = "http://student.kuali.org/wsdl/lu")

public class GetCluLoRelationTypesResponse {
    ...
    public void setReturn(java.util.List<CluLoRelationTypeInfo> new_return)  {
