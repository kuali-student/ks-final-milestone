...
public class OrgSearchAttribute extends KualiXmlSearchableAttributeImpl {
    ...
    // TODO: RICE=M9 UPGRADE check that replacing getDocumentAttributes with extractDocumentAttributes is really the intended
    // behavior
        ...
        for (DocumentAttribute value : attributeValues) {
            ...
            if (orgId != null) {
                try {
                    ...
                    OrgInfo orgInfo = orgService.getOrg(orgId, null);
