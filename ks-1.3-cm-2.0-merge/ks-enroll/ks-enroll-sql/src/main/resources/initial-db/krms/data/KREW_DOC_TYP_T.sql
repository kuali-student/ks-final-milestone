...
INSERT INTO KREW_DOC_TYP_T (ACTV_IND,BLNKT_APPR_GRP_ID,CUR_IND,DOC_HDLR_URL,DOC_TYP_DESC,DOC_TYP_ID,DOC_TYP_NM,DOC_TYP_VER_NBR,GRP_ID,LBL,OBJ_ID,PARNT_ID,POST_PRCSR,RTE_VER_NBR,VER_NBR)
        values ('1','1','1','${kr.krad.url}/maintenance?methodToCall=docHandler','Create a KRMS Term','3034','TermMaintenanceDocument','0','1','KRMS Term Maintenance Document','bc83f80b-85c4-40fd-998c-ef53fdd97e3f','2681','org.kuali.rice.krad.workflow.postprocessor.KualiPostProcessor','2','0')
/
