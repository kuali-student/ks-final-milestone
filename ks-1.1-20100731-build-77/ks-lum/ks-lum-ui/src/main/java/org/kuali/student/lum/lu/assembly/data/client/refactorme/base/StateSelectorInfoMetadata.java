...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.StateSelectorInfoHelper.Properties;


public class StateSelectorInfoMetadata
{
	...
	public void loadChildMetadata (Metadata mainMeta, String type, String state,  RecursionCounter recursions)
	{
		...
		new FieldSelectorInfoMetadata ().loadChildMetadata (listMeta, type, state, recursions);
