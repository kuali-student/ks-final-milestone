...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.orch.CreditCourseActivityDurationHelper.Properties;


public class CreditCourseActivityDurationMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "CreditCourseActivityDurationMetadata");
		
		Metadata childMeta;
		Metadata listMeta;
		
		// metadata for TimeUnit
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.TIME_UNIT.getKey (), childMeta);
