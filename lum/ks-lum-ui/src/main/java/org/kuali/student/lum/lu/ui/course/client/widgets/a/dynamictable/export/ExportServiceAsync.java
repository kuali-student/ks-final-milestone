...
/**
 * ExportService async interface
 * @author wilj
 *
 * @param <T> the generic type with which the table structure is associated
 */
public interface ExportServiceAsync<T> {
	public void export(ExportRequest<T> request, AsyncCallback<ExportStatus> callback);

	public void getExportStatus(String exportId, AsyncCallback<ExportStatus> callback);
}
