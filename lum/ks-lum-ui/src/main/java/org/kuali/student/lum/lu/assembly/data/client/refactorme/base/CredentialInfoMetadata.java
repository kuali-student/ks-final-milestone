...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.CredentialInfoHelper.Properties;


public class CredentialInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "CredentialInfoMetadata");
