...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.ProposalDocRelationTypeInfoHelper.Properties;


public class ProposalDocRelationTypeInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "ProposalDocRelationTypeInfoMetadata");
