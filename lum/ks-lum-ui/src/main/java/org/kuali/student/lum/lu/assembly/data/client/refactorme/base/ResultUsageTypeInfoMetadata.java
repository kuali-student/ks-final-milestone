...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.ResultUsageTypeInfoHelper.Properties;


public class ResultUsageTypeInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "ResultUsageTypeInfoMetadata");
