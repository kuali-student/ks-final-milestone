...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.AtpInfoHelper.Properties;


public class AtpInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "AtpInfoMetadata");
