...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.CommentInfoHelper.Properties;


public class CommentInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "CommentInfoMetadata");
		
		Metadata childMeta;
		Metadata listMeta;
		
		// metadata for commentText
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.COMMENT_TEXT.getKey (), childMeta);
