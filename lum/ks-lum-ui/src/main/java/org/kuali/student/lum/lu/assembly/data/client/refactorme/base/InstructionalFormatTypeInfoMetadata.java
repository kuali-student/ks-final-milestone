...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.InstructionalFormatTypeInfoHelper.Properties;


public class InstructionalFormatTypeInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "InstructionalFormatTypeInfoMetadata");
