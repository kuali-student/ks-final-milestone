...
@XmlRootElement(name = "getLuType", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getLuType", namespace = "http://student.kuali.org/wsdl/lu")

public class GetLuType {
