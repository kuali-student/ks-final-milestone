...
@XmlRootElement(name = "getLrScaleTypesForClu", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getLrScaleTypesForClu", namespace = "http://student.kuali.org/wsdl/lu", propOrder = {"cluId","lrTypeKey"})
