...
@XmlRootElement(name = "removeLuStatementFromClu", namespace = "http://student.kuali.org/wsdl/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "removeLuStatementFromClu", namespace = "http://student.kuali.org/wsdl/lu", propOrder = {"cluId","luStatementId"})

public class RemoveLuStatementFromClu {
