...
@XmlRootElement(name = "updateLuiRelationResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "updateLuiRelationResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
