...
@XmlRootElement(name = "deleteLuiRelationResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "deleteLuiRelationResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
