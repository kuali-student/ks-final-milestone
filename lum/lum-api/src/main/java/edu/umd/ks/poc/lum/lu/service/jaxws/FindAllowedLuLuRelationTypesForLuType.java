...
@XmlRootElement(name = "findAllowedLuLuRelationTypesForLuType", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findAllowedLuLuRelationTypesForLuType", namespace = "http://edu.umd.ks/poc/lum/lu")
