...
@XmlRootElement(name = "findSimpleEquivalenciesResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findSimpleEquivalenciesResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
