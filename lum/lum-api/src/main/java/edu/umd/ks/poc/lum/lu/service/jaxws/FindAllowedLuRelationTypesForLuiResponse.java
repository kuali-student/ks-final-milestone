...
@XmlRootElement(name = "findAllowedLuRelationTypesForLuiResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findAllowedLuRelationTypesForLuiResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
