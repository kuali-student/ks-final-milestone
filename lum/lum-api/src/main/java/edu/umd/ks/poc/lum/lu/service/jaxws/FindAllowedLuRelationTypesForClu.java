...
@XmlRootElement(name = "findAllowedLuRelationTypesForClu", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findAllowedLuRelationTypesForClu", namespace = "http://edu.umd.ks/poc/lum/lu")
