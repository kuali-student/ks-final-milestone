...
@XmlRootElement(name = "removeCluFromCluSetResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "removeCluFromCluSetResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
