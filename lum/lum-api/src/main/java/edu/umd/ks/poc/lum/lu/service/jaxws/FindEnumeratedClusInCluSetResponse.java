...
@XmlRootElement(name = "findEnumeratedClusInCluSetResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findEnumeratedClusInCluSetResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
