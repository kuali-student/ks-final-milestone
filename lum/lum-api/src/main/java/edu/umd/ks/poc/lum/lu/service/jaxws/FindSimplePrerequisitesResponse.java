...
@XmlRootElement(name = "findSimplePrerequisitesResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findSimplePrerequisitesResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
