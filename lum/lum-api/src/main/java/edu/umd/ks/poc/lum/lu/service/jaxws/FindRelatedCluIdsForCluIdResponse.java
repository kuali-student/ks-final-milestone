...
@XmlRootElement(name = "findRelatedCluIdsForCluIdResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findRelatedCluIdsForCluIdResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
