...
@XmlRootElement(name = "addSimpleCorequisiteResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "addSimpleCorequisiteResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
