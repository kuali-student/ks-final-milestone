...
@XmlRootElement(name = "addSimpleAntirequisiteResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "addSimpleAntirequisiteResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
