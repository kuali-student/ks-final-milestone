...
@XmlRootElement(name = "addSimpleAntirequisite", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "addSimpleAntirequisite", namespace = "http://edu.umd.ks/poc/lum/lu")
