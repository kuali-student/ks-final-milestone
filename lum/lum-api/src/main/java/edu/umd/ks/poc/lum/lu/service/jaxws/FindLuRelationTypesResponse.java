...
@XmlRootElement(name = "findLuRelationTypesResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findLuRelationTypesResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
