...
@XmlRootElement(name = "findClusFromCluSetResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findClusFromCluSetResponse", namespace = "http://edu.umd.ks/poc/lum/lu")
