...
public class CurriculumManagementConstants {
    ...
    public final static String CANCEL_COURSE_CONFIRMATION_DIALOG = "CM-Cancel-Course-Dialog";
    ...
    public final static String COURSE_ACKNOWLEDGE_CONFIRMATION_DIALOG = "CM-Proposal-Review-Course-Acknowledge-Dialog";
