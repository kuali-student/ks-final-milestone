...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.CluLoRelationInfoHelper.Properties;


public class CluLoRelationInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "CluLoRelationInfoMetadata");
		...
		// metadata for loId
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.LO_ID.getKey (), childMeta);
		childMeta.setDataType (Data.DataType.STRING);
		childMeta.setWriteAccess (Metadata.WriteAccess.ALWAYS);
		if (this.matches (type, state, "(default)", "(default)"))
		{
