...
public interface LprService {
     ...
     * @param personId    Id an identifier for a Person
     ...
     *
     * @param validationType     the identifier for the validation Type
     * @param lprTransactionType the identifier for the
     ...
     * object.
     *
     * @param lprTransactionType the identifier for the Type
    ...
    /**
     * Retrieves a single LprTransactionItem by a LprTransactionItem Id.
     *
     * @param lprTransactionItemId the identifier for the
     *                             LprTransaction to be retrieved
     * @param contextInfo          information containing the principalId and
     ...
     * @throws InvalidParameterException contextInfo is not valid
     * @throws MissingParameterException lprTransactionItemId or
     *                                   contextInfo is missing or null
     * @throws OperationFailedException  unable to complete request
     * @throws PermissionDeniedException an authorization failure occurred
     */
    LprTransactionItemInfo getLprTransactionItem(@WebParam(name = "lprTransactionItemId") String lprTransactionItemId,
                                                 @WebParam(name = "contextInfo") ContextInfo contextInfo)
