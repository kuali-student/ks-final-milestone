...
/**
 * This is denormalized view of a student's activity registrations in a
 * term.
 *
...
public interface ActivityRegistrationDetailDisplay
    ...
    /**
     * The Activity Offering name or title.
     *
     * @name Activity Offering Name
     * @readonly
     */
    public RichText getActivityOfferingName();

    /**
     * The schedule of this activity.
     *
     * @name Activity Schedule
     * @readonly
     */
    public ScheduleDisplay getActivitySchedule();
}
