...
svn move -m "Moving %DB%-impex to %DB%/src/main/impex/datasets/reference" --parents %BASE_URL%/ks-cfg-dbs/%DB%-impex %BASE_URL%/ks-cfg-dbs/%DB%/src/main/impex/datasets/reference
svn move -m "Moving %DB% schema.xml out of the datasets directory" %BASE_URL%/ks-cfg-dbs/%DB%/src/main/impex/datasets/reference/schema.xml %BASE_URL%/ks-cfg-dbs/%DB%/src/main/impex/schema.xml 
