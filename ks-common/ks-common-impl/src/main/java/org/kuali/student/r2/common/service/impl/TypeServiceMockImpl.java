...
//    }
    ...
    private void init() {
        String atpObjectURI = "http://student.kuali.org/wsdl/atp/AtpInfo";
        String milestoneObjectURI = "http://student.kuali.org/wsdl/atp/MilestoneInfo";
        
        List<String[]> typeArrays = new ArrayList<String[]>();
        typeArrays.add(new String[]{"kuali.atp.type.AcademicCalendar", "Academic Calendar", "Academic Calendar", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.HolidayCalendar", "Holiday Calendar", "Holiday Calendar", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.Fall", "Fall", "Fall Semester", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.Spring", "Spring", "Spring Semester", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.FallSpring", "Fall-Spring", "Fall & Spring Semesters", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.AY", "AY", "Full Academic Year", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.FY", "FY", "Fiscal Year", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.Holiday", "Holiday", "Holiday", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.SpringBreak", "SpringBreak", "Spring Break", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.Thanksgiving", "Thanksgiving", "Thanksgiving", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.HalfFall1", "Fall Half-Semester 1", "Fall Half-Semester 1", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.HalfFall2", "Fall Half-Semester 2", "Fall Half-Semester 2", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.HalfSpring1", "Spring Half-Semester 1", "Spring Half-Semester 1", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.HalfSpring2", "Spring Half-Semester 1", "Spring Half-Semester 2", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.Mini-mester1A", "Mini Semester 1A", "Mini Semester 1A", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.Mini-mester1B", "Mini Semester 1B", "Mini Semester 1B", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.Mini-mester2C", "Mini Semester 2C", "Mini Semester 2C", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.Mini-mester2D", "Mini Semester 2D", "Mini Semester 2D", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.Session1", "Session 1", "Session 1", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.Session2", "Session 2", "Session 2", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.SessionG1", "Session G1", "Session G1", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.SessionG2", "Session G2", "Session G2", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.Summer", "Summer", "Summer Semester", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.SummerEve", "Summer Eve", "Summer Eve", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.Winter", "Winter", "Winter", atpObjectURI});
        typeArrays.add(new String[]{"kuali.atp.type.Adhoc", "Ad hoc", "Ad hoc", atpObjectURI});

        //holidays
        typeArrays.add(new String[]{"kuali.atp.milestone.Christmas", "Christmas", "Christmas", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.ChristmasObserved", "Christmas Observed", "Christmas Observed", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.FallBreak", "Fall Break", "Fall Break", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.LaborDay", "Labor Day", "Labor Day", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.IndependenceDay", "Independence Day", "Independence Day", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.IndependenceDayObserved", "Independence Day Observed", "Independence Day Observed", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.MemorialDay", "Memorial Day", "Memorial Day", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.MemorialDayObserved", "Memorial Day Observed", "Memorial Day Observed", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.MLKDay", "Martin Luther King Day", "Martin Luther King Day", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.MLKDayObserved", "MLK Day Observed", "MLK Day Observed", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.NewYearsDay", "New Years Day", "New Years Day", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.NewYearsDayObserved", "New Years Day Observed", "New Years Day Observed", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.PresidentsDay", "Presidents Day", "Presidents Day", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.SpringBreak", "Spring Break", "Spring Break", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.ThanksgivingBreak", "Thanksgiving Break", "Thanksgiving Break", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.VeteransDay", "Veterans Day", "Veterans Day", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.VeteransDayObserved", "Veterans Day Observed", "Veterans Day Observed", milestoneObjectURI});

        //events    -- type_key, name, type_descr, REF_OBJECT_URI
        typeArrays.add(new String[]{"kuali.atp.milestone.FamilyWeekend", "Family Weekend", "Family Weekend", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.Homecoming", "Homecoming", "Homecoming", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.GraduationApplicationDeadline", "Graduation Application Deadline", "Deadline to apply for Graduation", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.AlumniDay", "Alumni Day", "Alumni Day", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.Baccalaureate", "Baccalaureate", "Baccalaureate", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.Commencement", "Commencement", "Commencement", milestoneObjectURI});
        ...
        TypeInfo termGroupType = createTypeInfo("kuali.atp.type.group.term", "Group for Terms", "Group for terms", atpObjectURI);
        ...
        //keydates
        typeArrays.add(new String[]{"kuali.atp.milestone.AdvanceRegistrationPeriod", "Advance Registration Period", "Advance Registration Period", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.RegistrationPeriod", "Registration Period", "Registration Period", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.RegistrationBeginsTransfer", "Registration Begins Transfer", "Registration Begins Transfer", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.DropDeadlineWithoutRecord", "Drop Deadline Without Record", "Drop Deadline Without Record", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.FinalExamPeriod", "Final Exam Period", "Final Exam Period", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.GradesDue", "Grades Due", "Grades Due", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.InstructionalPeriod", "Instructional Period", "Instructional Period", milestoneObjectURI});

        //curriculum
        typeArrays.add(new String[]{"kuali.atp.milestone.CoordinatorsKickoffMeeting", "Coordinators Kickoff Meeting", "Coordinators Kickoff Meeting", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.ProposalPeriod", "Proposal Period", "Proposal Period", milestoneObjectURI});
        typeArrays.add(new String[]{"kuali.atp.milestone.ReviewPeriod", "Review Period", "Review Period", milestoneObjectURI});
        ...
        TypeInfo keydateGroupType = createTypeInfo("kuali.milestone.type.group.keydate", "Group for key dates", "Group for key dates", milestoneObjectURI);
        ...
        TypeInfo curriculumGroupType = createTypeInfo("kuali.milestone.type.group.curriculum", "Curriculum", "Curriculum", milestoneObjectURI);
        ...
        TypeInfo holidayGroupType = createTypeInfo("kuali.milestone.type.group.holiday", "Holidays", "Holidays", milestoneObjectURI);
        ...
        TypeInfo eventGroupType = createTypeInfo("kuali.milestone.type.group.event", "Acal Events", "Acal Events", milestoneObjectURI);
