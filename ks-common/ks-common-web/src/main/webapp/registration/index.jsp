<!doctype html><!--[if lt IE 7]>      <html class="no-js lt-ie9 lt-ie8 lt-ie7"> <![endif]--><!--[if IE 7]>         <html class="no-js lt-ie9 lt-ie8"> <![endif]--><!--[if IE 8]>         <html class="no-js lt-ie9"> <![endif]--><!--[if gt IE 8]><!--><html class="no-js"><!--<![endif]--><head><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title></title><meta name="description" content=""><meta name="viewport" content="width=device-width"><!-- Place favicon.ico and apple-touch-icon.png in the root directory --><link rel="stylesheet" href="styles/1d7769e0.vendor.css"><link rel="stylesheet" href="styles/54f31fb8.main.css"></head><body ng-app="regCartApp"><!--[if lt IE 7]>
    ...
    <![endif]--><script src="scripts/8ac281c0.vendor.js"></script><script src="scripts/033601d3.scripts.js"></script><script>'use strict'; angular.module('configuration', []).value('APP_URL','${ConfigProperties.application.url}/services/');</script>
</body></html>