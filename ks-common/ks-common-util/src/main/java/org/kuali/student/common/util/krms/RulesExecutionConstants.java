...
public class RulesExecutionConstants {
    ...
    public static final Term studentRegistrationHoldsTerm = new Term(STUDENT_REGISTRATION_HOLDS_TERM_NAME);

    public static final String COURSE_SET_ID_TERM_PROPERTY_NAME = "courseSetIdProperty";
    public static final String COURSE_ID_TERM_PROPERTY_NAME = "courseIdProperty";
    public static final String TEST_SET_ID_TERM_PROPERTY = "testSetIdProperty";
    public static final String MILESTONE_ID_TERM_PROPERTY_NAME = "milestoneIdProperty";
