...
@XmlRootElement(name = "getSearchResultType", namespace = "http://student.kuali.org/wsdl/search")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getSearchResultType", namespace = "http://student.kuali.org/wsdl/search")
