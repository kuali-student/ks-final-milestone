...
public class LuServiceImpl implements LuService {
	...
	public List<ValidationResultInfo> validateClu(String validationType,
		...
		// return createValidator().validateTypeStateObject(cluInfo,
		// getObjectStructure("cluInfo"));
	...
	public CluInfo createClu(String luTypeKey, CluInfo cluInfo)
		...
		if (clu.getCampusLocations() == null) {
			clu.setCampusLocations(new ArrayList<CluCampusLocation>());
		}
		...
		if (clu.getAccreditations() == null) {
			clu.setAccreditations(new ArrayList<CluAccreditation>());
		}
	...
	public List<ValidationResultInfo> validateCluCluRelation(
		...
		// return createValidator().validateTypeStateObject(cluCluRelationInfo,
		// getObjectStructure("cluCluRelationInfo"));
		return null;
	}
	...
	public CluSetInfo updateCluSet(String cluSetId, CluSetInfo cluSetInfo)
		...
		if (!cluSet.isCriteriaSet()) {
			...
			Set<String> newCluSetIds = new HashSet<String>(cluSetInfo
					.getCluSetIds());
			for (Iterator<CluSet> i = cluSet.getCluSets().iterator(); i
					.hasNext();) {
	...
	public StatusInfo removeCluSetFromCluSet(String cluSetId,
		...
		if (cluSet.isCriteriaSet()) {
			throw new UnsupportedActionException(
					"Cannot remove a CluSet from a Dynamic CluSet");
		}
	...
	public StatusInfo addCluToCluSet(String cluId, String cluSetId)
		...
		if (cluSet.isCriteriaSet()) {
			throw new UnsupportedActionException(
					"Cannot add a Clu to a Dynamic CluSet");
		}
	...
	public StatusInfo removeCluFromCluSet(String cluId, String cluSetId)
		...
		if (cluSet.isCriteriaSet()) {
			throw new UnsupportedActionException(
					"Cannot remove a Clu from a Dynamic CluSet");
		}
