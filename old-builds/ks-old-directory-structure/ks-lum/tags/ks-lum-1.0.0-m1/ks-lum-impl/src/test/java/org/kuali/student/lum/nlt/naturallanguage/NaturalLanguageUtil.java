...
//		type.setHeaders(createHeaders());
    ...
    public static LuNlStatementInfo getComplexLuNlStatementInfo2() {
		...
		List<ReqCompFieldInfo> fieldList1 = NaturalLanguageUtil.createReqComponentFields("0", "greater_than_or_equal_to", "reqCompFieldType.cluSet", "CLUSET-NL-1");
		ReqComponentInfo r1 = NaturalLanguageUtil.createReqComponent("kuali.reqCompType.courseList.none", fieldList1);
		r1.setId("req-1");
		List<ReqCompFieldInfo> fieldList2 = NaturalLanguageUtil.createReqComponentFields("1", "greater_than_or_equal_to", "reqCompFieldType.cluSet", "CLUSET-NL-1");
		ReqComponentInfo r2 = NaturalLanguageUtil.createReqComponent("kuali.reqCompType.courseList.nof", fieldList2);
		r2.setId("req-2");
		List<ReqCompFieldInfo> fieldList3 = NaturalLanguageUtil.createReqComponentFields("0", "greater_than_or_equal_to", "reqCompFieldType.cluSet", "CLUSET-NL-2");
		ReqComponentInfo r3 = NaturalLanguageUtil.createReqComponent("kuali.reqCompType.courseList.none", fieldList3);
		r3.setId("req-3");
		List<ReqCompFieldInfo> fieldList4 = NaturalLanguageUtil.createReqComponentFields("1", "greater_than_or_equal_to", "reqCompFieldType.cluSet", "CLUSET-NL-2");
		ReqComponentInfo r4 = NaturalLanguageUtil.createReqComponent("kuali.reqCompType.courseList.nof", fieldList4);
		r4.setId("req-4");
		List<ReqCompFieldInfo> fieldList5 = NaturalLanguageUtil.createReqComponentFields("3", "greater_than_or_equal_to", "reqCompFieldType.cluSet", "CLUSET-NL-2");
		ReqComponentInfo r5 = NaturalLanguageUtil.createReqComponent("kuali.reqCompType.courseList.all", fieldList5);
		r5.setId("req-5");
		List<ReqCompFieldInfo> fieldList6 = NaturalLanguageUtil.createReqComponentFields("1", "greater_than_or_equal_to", "reqCompFieldType.cluSet", "CLUSET-NL-3");
		ReqComponentInfo r6 = NaturalLanguageUtil.createReqComponent("kuali.reqCompType.courseList.nof", fieldList6);
		r6.setId("req-6");
		List<ReqCompFieldInfo> fieldList7 = NaturalLanguageUtil.createReqComponentFields("2", "greater_than_or_equal_to", "reqCompFieldType.cluSet", "CLUSET-NL-2");
		ReqComponentInfo r7 = NaturalLanguageUtil.createReqComponent("kuali.reqCompType.courseList.nof", fieldList7);
		r7.setId("req-7");
		List<ReqCompFieldInfo> fieldList8 = NaturalLanguageUtil.createReqComponentFields("4", "greater_than_or_equal_to", "reqCompFieldType.clu", "CLU-NL-2, CLU-NL-3, CLU-NL-4, CLU-NL-5");
		ReqComponentInfo r8 = NaturalLanguageUtil.createReqComponent("kuali.reqCompType.courseList.all", fieldList8);
		r8.setId("req-8");
