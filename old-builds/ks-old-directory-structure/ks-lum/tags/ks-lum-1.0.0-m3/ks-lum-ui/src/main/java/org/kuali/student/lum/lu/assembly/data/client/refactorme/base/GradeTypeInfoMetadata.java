...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.GradeTypeInfoHelper.Properties;


public class GradeTypeInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "GradeTypeInfoMetadata");
