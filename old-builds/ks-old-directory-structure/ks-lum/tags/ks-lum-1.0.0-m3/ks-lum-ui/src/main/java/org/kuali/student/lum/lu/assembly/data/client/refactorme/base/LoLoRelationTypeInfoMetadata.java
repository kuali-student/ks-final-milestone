...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.LoLoRelationTypeInfoHelper.Properties;


public class LoLoRelationTypeInfoMetadata
{
	...
	{
		int recurseLevel = increment (recursions, "LoLoRelationTypeInfoMetadata");
