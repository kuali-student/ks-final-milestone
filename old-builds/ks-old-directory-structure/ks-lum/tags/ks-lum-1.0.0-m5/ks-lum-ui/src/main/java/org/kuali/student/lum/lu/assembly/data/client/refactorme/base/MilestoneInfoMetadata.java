...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.MilestoneInfoHelper.Properties;


public class MilestoneInfoMetadata
{
	...
	public void loadChildMetadata (Metadata mainMeta, String type, String state,  RecursionCounter recursions)
	{
		...
		// metadata for milestoneDate
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.MILESTONE_DATE.getKey (), childMeta);
		...
		if (this.matches (type, state, "(default)", "(default)"))
		{
			...
			childMeta.getConstraints ().add (ConstraintMetadataBank.BANK.get ("milestone.types"));
		}
