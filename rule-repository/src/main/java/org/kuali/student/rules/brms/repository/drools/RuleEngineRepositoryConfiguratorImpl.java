...
public class RuleEngineRepositoryConfiguratorImpl 
     ...
     * 
     * @see org.kuali.student.rules.brms.repository.drools.RuleEngineRepositoryConfigurator#getJCRRepository(java.net.URL)
     */
     ...
     * Creates and gets a JCR repository.
     * 
     * @see org.kuali.student.rules.brms.repository.drools.RuleEngineRepositoryConfigurator#getJCRRepository(java.net.URL, java.net.URL)
     */
