...
public class BRMSRepositoryDroolsImpl implements BRMSRepository 
{
		...
		throws BRMSRepositoryException
    {
        ...
        {
        	throw new BRMSRepositoryException( "Loading child categories failed: " +
        			"categoryPath=" + categoryPath, e );
        }
    }
		...
		throws BRMSRepositoryException
    {
        ...
        {
        	throw new BRMSRepositoryException( "Creating category failed: " +
        			"path=" + path, e );
        }
    }

	/**
	 * Creates a new rule n a rule set. It will be saved, but not checked in.
	 * The initial state will be set to draft state.
	 * 
	 * @param ruleSetUuid Rule set uuid
	 * @param ruleName Rule name
	 * @param description Rule description
	 * @param ruleContent Rule code content
	 * @param category Cateogry to add rule under
	 * @return Rule set uuid
	 * @throws BRMSRepositoryException
	 */
    public String createRule( String ruleSetUuid,
							  String ruleName,
							  String description,
							  String ruleContent,
							  String category ) 
		    	throws BRMSRepositoryException
    {
        ...
        catch ( RulesRepositoryException e ) 
        {
        	...
        	{
        		throw new BRMSRepositoryException( "Creating new rule failed - " +
        				"Duplicate rule: ruleName=" + ruleName, e );
        	} 
        	else 
        	{
        		throw new BRMSRepositoryException( "Creating new rule failed: " +
     ...
     * @throws BRMSRepositoryException
     */
    public void checkinRule( Rule rule, String comment )
		throws BRMSRepositoryException
	{
...
System.out.println( "\n\n***********************************************************\n\n" );
	 ...
	 * @param assetUUID rule or rule set uuid
		...
		throws BRMSRepositoryException 
	{
        ...
        {
        	throw new BRMSRepositoryException( "Restoring version failed: " +
        			"oldVersionUUID=" + oldVersionUUID + 
        			", newVersionUUID=" + newVersionUUID, e );
        }

	}

	/**
	 * Exports the rules repository as a zip file 
	 * container an XML repository file.
	 * 
	 * @param filename E.g. repository_export.xml.zip
	 * @return A zip file
	 * @throws BRMSRepositoryException
	 */
		...
		throws BRMSRepositoryException 
	{
    	...
    	{
			throw new BRMSRepositoryException( 
					"Exporting repository failed: " + e.getMessage(), e );
    	}
	}
	 ...
	 * 
	 * @param filename E.g. repository_export.xml
	 ...
	 * 
	 * @param byteArray Byte array (XML file) - E.g. an repository_export.xml
	 * @throws BRMSRepositoryException
	 */
	 ...
	 * @throws BRMSRepositoryException
	 */
    public String createRuleSet( String name, String description )
		throws BRMSRepositoryException 
	{
    	if ( name == null || name.trim().length() == 0 )
    	{
    ...
    /**
     * Adds a fact to a rule set. 
     * E.g. in Drools: import java.util.Calendar
     * 
     * @param ruleSetUuid Rule set uuid
     * @param fact A java class
     * @throws BRMSRepositoryException
     */
	public void setFactsToRuleSet( String ruleSetUuid, String fact )
		throws BRMSRepositoryException 
    {
        try 
        {
	 ...
	 * 
	 * @param uuid Rule uuid
	 * @param newState New rule status
	 * @throws BRMSRepositoryException
	 */
	 ...
	 * @param replaceExisting Replace existing snapshot
	 * @param comment Comments for creating the snapshot
	 * @throws BRMSRepositoryException
	 */
    public void createRuleSetSnapshot( String ruleSetName, String snapshotName,
		...
		throws BRMSRepositoryException 
    {
    	...
    	try 
        {
			...
			PackageItem item = this.repository.loadPackageSnapshot( ruleSetName,
					snapshotName );
        ...
        {
        	throw new BRMSRepositoryException( "Creating rule set snapshot failed: " +
        			"ruleSetName=" + ruleSetName + ", snapshotName=" + snapshotName, e );
        }
	}
    	...
    	throws BRMSRepositoryException 
    {
        ...
        {
            throw new BRMSRepositoryException( "Removing category failed: " +
            		"categoryPath" + categoryPath, e );
        }
    }
		...
		throws BRMSRepositoryException 
    {
        ...
        {
        	throw new BRMSRepositoryException( "Renaming rule failed: " +
        			"uuid" + uuid, e );
        }
    }
	 ...
	 * @param uuid Rule uuid
	 * @param comment Rule comment
	 * @param archive If true archive rule, otherwise unarchive rule
	 * @throws BRMSRepositoryException
	 */
		...
		throws BRMSRepositoryException 
    {
        ...
        {
        	throw new BRMSRepositoryException( "Archiving rule failed: " +
        			"uuid=" + uuid, e );
        }
    }
	 ...
	 * 
	 * @param uuid Rule set uuid
	 * @param comment Rule set comment
	 * @throws BRMSRepositoryException
	 */
	 ...
	 * @param uuid Rule set uuid
	 * @param comment Rule set comment
	 * @param archive If true archive rule set, otherwise unarchive rule set
	 * @throws BRMSRepositoryException
	 */
	 ...
	 * 
	 * @param uuid
	 * @param newName New rule set name
		...
		throws BRMSRepositoryException 
    {
        ...
        {
        	throw new BRMSRepositoryException( "Renaming rule set failed: " +
        			"uuid=" + uuid, e );
        }
    }
     ...
     * @throws BRMSRepositoryException
     */
    public BuilderResultList compileRuleSet( String ruleSetUUID ) 
    	throws BRMSRepositoryException 
    {
	    ...
	    {
	    	throw new BRMSRepositoryException( "Compiling rule set failed: " +
	    			"ruleSetUUID=" + ruleSetUUID, e );
	    }
    ...
    /**
     * Compiles a rule set and returns the source code.
     * For Drools, it returns the DRL.
     * 
     * @param ruleSetUUID Rule set uuid
    	...
    	throws BRMSRepositoryException 
    {
    	try
    	{
	        ...
	        {
	            throw new BRMSRepositoryException( 
	            		"Compiling rule set failed: " + result );
	        }
    	...
    	throws BRMSRepositoryException
    {
	    ...
	    {
	    	throw new BRMSRepositoryException( "Loading rule set failed: " +
	    			"ruleSetUuid=" + ruleSetUuid, e );
	    }
	    catch ( Exception e ) 
	    {
		...
		throws BRMSRepositoryException
    {
	    ...
	    {
	    	throw new BRMSRepositoryException( 
	    			"Loading compiled rule set snapshot failed: " +
	    			"ruleSetName=" + ruleSetName + 
	    			", snapshotName=" + snapshotName, e );
	    }
	    catch ( Exception e ) 
	    {
	    	throw new BRMSRepositoryException( 
		...
		throws BRMSRepositoryException
    {
	    ...
	    {
	    	throw new BRMSRepositoryException( "Loading rule set snapshot failed: " +
	    			"ruleSetName=" + ruleSetName + 
	    			", snapshotName=" + snapshotName, e );
	    }
    }
	        ...
	        while( it.hasNext() ) 
	        {
	            ...
	            for ( String snapshotName : snapshots ) 
	            {
	                ...
	                if ( result != null ) 
	                {
	                    ...
	                    sb.append( '\n' );
	                    throw new BRMSRepositoryException(
	                    		"Rebuilding snapshot failed: snapshotName=" + snapshotName + sb.toString() );
	                }
	            }
	        }
	    } 
    ...
    /**
     * Compiles source code (e.g. A Drools DRL file) and returns a compiled 
     * rule engine specific object (e.g. a Drools <code>org.drools.rule.Package</code>).
     * 
     * @param sourceDrl DRL file to compile
     * @return A drools package (<code>org.drools.rule.Package</code>)
     * @throws BRMSRepositoryException Thrown if compilation fails
     */
		...
		throws BRMSRepositoryException
    {
    	...
    	{
			throw new BRMSRepositoryException( "Compiling DRL failed: " + 
					e.getMessage(), e );
    	}
    	catch ( DroolsParserException e ) 
		{
			throw new BRMSRepositoryException( "Compiling and parsing DRL failed: " + 
					e.getMessage(), e );
		}
		catch ( IOException e ) 
		{
