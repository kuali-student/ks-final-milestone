...
public interface BRMSRepository 
{
    ...
    public String createRule( String ruleSetUuid,
			  ...
			  String description,
			  String ruleContent,
			  String category ) throws BRMSRepositoryException;
	...
	public void restoreVersion( String versionUUID, String assetUUID,
			String comment ) throws BRMSRepositoryException;
	 ...
	 * @throws BRMSRepositoryException
	 */
	public void createRuleSetSnapshot( String ruleSetName, 
			String snapshotName,
     ...
     * 
     * @param source A rule engine specific source code to compile
