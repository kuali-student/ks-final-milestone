...
/**
 * This class maps the relationship between population rule and group.
 *
 * @author Mezba Mahtab
 */
@Entity
@Table(name = "KSEN_POPULATION_RULE_GRP")
public class PopulationRuleGroupEntity extends MetaEntity {
    ...
    public PopulationRuleGroupEntity() {
    }
