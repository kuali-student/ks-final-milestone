...
import org.kuali.student.lum.lu.assembly.data.client.refactorme.base.LuiLuiRelationInfoHelper.Properties;


public class LuiLuiRelationInfoMetadata
{
	...
	public void loadChildMetadata (Metadata mainMeta, String type, String state,  RecursionCounter recursions)
	{
		...
		mainMeta.getProperties ().put (Properties.LUI_ID.getKey (), childMeta);
		...
		// metadata for relatedLuiId
		childMeta = new Metadata ();
		mainMeta.getProperties ().put (Properties.RELATED_LUI_ID.getKey (), childMeta);
		childMeta.setDataType (Data.DataType.STRING);
		childMeta.setWriteAccess (Metadata.WriteAccess.ALWAYS);
		if (this.matches (type, state, "(default)", "(default)"))
		{
