...
public class ChangeDetectorOld {
	...
	public ChangeDetectorOld() {
		this(null, null, null, null);
	}

	public ChangeDetectorOld(String outputDir, String reportFile, List<File> schemaFiles, List<File> dataFiles) {
		super();
