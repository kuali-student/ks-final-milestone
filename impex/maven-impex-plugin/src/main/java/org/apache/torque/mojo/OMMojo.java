...
public class OMMojo extends DataModelTaskMojo {
	 ...
	 * 
	 * @parameter property="outputDir" expression="${project.build.sourceDirectory}/../generated-java"
	 */
	...
	/**
	 * The context property where it is configured whether methods are generated to easily retrieve foreign key
	 * relationships.
	 */
	...
	/**
	 * The context property which determines whether isXXX methods are generated for boolean properties instead of
	 * getXXX methods.
	 */
	...
	/**
	 * The subpackage (relative to <code>targetPackage</code> where Torque will put the generated Java classes for the
	 * database map.
	 * 
	...
	/**
	 * The subpackage (relative to <code>targetPackage</code>) where Torque will put the generated Peer Java classes. If
	 * not set, the Peer classes will be generated in <code>targetPackage</code>.
	 * 
	 * @parameter
	 */
	...
	/**
	 * The subpackage (relative to <code>targetPackage</code>) where Torque will put the generated data object Java
	 * classes. If not set, the object classes will be generated in <code>targetPackage</code>.
	 * 
	 * @parameter
	 */
	...
	/**
	 * The subpackage (relative to <code>targetPackage</code>) where Torque will put the generated Java Manager classes,
	 * if they are generated at all. If not set, the Manager classes will be generated in <code>targetPackage</code>.
	 * 
	 * @parameter
	 */
	...
	/**
	 * The subpackage (relative to <code>targetPackage</code>) where Torque will put the generated JavaBean classes, if
	...
	/**
	 * The subpackage (relative to <code>targetPackage</code>) where Torque will put the generated BaseObject, BasePeer,
	 * (and BaseManager, if they are generated at all) Java classes. If not set, the Base classes will be generated in
	...
	/**
	 * The subpackage (relative to <code>targetPackage</code>) where Torque will put the generated BaseBean Java
	 * classes, if they are generated at all.
	 * 
	 * @parameter expression="bean"
	 */
	...
	/**
	 * If true, Torque generates data objects with collection support and methods to easily retrieve foreign key
	 * relationships.
	 * 
	 * @parameter expression="true"
	 */
	...
	/**
	 * If true and objectIsCaching is true, Torque silently fetches foreign key relation collections if the collection
	...
	/**
	 * If true, Torque generates a bean object for each data object, plus methods to convert data objects to beans and
	 * vice versa.
	 * 
	 * @parameter expression="false"
	 */
	...
	public void execute() throws MojoExecutionException {
		...
		try {
			...
			getLog().info("torque non-base java sources generated into: " + outputDirectory.getAbsolutePath());
		...
		super.setAntTask(new TorqueDataModelTask());
		super.bootstrap();
		...
		try {
			...
			getLog().info("torque base java sources generated into: " + baseOutputDirectory.getAbsolutePath());

			if (getProject() != null) {
				getProject().addCompileSourceRoot(baseOutputDirectory.getPath());
			}
		} catch (BuildException e) {
			getLog().error(e.getMessage());
			throw new MojoExecutionException(e.getMessage(), e);
	...
	protected PropertiesConfiguration getMojoContextProperties() {
		...
		configuration.addProperty(TARGET_PACKAGE_CONTEXT_PROPERTY, getTargetPackage());

		configuration.addProperty(BASE_PREFIX_CONTEXT_PROPERTY, basePrefix);

		configuration.addProperty(SUBPACKAGE_MAP_CONTEXT_PROPERTY, subpackageMap);

		configuration.addProperty(SUBPACKAGE_BASE_CONTEXT_PROPERTY, subpackageBase);

		configuration.addProperty(SUBPACKAGE_BASE_BEAN_CONTEXT_PROPERTY, subpackageBaseBean);

		configuration.addProperty(SUBPACKAGE_BEAN_CONTEXT_PROPERTY, subpackageBean);

		configuration.addProperty(SUBPACKAGE_MANAGER_CONTEXT_PROPERTY, subpackageManager);

		configuration.addProperty(SUBPACKAGE_OBJECT_CONTEXT_PROPERTY, subpackageObject);

		configuration.addProperty(SUBPACKAGE_PEER_CONTEXT_PROPERTY, subpackagePeer);

		configuration.addProperty(ADD_GET_BY_NAME_METHOD_CONTEXT_PROPERTY, Boolean.toString(addGetByNameMethod));

		configuration.addProperty(ADD_INTAKE_RETRIEVABLE_CONTEXT_PROPERTY, Boolean.toString(addRetrievableInterface));

		configuration.addProperty(RETRIEVABLE_INTERFACE_CONTEXT_PROPERTY, retrievableInterface);

		configuration.addProperty(ADD_SAVE_METHOD_CONTEXT_PROPERTY, Boolean.toString(addSaveMethod));

		configuration.addProperty(ADD_TIME_STAMP_CONTEXT_PROPERTY, Boolean.toString(addTimeStamp));

		configuration.addProperty(BEAN_SUFFIX_CONTEXT_PROPERTY, beanSuffix);

		configuration.addProperty(BEAN_EXTENDS_CLASS_PROPERTY, beanExtendsClass);

		configuration.addProperty(GENERATE_BEANS_CONTEXT_PROPERTY, Boolean.toString(generateBeans));

		configuration.addProperty(COMPLEX_OBJECT_MODEL_CONTEXT_PROPERTY, Boolean.toString(complexObjectModel));

		configuration.addProperty(CORRECT_GETTERS_CONTEXT_PROPERTY, Boolean.toString(correctGetters));

		configuration.addProperty(ENABLE_JAVA_5_FEATURES_CONTEXT_PROPERTY, Boolean.toString(enableJava5Features));

		configuration.addProperty(OBJECT_IS_CACHING_CONTEXT_PROPERTY, Boolean.toString(objectIsCaching));

		configuration.addProperty(SAVE_EXCEPTION_CONTEXT_PROPERTY, saveException);

		configuration.addProperty(SILENT_DB_FETCH_CONTEXT_PROPERTY, Boolean.toString(silentDbFetch));

		configuration.addProperty(USE_MANAGERS_CONTEXT_PROPERTY, Boolean.toString(useManagers));
	 ...
	 * 
	 * @return the subpackage for the base Object, Peer, and Manager classes, or null if not set.
	 */
	 ...
	 *            the subpackage for the base Object, Peer, and Manager classes.
	 */
	 ...
	 * 
	 * @return the subpackage for the base peer, object, and manager classes, or null if not set.
	 */
	 ...
	 * 
	 * @param subpackageBaseBean
	 *            the subpackage for the base bean classes.
	 */
	 ...
	 * 
	 * @param subpackageManager
	 *            the subpackage for the manager classes.
	 */
	 ...
	 * 
	 * @param subpackagePeer
	 *            the subpackage for the peer classes.
	 */
	 ...
	 * 
	 * @return true if Torque adds methods to get database fields by name/position, false otherwise.
	 */
	 ...
	 * 
	 * @param addGetByNameMethod
	 *            whether Torque should add methods to get database fields by name/position.
	 */
	 ...
	 * 
	 * @return true if the data objects will implement an Retrievable interface, false otherwise.
	 */
	 ...
	 * 
	 * @param addRetrievableInterface
	 *            whether the data objects should implement a Retrievable interface.
	 */
	 ...
	 * 
	 * @return true if Torque will add save methods to the data objects, false otherwise.
	 */
	 ...
	 * 
	 * @param addSaveMethod
	 *            whether Torque should add save methods to the data objects.
	 */
	 ...
	 * 
	 * @return true if Torque puts time stamps in generated om files, false otherwise.
	 */
	 ...
	 * 
	 * @param addTimeStamp
	 *            whether Torque puts time stamps in generated om files.
	 */
	...
	/**
	 * Returns whether Torque generates data objects with collection support and methods to easily retrieve foreign key
	 * relationships.
	 * 
	 * @return true if Torque generates data objects with collection support and methods to easily retrieve foreign key
	...
	/**
	 * Sets whether Torque generates data objects with collection support and methods to easily retrieve foreign key
	 * relationships.
	 * 
	 * @param complexObjectModel
	 *            whether Torque generates data objects with collection support and methods to easily retrieve foreign
	 *            key relationships, false otherwise.
	 */
	 ...
	 * 
	 * @return true if Torque generates isXXX getter methods for boolean columns, false if Torque generates getXXX
	 *         getter methods for boolean columns.
	 */
	 ...
	 *            true if Torque generates isXXX getter methods for boolean columns, false if Torque generates getXXX
	 *            getter methods for boolean columns.
	 */
	 ...
	 * 
	 * @return true if Java5 generics and iteration shorthand will be used in generated code, false to generate
	 *         1.4-compliant code.
	 */
	 ...
	 * 
	 * @param enableJava5Features
	 *            true if Java5 generics and iteration shorthand will be used in generated code, false to generate
	 *            1.4-compliant code.
	 */
	 ...
	 * 
	 * @param generateBeans
	 *            whether bean classes should be generated.
	 */
	 ...
	 * 
	 * @return true if data objects cache their foreign key relationships, false otherwise.
	 */
	...
	/**
	 * Returns the fully qualified class name of the Retrievable interface which should be implemented by the generated
	 * data objects.
	 * 
	...
	/**
	 * Sets the fully qualified class name of the Retrievable interface which should be implemented by the generated
	 * data objects.
	 * 
	 * @param retrievableInterface
	 ...
	 * 
	 * @return the class name of the Exception which should be thrown by the generated save methods.
	 */
	...
	/**
	 * Returns whether Torque silently fetches foreign key relation collections if the collection is not yet
	 * initialized.
	 * 
	 * @return true if Torque silently fetches foreign key relation collections if the collection is not yet
	...
	/**
	 * Sets whether Torque should silently fetches foreign key relation collections if the collection is not yet
	 * initialized.
	 * 
	 * @param silentDbFetch
	 *            whether Torque should silently fetch foreign key relation collections if the collection is not yet
	 *            initialized.
	 */
	 ...
	 * 
	 * @return true if Torque will generate Manager classes that use JCS for caching, false otherwise.
	 */
	 ...
	 * 
	 * @param useManagers
	 *            whether Torque should generate Manager classes that use JCS for caching.
	 */
	 ...
	 * 
	 * @return where the sources for the persistence base classes will be generated.
	 */
	 ...
	 * 
	 * @return the location where the report file for the base persistence classes will be generated.
	 */
