...
public class YVFSumPropositionTest {
	...
	@Test
	public void testSumProposition() throws Exception {
		YieldValueFunctionDTO yvf = new YieldValueFunctionDTO();
		FactStructureDTO fs1 = CommonTestUtil.createFactStructure("fact.id.1", "course.sum.fact");
		yvf.setFactStructureList(Arrays.asList(fs1));

		Map<String, Object> factMap = getFactMap(fs1);
		
		YVFSumProposition<BigDecimal> poposition = new YVFSumProposition<BigDecimal>(
				"1", "YVFSumProposition", 
