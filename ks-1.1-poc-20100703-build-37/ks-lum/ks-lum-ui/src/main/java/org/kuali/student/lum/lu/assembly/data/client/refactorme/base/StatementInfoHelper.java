...
public class StatementInfoHelper
{
	...
	private StatementInfoHelper (Data data)
	{
		this.data = data;
	}
	
	public static StatementInfoHelper wrap (Data data)
	{
		if (data == null)
		{
			 return null;
		}
		return new StatementInfoHelper (data);
	}
	...
	public void setStatementIds (Data value)
	{
		data.set (Properties.STATEMENT_IDS.getKey (), value);
	}
	
	
	public Data getStatementIds ()
	{
		return (Data) data.get (Properties.STATEMENT_IDS.getKey ());
	}
