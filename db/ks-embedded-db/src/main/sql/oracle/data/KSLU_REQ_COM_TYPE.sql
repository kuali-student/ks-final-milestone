TRUNCATE TABLE KSLU_REQ_COM_TYPE DROP STORAGE
/
INSERT INTO KSLU_REQ_COM_TYPE (EFF_DT,EXPIR_DT,NAME,TYPE_DESC,TYPE_KEY)
...
/
INSERT INTO KSLU_REQ_COM_TYPE (EFF_DT,EXPIR_DT,NAME,TYPE_DESC,TYPE_KEY)
  VALUES (TO_DATE( '20000101000000', 'YYYYMMDDHH24MISS' ),TO_DATE( '20001231000000', 'YYYYMMDDHH24MISS' ),'All of required courses','Student must take all of the specified courses','kuali.reqCompType.courseList.all')
/
INSERT INTO KSLU_REQ_COM_TYPE (EFF_DT,EXPIR_DT,NAME,TYPE_DESC,TYPE_KEY)
