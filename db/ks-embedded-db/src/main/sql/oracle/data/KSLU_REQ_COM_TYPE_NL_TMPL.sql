TRUNCATE TABLE KSLU_REQ_COM_TYPE_NL_TMPL DROP STORAGE
/
INSERT INTO KSLU_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE)
...
/
INSERT INTO KSLU_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE)
  VALUES ('1000','de','KUALI.CATALOG','kuali.reqCompType.courseList.nof','Student muss abgeschlossen $expectedValue von $cluSet.getCluSetAsShortName()')
/
INSERT INTO KSLU_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE)
...
/
INSERT INTO KSLU_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE)
  VALUES ('2000','jp','KUALI.CATALOG','kuali.reqCompType.courseList.nof','å­¦ç xã?¯ã¬? $cluSet.getCluSetAsShortName() ã?®ä¸­ã?9ã 0ã¬¬$expectedValue ã  çµ äº ã? ã?ªã? ã Rã?°ã?ªã 0ã?ªã? ã¬ ')
/
INSERT INTO KSLU_REQ_COM_TYPE_NL_TMPL (ID,LANGUAGE,NL_USUAGE_TYPE_KEY,OWNER,TEMPLATE)
