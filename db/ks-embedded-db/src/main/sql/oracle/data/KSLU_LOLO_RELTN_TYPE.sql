...
/
INSERT INTO KSLU_LOLO_RELTN_TYPE (EFF_DT,EXPIR_DT,ID,NAME,REV_NAME,VERSIONIND)
  VALUES (TO_DATE( '20080101000000', 'YYYYMMDDHH24MISS' ),TO_DATE( '20100101000000', 'YYYYMMDDHH24MISS' ),'kuali.lo.relation.type.inSupportOf','inSupportOf','supports',0)
/
INSERT INTO KSLU_LOLO_RELTN_TYPE (DESCR,EFF_DT,EXPIR_DT,ID,NAME,REV_DESCR,REV_NAME,VERSIONIND)
